...
Este documento aborda como configurar a extensão de tag de plug-ins do SDK da Web e usá-la para aumentar a [Extensão SDK da Web do Adobe Experience Platform](../web-sdk/overview.md).
...
A variável `getNewRepeat` o elemento de dados usa os seguintes argumentos:
...
A variável `p_fo` o elemento de dados usa os seguintes argumentos:
