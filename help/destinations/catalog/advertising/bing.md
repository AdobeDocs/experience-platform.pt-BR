...
>title="ID do mapeamento"
>abstract="Insira a ID numérica do segmento do Bing para a qual você deseja mapear o segmento selecionado. Se a variável fornecida [!UICONTROL ID do mapeamento] não corresponde a uma ID de segmento no destino do Bing, você não verá os dados de público-alvo esperados em sua conta do Bing."
