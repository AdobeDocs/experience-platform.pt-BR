...
![O Editor de esquemas com um campo e Gerenciar campos relacionados são destacados.](../images/ui/field-based-workflows/manage-related-fields.png)
...
![A caixa de diálogo Gerenciar campos relacionados com o diagrama do grupo de campos e Confirmar estão destacadas.](../images/ui/field-based-workflows/select-fields.png)

A tela reaparece com apenas os campos selecionados presentes na estrutura do esquema.

![O Editor de esquemas com o grupo de campos recém-editado realçado.](../images/ui/field-based-workflows/fields-added.png)
...
![O Editor de esquemas com um espaço reservado para campo raiz realçado.](../images/ui/field-based-workflows/root-custom-field.png)
...
![O Nome do campo destacado e uma lista de campos padrão recomendados exibidos nas propriedades do campo do Editor de esquemas.](../images/ui/field-based-workflows/standard-field-search.png)
...
![O ícone de adição é realçado em um item dos campos padrão sugeridos.](../images/ui/field-based-workflows/add-standard-field.png)
...
![O Editor de esquemas com o grupo Campo, o campo padrão e Gerenciar campos relacionados destacados.](../images/ui/field-based-workflows/standard-field-added.png)
...
![O Editor de esquemas com o ícone adicionar e um campo de nível raiz sem título realçado.](../images/ui/field-based-workflows/root-custom-field.png)
...
![O Nome do campo e a sugestão de Novo campo são destacados nas propriedades do campo do Editor de esquemas.](../images/ui/field-based-workflows/custom-field-search.png)
...
![As configurações da propriedade Display name, Type e Assign to field estão realçadas no Editor de esquemas.](../images/ui/field-based-workflows/select-field-group.png)
...
![Aplicar está realçado nas propriedades do campo do Editor de esquemas.](../images/ui/field-based-workflows/apply-field.png)
...
![O Editor de esquemas com o novo campo adicionado à tela e o namespace sob a ID do locatário. O grupo Campo e o campo são destacados.](../images/ui/field-based-workflows/tenantId.png)
...
Se o esquema em que você está trabalhando tiver um campo do tipo objeto fornecido por um grupo de campos padrão, será possível adicionar seus próprios campos personalizados a esse objeto padrão. Selecione o sinal de mais (**+**) ao lado da raiz do objeto.
...
Consulte a [Criar e editar esquemas no guia da interface](./resources/schemas.md#custom-fields-for-standard-groups) para obter mais informações sobre como adicionar campos personalizados.
