...
>* Para exportar identidades, você precisa da **Exibir Gráfico de Identidade** ![permissão de controle de acesso](https://experienceleague.adobe.com/en/docs/experience-platform/access-control/home#permissions).
