...
title: Conexão LINE
description: Use o destino do LINE para adicionar perfis ao seu público-alvo do Experience Platform e fornecer experiências personalizadas aos usuários conectados.
