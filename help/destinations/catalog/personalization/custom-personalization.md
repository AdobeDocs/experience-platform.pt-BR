...
>abstract="Essa opção determina em qual sequência de dados de coleta de dados os segmentos serão incluídos na resposta à página. O menu suspenso mostra somente os fluxos de dados com a configuração de destino ativada. Você deve configurar um fluxo de dados antes de configurar seu destino."
>additional-url="https://experienceleague.adobe.com/docs/experience-platform/edge/fundamentals/datastreams.html?lang=en" text="Saiba como configurar um fluxo de dados"
