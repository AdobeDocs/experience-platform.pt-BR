---
keywords: Pinterest, Pinterest, Rastreamento de conversão de Pinterest, Rastreamento de conversão de pintrest
title: Extensão de rastreamento de conversão Pinterest
...
Acompanhe as ações dos visitantes no seu site após as visualizações do seu Pin promovido. Meça o retorno do investimento em anúncios e crie públicos-alvo direcionados. Saiba mais [aqui](https://ads.pinterest.com/).

[!DNL Pinterest Conversion Tracking] O é uma extensão de publicidade no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão em [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100523.pinterest-conversion-tracking-for-adobe-launch.html).
...
![Extensão de rastreamento de conversão Pinterest](../../assets/catalog/advertising/pinterest/catalog.png)
...
Para obter informações sobre as opções de configuração de extensão e o suporte de instalação, consulte a página [Rastreamento de conversão do Pinterest no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100523.pinterest-conversion-tracking-for-adobe-launch.html).
