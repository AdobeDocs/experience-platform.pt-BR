---
keywords: twitter; Twitter; tag universal de site do twitter; tag universal de site do Twitter; Tag UWT do Twitter; Twitter uwt; twitter uwt
title: Extensão de tag do Twitter Universal Website
description: A extensão Tag do site universal do Twitter é um destino de publicidade no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
![Extensão de tag universal do site do Twitter](../../assets/catalog/advertising/twitter-uwt/catalog.png)
...
Para instalar a extensão [!DNL Twitter Universal Website Tag]:
