...
title: Criar um Fluxo de Dados Usando uma Origem de Pagamentos na Interface
type: Tutorial
...
Depois de criar sua conta de origem de pagamentos, a variável **[!UICONTROL Adicionar dados]** será exibida, fornecendo uma interface para que você explore a hierarquia de tabelas da conta de origem de pagamentos.
...
Seguindo este tutorial, você criou com êxito um fluxo de dados para trazer dados de sua origem de pagamentos para a Platform. Os dados recebidos agora podem ser usados pelo downstream [!DNL Platform] serviços como [!DNL Real-Time Customer Profile] e [!DNL Data Science Workspace]. Consulte os seguintes documentos para obter mais detalhes:
