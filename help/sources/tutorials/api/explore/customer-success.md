...
Para inspecionar a estrutura de uma tabela do sistema CS, execute uma solicitação GET enquanto especifica o caminho de uma tabela como parâmetro de query.
