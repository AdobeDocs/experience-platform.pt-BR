...
A plataforma Adobe Experience inclui a infraestrutura para o controle de dados com a DULE (Data Usage Labeling and Implementation, Etiqueta e Aplicação de Uso de Dados) em seu núcleo.  Os recursos DULE permitem a aplicação de rótulos de uso de dados a conjuntos de dados e campos para categorizar dados de acordo com o tipo de políticas de uso que se aplicam a esses dados.

A lista a seguir descreve todos os rótulos de uso de dados atualmente suportados pela plataforma Experience.

Para obter mais informações sobre o Data Governance e o DULE, consulte a visão geral [](../home.md)do Data Governance.
...
A seção a seguir fornece informações detalhadas relacionadas à implementação de rótulos específicos.
