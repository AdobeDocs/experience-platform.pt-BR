...
Para [visualizar seus Insights Personalizáveis](../../../dashboards/data-distiller/overview.md), você pode usar o [modo profissional de consulta](../../../dashboards/data-distiller/customizable-insights/query-pro-mode.md) para realizar análises complexas com consultas SQL personalizadas e transformar seus dados em gráficos de fácil interpretação. Use o modo query pro para criar insights e visualizações sob medida em seus painéis e atender a públicos técnicos e não técnicos baixando seus insights como arquivos CSV.
...
**Solução de Insights Personalizáveis**: o Data Distiller habilita a extensão de modelos de dados de relatórios no Adobe Experience Platform, facilitando [a adição de atributos de perfil personalizados, como CLTV](../../use-cases/customer-lifetime-value.md) ou status de fidelidade.
...
**Solução de Insights Personalizáveis**: ao estender o modelo de dados de relatórios, os usuários podem incorporar atributos de perfil adicionais, enriquecendo o relatório de sobreposição de público-alvo com dados demográficos e preferências relevantes.
