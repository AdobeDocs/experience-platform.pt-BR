...
[!DNL Gainsight] O capacita os proprietários de produtos com as ferramentas para entender profundamente o comportamento do usuário, impulsionar a adoção de produtos e coletar feedback do usuário.
...
Para instalar o [!DNL Gainsight] extensão:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte [Página do Gainsight no Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).
