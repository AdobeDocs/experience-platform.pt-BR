...
[!DNL Invoca] traz insights de voz e dados de chamada para a jornada digital do cliente. Com [!DNL Invoca’s] a plataforma de inteligência de chamadas, os profissionais de marketing finalmente têm análises para medir os resultados das chamadas e vincular as conversões offline ao gasto digital.
...
Para obter informações sobre as opções de configuração de extensão e o suporte de instalação, consulte a página [Tags Invoca no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html).
