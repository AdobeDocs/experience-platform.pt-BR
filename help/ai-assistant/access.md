...
* **Acessar o aplicativo:** Você pode acessar o Assistente de IA (Herdado) no Adobe Experience Platform, Adobe Real-Time CDP, Adobe Journey Optimizer e [Customer Journey Analytics](https://experienceleague.adobe.com/en/docs/analytics-platform/using/ai-assistant).
...
Depois de ter as permissões necessárias, você pode acessar o Assistente do AI (Herdado) selecionando o ícone Assistente do AI (Herdado) no cabeçalho superior do aplicativo que está usando.
