...
| Código de erro | Título | Mensagem detalhada |
| --- | --- | --- |
| `1100-400` | Solicitação inválida | Não foi possível processar a solicitação. {detailedMessage} |
...
| `1105-401` | Não autorizado | O usuário não está autorizado. {detailedMessage} |
| `1106-403` | Proibido | A operação solicitada é proibida. {detailedMessage} |
| `1107-412` | Falha da pré-condição | A condição definida pelos cabeçalhos If-Unmodified-Since ou If-None-Match não foi atendida. {detailedMessage} |
...
| `1201-400` | Solicitação inválida | O flowId não pode ser nulo ou estar vazio. Forneça um flowId válido na solicitação e tente novamente. |
| `1202-400` | Solicitação inválida | O publicKeyId está ausente nas transformações do fluxo={transformations}. Forneça um publicKeyId na solicitação e tente novamente. |
| `1203-400` | Solicitação inválida | A chave de criptografia não existe em relação a keyID={keyID} nas transformações do fluxo={transformations}. Verifique a keyID fornecida e tente novamente. |
...
| Código de erro | Título | Mensagem detalhada |
| --- | --- | --- |
| `1300-400` | Solicitação inválida | Não há suporte para a solicitação de conexão PATCH para o conector {connectorType}. Verifique a solicitação fornecida e tente novamente. |
| `1301-400` | Solicitação inválida | Não há suporte para o parâmetro authSpecType fornecido: {authSpecType}. Forneça um tipo de especificação de autenticação válido e tente novamente. |
| `1302-400` | Solicitação inválida | O tipo de autenticação fornecido = {authType} não é compatível com o connector={connectorType}. Forneça um tipo de autenticação válido para o conector fornecido. |
...
| `1305-400` | Solicitação inválida | O tipo de conector fornecido = {connectorType} não é compatível com essa operação. |
...
| `1313-400` | Solicitação inválida | O atributo de caminho {attribute} não existe. Certifique-se de que o atributo exista e tente novamente. |
