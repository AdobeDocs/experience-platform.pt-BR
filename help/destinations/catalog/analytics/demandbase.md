...
Obtenha insights da conta B2B [!DNL Demandbase] diretamente no Adobe Analytics, onde você pode segmentar o tráfego e o comportamento por setor, receita e contas de destino. Essa visualização baseada em conta fornece insights exclusivos sobre engajamento, conversão e a fonte para seus visitantes mais valiosos.

[!DNL Demandbase] é uma extensão do Analytics no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101605.html).
