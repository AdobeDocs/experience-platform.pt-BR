...
Um segredo contém credenciais que permitem que o encaminhamento de eventos seja autenticado em outro sistema para troca segura de dados. Consulte o [manual de segredos](./guides/secrets.md) para obter uma visão geral sobre como os segredos funcionam no encaminhamento de eventos e o [manual de endpoint de segredos](./endpoints/secrets.md) para saber como gerenciá-los na API do Reator.
