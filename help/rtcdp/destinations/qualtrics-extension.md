...
description: A extensão de Comentários do Site Qualtrics é um destino pesquisa na Plataforma de Dados de Clientes em Tempo Real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão de Comentários do Site Qualtrics é um destino pesquisa na Plataforma de Dados de Clientes em Tempo Real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão de Comentários do Site Qualtrics {#qualtrics-extension}

## Visão geral {#overview}

O Feedback do site Qualtrics permite que você envolva visitantes do site com a mensagem certa, no momento certo. Quer você queira melhorar a experiência do visitante com pesquisas de feedback do site ou aumentar a conversão, o Feedback do site da Qualtrics lhe deu cobertura.

Crie e implante mensagens da Web altamente direcionadas e com marca própria em minutos usando uma interface intuitiva de apontar e clicar. Os dados e insights coletados em seu site são revelados juntamente com os dados de feedback dos clientes em todos os canais que oferecem uma visualização completa da experiência dos clientes - tudo isso em uma única plataforma.

O Feedback do site Qualtrics é uma extensão de pesquisa na Plataforma de Dados de Clientes em Tempo Real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
...
![Extensão de Comentários do Site Qualtrics](assets/qualtrics-extension.png)
...
Para instalar a extensão de Comentários do Site Qualtrics:
...
Para obter informações sobre as opções de configuração de extensão e o suporte de instalação, consulte a página [Comentários do site Qualtrics no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101569.qualtrics-website-feedback.html).
