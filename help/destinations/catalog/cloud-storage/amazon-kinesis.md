...
Você pode criar uma conexão de saída em tempo real com o armazenamento do [!DNL Amazon Kinesis] para transmitir dados de [!DNL Adobe Experience Platform].
...
>* [Destino do Azure Event Hubs](./azure-event-hubs.md)
