...
![Visão geral de vários aplicativos da Experience Platform, com o Real-Time CDP realçado.](/help/rtcdp/assets/platform-apps-overview.png)
...
Ao comprar o Real-Time CDP, sua empresa tem a escolha entre três edições, conforme mostrado na tabela abaixo. Todas as três edições estão disponíveis em um Prime padrão e em nível de Ultimate. Consulte as seções abaixo para obter informações adicionais que ajudam a decidir qual das três edições é a melhor para sua empresa.
...
Obtenha informações completas sobre a funcionalidade incluída nos níveis da Prime e do Ultimate de todas as edições abaixo:
...
* [Real-Time Customer Data Platform (B2B edition - Pacotes do Prime e Ultimate)](https://helpx.adobe.com/br/legal/product-descriptions/real-time-customer-data-platform-b2b-edition-prime-and-ultimate-packages.html)
* [Real-Time Customer Data Platform (Edição B2P - Pacotes do Prime e Ultimate)](https://helpx.adobe.com/br/legal/product-descriptions/real-time-customer-data-platform-b2p-edition-prime-and-ultimate-packages.html)
