...
Para adicionar perfis a um público existente, use o comando `INSERT INTO`. Isso permite adicionar perfis individuais ou públicos-alvo inteiros a um conjunto de dados de público-alvo existente.
