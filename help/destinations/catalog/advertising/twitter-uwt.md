...
[!DNL Twitter Universal Website Tag] é uma extensão de publicidade no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte [Rastreamento avançado de conversão](https://business.twitter.com/en/solutions/twitter-ads/website-clicks/advanced-conversion-tracking.html).
...
![Extensão de tag do site universal do Twitter](../../assets/catalog/advertising/twitter-uwt/catalog.png)
