...
* [Crie uma conexão de origem e um fluxo de dados para trazer [!DNL Oracle NetSuite Activities] dados para a Plataforma usando APIs](../../tutorials/api/create/marketing-automation/oracle-netsuite-activities.md).
