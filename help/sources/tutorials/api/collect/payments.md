...
topic: overview
description: Este tutorial aborda as etapas para recuperar dados de um aplicativo de pagamento de terceiros e assimilá-los na Plataforma por meio de conectores de origem e da API de Serviço de Fluxo.
