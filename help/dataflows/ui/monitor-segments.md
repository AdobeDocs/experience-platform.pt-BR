...
![O painel de segmentos. As informações sobre os diferentes segmentos na sua organização IMS e sandbox são exibidas.](../assets/ui/monitor-segments/segment-monitoring-dashboard.png)
...
>title="Trabalhos do segmento"
>abstract="A visualização Trabalhos de segmento contém informações sobre os trabalhos de avaliação e exportação de todos os segmentos."
