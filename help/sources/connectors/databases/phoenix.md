...
A plataforma Experience oferece suporte para a assimilação de dados de um banco de dados de terceiros. A plataforma pode se conectar a diferentes tipos de bancos de dados, como relacional, NoSQL ou data warehouses. O suporte para provedores de banco de dados inclui a Phoenix.

A documentação abaixo fornece informações sobre como conectar a Phoenix à plataforma usando APIs ou a interface do usuário:

## Conecte a Phoenix à plataforma usando APIs
...
## Conecte a Phoenix à plataforma usando a interface do usuário
