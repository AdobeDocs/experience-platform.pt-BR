...
A extensão de tag [!DNL Quantum Metric] facilita a implantação sem códigos de [!DNL Quantum Metric's] recursos de coleta de dados. Além disso, essa extensão oferece a capacidade de capturar elementos de dados que contêm informações úteis da API [!DNL Quantum Metric].
