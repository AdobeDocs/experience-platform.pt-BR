...
title: Criar uma conexão básica do Oracle usando a API do serviço de fluxo
type: Tutorial
...
Para criar uma ID de conexão base, faça uma solicitação POST para o ponto de extremidade `/connections` ao fornecer suas credenciais de autenticação [!DNL Oracle] como parte dos parâmetros de solicitação.
