---
keywords: Experience Platform, home, tópicos populares, sistema de automação de marketing, coletar dados de automação de marketing
solution: Experience Platform
title: Colete dados da automação de marketing usando conectores de origem e APIs
...
# Colete dados de automação de marketing usando conectores de origem e APIs
...
Uma resposta bem-sucedida retorna detalhes do schema recém-criado, incluindo seu identificador exclusivo (`$id`). Armazene essa ID conforme necessário nas etapas posteriores para criar um conjunto de dados de destino, mapeamento e fluxo de dados.
...
Para que os dados de origem sejam assimilados em um conjunto de dados de destino, eles devem primeiro ser mapeados para o schema de destino ao qual o conjunto de dados de destino adere. Isso é feito executando uma solicitação POST para [!DNL Conversion Service] API com mapeamentos de dados definidos na carga da solicitação.
...
Uma resposta bem-sucedida retorna detalhes do mapeamento recém-criado, incluindo seu identificador exclusivo (`id`). Armazene esse valor conforme for necessário na etapa posterior para criar um fluxo de dados.
