...
Na categoria *[!UICONTROL Bancos]* de Dados, selecione Data Explorer **[!UICONTROL do]** Azure e clique **no ícone + (+)** para criar um novo conector de Data Explorer.
...
Ao seguir este tutorial, você estabeleceu uma conexão com sua [!DNL Data Explorer] conta. Agora você pode continuar com o próximo tutorial e [configurar um fluxo de dados para trazer dados para o Platform](../../dataflow/databases.md).