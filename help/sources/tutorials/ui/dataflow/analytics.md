...
title: Criar um fluxo de dados usando uma fonte do Analytics na interface
...
>[!NOTE]
>
>Para criar um fluxo de dados, você já deve ter uma conta autenticada com o [!DNL Mixpanel] origem. Veja o tutorial sobre [criação de um [!DNL Mixpanel] conexão de origem na interface](../../ui/create/analytics/mixpanel.md) para obter mais informações.
