...
description: A extensão da tag do site universal do Twitter é um destino de publicidade na plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão da tag do site universal do Twitter é um destino publicitário na plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão de tag do site universal do Twitter {#twitter-uwt-extension}

## Visão geral {#overview}

A Tag do site universal do Twitter fornece ações para enviar beacons para a Tag UWT do Twitter.

A tag do site universal do Twitter é uma extensão de anúncio na plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte Rastreamento [de conversão](https://business.twitter.com/en/solutions/twitter-ads/website-clicks/advanced-conversion-tracking.html)avançado.
...
![Extensão de tag do site universal do Twitter](assets/twitter-uwt-extension.png)
...
Para instalar a extensão da tag do Twitter Universal Website:
