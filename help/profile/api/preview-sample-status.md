...
Você pode executar uma solicitação de GET para `/previewsamplestatus` endpoint para exibir os detalhes do último trabalho de amostra bem-sucedido executado para sua organização. Isso inclui o número total de perfis na amostra, bem como a métrica de contagem de perfis ou o número total de perfis que sua organização tem no Experience Platform.
