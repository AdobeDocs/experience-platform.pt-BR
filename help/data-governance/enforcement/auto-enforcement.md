...
Foi feito um aprimoramento na aplicação da política de consentimento em destinos de lote e streaming, incluindo ativações de mídia paga. Esse aprimoramento está disponível para clientes do Privacy and Security Shield ou do Healthcare Shield, além de remover proativamente perfis de destinos em lote e streaming conforme o status do consentimento é alterado. Também garante que as alterações de consentimento sejam propagadas imediatamente, para que o público-alvo correto seja sempre direcionado.
