...
O espaço de trabalho Conjuntos de dados em [!DNL Experience Platform] O permite visualizar e gerenciar todos os conjuntos de dados que sua organização fez, bem como criar novos conjuntos.
