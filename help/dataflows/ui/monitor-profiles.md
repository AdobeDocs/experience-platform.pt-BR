...
>abstract="A visualização de processamento de perfil contém informações sobre registros assimilados no serviço de perfil, incluindo o número de fragmentos de perfil criados, os fragmentos de perfil atualizados e o número total de fragmentos de perfil."
>text="Learn more in documentation"

>[!CONTEXTUALHELP]
>id="platform_monitoring_dataflow_run_details_profile"
>title="Detalhes da execução do fluxo de dados"
>abstract="A página Detalhes da execução do fluxo de dados exibe mais informações sobre a execução do fluxo de dados do seu perfil, incluindo a ID da organização e a ID de execução do fluxo de dados."
