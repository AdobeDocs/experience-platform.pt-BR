...
topic: overview
description: A documentação abaixo fornece informações sobre como conectar o Google BigQuery à plataforma usando APIs ou a interface do usuário.
...
>[!NOTE]
>
>O [!DNL Google BigQuery] está em beta. Consulte a visão geral [das](../../home.md#terms-and-conditions) Fontes para obter mais informações sobre o uso de conectores com rótulo beta.
...
[!DNL Experience Platform] fornece suporte para assimilar dados de um banco de dados de terceiros. [!DNL Platform] pode se conectar a diferentes tipos de bancos de dados, como relacional, NoSQL ou data warehouses. O suporte para provedores de banco de dados inclui [!DNL Google BigQuery].
...
A documentação abaixo fornece informações sobre como se conectar [!DNL Google BigQuery] a [!DNL Platform] APIs ou à interface do usuário:

## Conectar-se [!DNL Google BigQuery] a [!DNL Platform] APIs

- [Criar um conector do Google BigQuery usando a API de Serviço de Fluxo](../../tutorials/api/create/databases/bigquery.md)
...
## Conectar-se [!DNL Google BigQuery] à [!DNL Platform] interface do usuário

- [Criar um conector de origem do Google BigQuery na interface do usuário](../../tutorials/ui/create/databases/bigquery.md)
