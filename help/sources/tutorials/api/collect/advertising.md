...
Este tutorial aborda as etapas para recuperar dados de um aplicativo de publicidade de terceiros e trazê-los para [!DNL Platform] dentro de conectores de origem e APIs.
