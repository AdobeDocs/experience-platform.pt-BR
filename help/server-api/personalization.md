...
| --- | --- | --- |
| `schemas` | `String[]` | *Opcional*. Lista de schemas usados na decisão, para selecionar o tipo de ofertas retornadas. |
...
| `payload.scopeDetails.decisionProvider` | String | Isso será `TGT` se estiver usando o Adobe Target ou `ODE` se estiver usando [!DNL Offer Decisioning]. |
...
## Recuperar conteúdo {#retrieve-content}
