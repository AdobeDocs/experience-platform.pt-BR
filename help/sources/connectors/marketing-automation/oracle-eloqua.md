---
title: Visão geral do conector Oracle Eloqua
...
O Experience Platform fornece suporte para assimilação de dados de um sistema de automação de marketing de terceiros. O suporte para provedores de automação de marketing inclui [!DNL Oracle Eloqua].
...
A documentação abaixo fornece informações sobre como se conectar [!DNL Oracle Eloqua] para a Platform usando APIs ou a interface do usuário:

## Conectar [!DNL Oracle Eloqua] para a Platform usando APIs

* [Criar uma conexão básica do Oracle Eloqua usando a API de serviço de fluxo](../../tutorials/api/create/marketing-automation/oracle-eloqua.md)
...
## Conectar [!DNL Oracle Eloqua] para a Platform usando a interface

* [Criar uma conexão de origem do Oracle Eloqua na interface](../../tutorials/ui/create/marketing-automation/oracle-eloqua.md)
