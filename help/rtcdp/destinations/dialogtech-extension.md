...
description: A extensão DialogTech é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão DialogTech é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão DialogTech {#dialogtech-extension}

## Visão geral {#overview}

Inclua o trecho javascript DialogTech SourceTrak no Adobe Launch

DialogTech é uma extensão de análise na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte o site da [Dialog](https://www.dialogtech.com/).
...
Para instalar a extensão DialogTech:
