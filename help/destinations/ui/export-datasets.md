...
<tbody>
  ...
  <tr>
    ...
    <td>Prime</td>
    <td>Consulte a documentação de <a href="https://experienceleague.adobe.com/docs/journey-optimizer/using/data-management/datasets/export-datasets.html?lang=pt-BR#datasets"> [!DNL Adobe Journey Optimizer]</a>.</td>
  </tr>
  <tr>
    <td>Ultimate</td>
    <td>Consulte a documentação de <a href="https://experienceleague.adobe.com/docs/journey-optimizer/using/data-management/datasets/export-datasets.html?lang=pt-BR#datasets"> [!DNL Adobe Journey Optimizer]</a>.</td>
