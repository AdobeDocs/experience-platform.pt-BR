...
[!DNL SessionCam] O fornece um conjunto essencial de ferramentas que revelam o comportamento do usuário e mostram os problemas mais importantes a serem corrigidos.
...
Para instalar o [!DNL SessionCam] extensão:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte [Página SessionCam no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100517.html).
