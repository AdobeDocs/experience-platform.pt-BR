...
Para saber mais sobre namespaces de identidade no Experience Platform, consulte [documentação de namespaces de identidade](../../../../identity-service/namespaces.md).
...
* Permitindo que os usuários mapeiem [namespaces de identidade padrão](../../../../identity-service/namespaces.md#standard) aos seus próprios namespaces de identidade.
* Permitindo que os usuários mapeiem [namespaces de identidade personalizados](../../../../identity-service/namespaces.md#manage-namespaces) aos seus próprios namespaces de identidade.
...
| `acceptedGlobalNamespaces` | - | Opcional | Indica qual [namespaces de identidade padrão](../../../../identity-service/namespaces.md#standard) (por exemplo, [!UICONTROL IDFA]) podem mapear para a identidade que você está configurando. |
