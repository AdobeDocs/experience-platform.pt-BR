...
Serviços inteligentes, baseados em [!DNL Adobe Experience Platform]O , oferece aos profissionais de marketing responsáveis pela experiência do cliente acesso ao IA-as-service, facilitando a previsão do comportamento do cliente, a medição do impacto de uma campanha ou a garantia de melhor retorno sobre cada investimento. Veja abaixo alguns dos benefícios oferecidos pelos Serviços inteligentes.
...
Os dados do cliente são assimilados e transformados com o Experience Data Model (XDM) em [!DNL Adobe Experience Platform]. Para saber mais sobre o XDM, visite o [Visão geral do XDM](../xdm/home.md).
