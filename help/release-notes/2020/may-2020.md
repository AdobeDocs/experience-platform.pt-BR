...
| Grupo de campos de esquema do SDK da Web da Adobe Experience Platform | Um grupo de campos a ser usado com o [!DNL Experience Platform web SDK] que abrange todos os campos aceitos. |
...
Para obter mais informações sobre [!DNL Platform Web SDK] e [!DNL Edge Network], consulte a [documentação](../../web-sdk/home.md).
...
| Ponto de extremidade do GET em massa | Adição do ponto de extremidade GET em massa à API [!DNL Real-Time Customer Profile] para habilitar a recuperação de vários resultados em uma única chamada de API. Agora você pode GET até 100 IDs em massa para definições de segmento, trabalhos de segmento e políticas de mesclagem. |
| Procurar perfil por identidade | Na interface do usuário do [!DNL Platform], agora é possível selecionar um namespace de identidade e fornecer um valor de identidade para procurar um perfil. |
