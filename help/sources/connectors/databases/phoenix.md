...
[!DNL Experience Platform] O oferece suporte para assimilar dados de um banco de dados de terceiros. [!DNL Platform] pode se conectar a diferentes tipos de bancos de dados, como relacional, NoSQL ou data warehouses. O suporte para provedores de banco de dados inclui [!DNL Phoenix].
...
A documentação abaixo fornece informações sobre como se conectar [!DNL Phoenix] para [!DNL Platform] usando APIs ou a interface do usuário:

## Connect [!DNL Phoenix] para [!DNL Platform] uso de APIs

- [Criar uma conexão base Phoenix usando a API do Serviço de Fluxo](../../tutorials/api/create/databases/phoenix.md)
- [Explorar tabelas de dados usando a API do Serviço de fluxo](../../tutorials/api/explore/tabular.md)
- [Criar um fluxo de dados para uma fonte de banco de dados usando a API do Serviço de Fluxo](../../tutorials/api/collect/database-nosql.md)

## Connect [!DNL Phoenix] para [!DNL Platform] uso da interface do usuário

- [Criar uma conexão de origem Phoenix na interface do usuário](../../tutorials/ui/create/databases/phoenix.md)
