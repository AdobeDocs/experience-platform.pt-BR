---
title: Extensão de áudio e vídeo do Adobe Media Analytics
seo-title: Extensão de áudio e vídeo do Adobe Media Analytics
description: A extensão do Adobe Media Analytics para áudio e vídeo é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão do Adobe Media Analytics para vídeo é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do Adobe Media Analytics para áudio e vídeo {#adobe-analytics-for-video-extension}

## Visão geral {#overview}

O Adobe Media Analytics para áudio e vídeo é um complemento da oferta básica do Analytics que fornece aos clientes avaliações robustas para vídeo, áudio e anúncios.

O Adobe Media Analytics para áudio e vídeo é uma extensão de análise na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100157.html).
...
![Extensão de áudio e vídeo do Adobe Media Analytics](/help/rtcdp/destinations/assets/adobe-analytics-extension.png)
...
Para instalar a extensão do Adobe Analytics para vídeo:
...
Para obter informações sobre as opções de configuração de extensão, consulte a página [de extensão do](https://docs.adobe.com/content/help/pt-BR/launch/using/extensions-ref/adobe-extension/media-analytics-extension/overview.html) Adobe Media Analytics para áudio e vídeo na documentação do Experience Launch.
