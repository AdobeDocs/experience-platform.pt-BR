...
topic: overview
description: Este tutorial fornece etapas para a criação de um conector de origem de Data Explorer do Azure (a seguir denominado "Data Explorer") usando a interface de usuário da Plataforma.
