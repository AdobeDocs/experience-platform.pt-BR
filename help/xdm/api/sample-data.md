---
keywords: Experience Platform;página inicial;tópicos populares;api;API;XDM;sistema XDM;modelo de dados de experiência;modelo de dados de experiência;modelo de dados de experiência;modelo de dados;modelo de dados;modelo de dados;dados de amostra;dados de amostra;rpc;
solution: Experience Platform
title: Endpoint da API de dados de amostra
description: O endpoint /sampledata na API do registro de esquema permite gerar dados de amostra mapeados para a estrutura de qualquer esquema XDM existente.
...
Usar o `/sampledata` endpoint na variável [!DNL Schema Registry] , você pode gerar um objeto de assimilação de exemplo para qualquer esquema criado anteriormente.
...
| Parâmetro | Descrição |
| --- | --- |
| `{SCHEMA_ID}` | A variável `meta:altId` ou codificado em URL `$id` do esquema para o qual você deseja gerar dados de amostra. |
