...
A documentação abaixo fornece informações sobre como conectar o S3 à Adobe Experience Platform usando APIs ou a interface do usuário:

### Uso de APIs

- [Criar uma conexão de origem S3 usando a API de Serviço de Fluxo](../../tutorials/api/create/cloud-storage/s3.md)
