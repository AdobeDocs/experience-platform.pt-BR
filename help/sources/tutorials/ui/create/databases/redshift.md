...
Os conectores de origem no Adobe Experience Platform fornecem a capacidade de assimilar dados de origem externa de forma programada. Este tutorial fornece etapas para a criação de um conector de origem Amazon Redshift (a seguir, &quot;Redshift&quot;) usando a interface do usuário do Platform.
...
Para acessar sua conta Redshift no Platform, você deve fornecer os seguintes valores:
...
Ao seguir este tutorial, você estabeleceu uma conexão básica com sua conta Redshift. Agora você pode continuar com o próximo tutorial e [configurar um fluxo de dados para trazer dados para o Platform](../../dataflow/databases.md).