---
keywords: Experience Platform;home;popular topics;conector de pagamento
...
Um fluxo de dados é uma tarefa programada que recupera e ingere dados de uma fonte para um conjunto de dados Adobe Experience Platform. Este tutorial fornece etapas para configurar um novo fluxo de dados usando sua conta de pagamentos.
...
Além disso, este tutorial requer que você já tenha criado uma conta de pagamentos. Uma lista de tutoriais para criar conectores de pagamento diferentes na interface do usuário pode ser encontrada na [visão geral dos conectores de origem](../../../home.md).

## Selecionar dados

Depois de criar sua conta de pagamentos, a etapa **[!UICONTROL Selecionar dados]** é exibida, fornecendo uma interface interativa para você explorar sua hierarquia de arquivos.
