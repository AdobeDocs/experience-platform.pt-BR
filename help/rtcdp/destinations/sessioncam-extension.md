...
seo-title: Extensão SessionCam
description: A extensão SessionCam é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão SessionCam é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão SessionCam {#sessioncam-extension}

## Visão geral {#overview}

O SessionCam fornece um conjunto essencial de ferramentas que revelam o comportamento do usuário e mostram os problemas mais importantes a serem corrigidos.

SessionCam é uma extensão de análise na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100517.html).
...
![Extensão SessionCam](assets/sessioncam-extension.png)
...
Para instalar a extensão SessionCam:
