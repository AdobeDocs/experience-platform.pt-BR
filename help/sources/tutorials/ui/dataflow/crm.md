...
title: Criar um fluxo de dados usando uma origem de CRM na interface
type: Tutorial
...
Depois de criar sua conta de origem do CRM, a variável **[!UICONTROL Adicionar dados]** será exibida, fornecendo uma interface para você explorar a hierarquia de tabela da sua conta do CRM.
...
>[!NOTE]
>
>Se você estiver usando [!DNL Salesforce] como parte da Adobe Real-time Customer Data Platform B2B Edition, consulte a [[!DNL Salesforce] documento de mapeamento de campo](../../../connectors/adobe-applications/mapping/salesforce.md) para obter orientação sobre mapeamento [!DNL Salesforce] campos de origem aos campos de destino XDM apropriados.
...
Ao seguir este tutorial, você criou com êxito um fluxo de dados para trazer dados da origem do CRM para a Platform. Os dados recebidos agora podem ser usados pelo downstream [!DNL Platform] serviços como [!DNL Real-Time Customer Profile] e [!DNL Data Science Workspace]. Consulte os seguintes documentos para obter mais detalhes:
