...
O tutorial a seguir orienta você pelas etapas para criar uma conexão de origem e um fluxo de dados para trazer dados do [!DNL Mailchimp Campaign] para a Experience Platform usando a [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
Depois de recuperar as credenciais de autenticação do [!DNL Mailchimp], você pode iniciar o processo de criação do fluxo de dados para trazer os dados do [!DNL Mailchimp Campaign] para a Experience Platform. A primeira etapa na criação de um fluxo de dados é criar uma conexão base.
