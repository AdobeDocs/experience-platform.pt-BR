...
description: A extensão Foresee é um destino pesquisa na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão prevista {#foresee-extension}

## Visão geral {#overview}

Configurar as implantações do ForeConsulte produto usando o Experience Platform Launch.

O Foresee é uma extensão de pesquisa na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100164.html).
...
Para instalar a extensão do Foresee:
