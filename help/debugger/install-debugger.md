...
Depois de instalar a extensão do Chrome ou o complemento do Firefox, um ícone (![](images/start-icon.jpg)) é adicionado à barra de extensão. Selecione esse ícone para abrir a extensão.
