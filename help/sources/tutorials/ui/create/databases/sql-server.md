...
topic: overview
description: Este tutorial fornece etapas para a criação de um conector de origem do Microsoft SQL Server (a seguir denominado "SQL Server") usando a interface do usuário da plataforma.
