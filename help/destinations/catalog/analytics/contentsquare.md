...
title: Extensão do Contentsquare
...
Visualize comportamentos na página, consulte POR QUE os clientes abandonam e COMO você pode melhorar. Atribua receita a UX e elementos de conteúdo para cada segmento do Analytics e teste do Target. Instale a tag [!DNL Contentsquare], configure variáveis e eventos personalizados. Comece a coletar dados para a análise UX em alguns cliques.
...
![Extensão do Contentsquare](../../assets/catalog/analytics/contentsquare/catalog.png)
