...
| ---------- | ----------- |
| `endpoint` | O terminal do [!DNL Data Explorer] servidor. |
...
| `servicePrincipalId` | A ID exclusiva do principal de serviço usada para conectar-se ao banco de dados da Data Explorer. |
| `servicePrincipalKey` | A chave principal de serviço exclusiva usada para conectar-se ao banco de dados de Datas Explorer. |
...
Depois de reunir as credenciais necessárias, siga as etapas abaixo para criar uma nova [!DNL Data Explorer] conta à qual se conectar [!DNL Platform].
...
Na categoria *[!UICONTROL Bancos]* de dados, selecione Data Explorer **[!UICONTROL do]** Azure seguida por **[!UICONTROL Adicionar dados]** para criar um novo conector de Data Explorer.
...
Se você estiver usando novas credenciais, selecione **[!UICONTROL Nova conta]**. No formulário de entrada exibido, forneça à conexão um nome, uma descrição opcional e suas [!DNL Data Explorer] credenciais. Quando terminar, selecione **[!UICONTROL Connect]** e aguarde algum tempo para a nova conta ser estabelecida.
...
Ao seguir este tutorial, você estabeleceu uma conexão com sua [!DNL Data Explorer] conta. Agora você pode continuar com o próximo tutorial e [configurar um fluxo de dados para trazer dados para a Plataforma](../../dataflow/databases.md).