...
Para que o SDK envie dados para o Experience Platform, primeiro você deve criar um novo datastream para Platform na interface do usuário da coleta de dados. Etapas específicas para criar um novo conjunto de dados são fornecidas na [documentação do SDK](../../../../edge/fundamentals/datastreams.md).
