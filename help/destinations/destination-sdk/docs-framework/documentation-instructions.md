...
# Documentar seu destino em [!DNL Adobe Experience Platform]
...
Bem-vindo(a) ao [!DNL Adobe Experience Platform], é ótimo ter você aqui!
A documentação do destino é a etapa final antes de ser ativada no [!DNL Adobe Experience Platform].
...
* [Instruções específicas para o tipo do Adobe Markdown](https://experienceleague.adobe.com/docs/contributor/contributor-guide/writing-essentials/markdown.html?lang=pt-BR#custom-markdown-extensions) (o tipo do Adobe Markdown é muito semelhante ao Markdown comum).
...
* Sua integração com o Adobe deve estar em uma fase de teste com seu destino implantado em um ambiente de preparo no [!DNL Adobe Experience Platform].

## Instruções de alto nível para criar a documentação para seu destino no [!DNL Adobe Experience Platform] {#high-level-instructions}

Em um alto nível, para criar a documentação para o seu destino, você precisa [criar uma bifurcação](https://experienceleague.adobe.com/docs/contributor/contributor-guide/setup/local-repo.html?lang=pt-BR#fork-the-repository) do repositório de documentação do [!DNL Adobe Experience Platform] e editar o [modelo de documentação fornecido](./self-service-template.md) em uma nova ramificação. Use o modelo fornecido pela Adobe para criar uma nova página de destino. Abra uma solicitação de pull (PR) quando estiver pronto. As instruções para fazer isso estão mais abaixo, em [Etapas para criar sua nova página de destino](./documentation-instructions.md#steps-to-create-docs-page).
...
Para ajudá-lo a criar sua página de documentação, a Adobe preencheu previamente um [modelo de documentação](./self-service-template.md) para você. Mais abaixo, você pode encontrar instruções sobre como editar o modelo e abrir uma solicitação de pull. A equipe de documentação do Adobe revisará e publicará a documentação para o novo destino.
...
Você pode usar a interface da Web do GitHub ou seu ambiente local para criar a documentação para seu novo destino no [!DNL Adobe Experience Platform]. Encontre instruções para ambas as opções nos links abaixo:
