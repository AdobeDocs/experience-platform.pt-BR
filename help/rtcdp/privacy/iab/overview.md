...
**O SDK não faz interface com nenhum CMPs pronto**. Cabe a você determinar como integrar o SDK ao seu site, acompanhar as mudanças de consentimento no CMP e chamar o comando apropriado.
