...
[!DNL DialogTech] é uma extensão do analytics no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte [Site da Dialogtech](https://www.dialogtech.com/).
...
Para instalar o [!DNL DialogTech] extensão:
