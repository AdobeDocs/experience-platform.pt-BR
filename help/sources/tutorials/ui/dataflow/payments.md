...
title: Configurar um fluxo de dados para uma conexão de fonte de pagamento na interface do usuário
topic-legacy: overview
type: Tutorial
description: Um fluxo de dados é uma tarefa agendada que recupera e assimila dados de uma fonte para um conjunto de dados da Adobe Experience Platform. Este tutorial fornece etapas para configurar um novo fluxo de dados usando sua conta de pagamentos.
...
# Configurar um fluxo de dados para uma conexão de pagamento na interface do usuário

Um fluxo de dados é uma tarefa agendada que recupera e assimila dados de uma fonte para um conjunto de dados da Adobe Experience Platform. Este tutorial fornece etapas para configurar um novo fluxo de dados usando sua conta de pagamentos.
...
Além disso, este tutorial requer que você já tenha criado uma conta de pagamentos. Uma lista de tutoriais para criar diferentes conectores de pagamento na interface do usuário pode ser encontrada na [visão geral dos conectores de origem](../../../home.md).

## Selecionar dados

Depois de criar sua conta de pagamentos, a etapa **[!UICONTROL Selecionar dados]** é exibida, fornecendo uma interface interativa para explorar sua hierarquia de arquivos.
...
![conjunto de dados use-existing](../../../images/tutorials/dataflow/payments/existing-dataset.png)
...
Na tela **[!UICONTROL Dataflows]**, selecione o nome do fluxo de dados que deseja desativar.

![browse-dataset-flow](../../../images/tutorials/dataflow/payments/view-dataset-flows.png)

A coluna **[!UICONTROL Properties]** aparece no lado direito da tela. Este painel contém um botão de alternância **[!UICONTROL Enabled]**. Clique no botão de alternância para desativar o fluxo de dados. A mesma alternância pode ser usada para reativar um fluxo de dados depois que ele for desativado.
