...
Para obter informações sobre as opções de configuração de extensão, consulte o [Página de extensão do Adobe Target](../../../tags/extensions/client/target/overview.md) na documentação das tags.
