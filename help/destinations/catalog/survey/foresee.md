...
title: Prever destino de extensão
description: A extensão Foresee é um destino de pesquisa no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do [!DNL Foresee] {#foresee-extension}

## Visão geral {#overview}

Configure as implantações de produto do [!DNL ForeSee] usando tags.

[!DNL Foresee] é uma extensão de pesquisa em [!DNL Adobe Experience Platform]. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100164.html).
...
![Prever extensão](../../assets/catalog/survey/foresee/catalog.png)
...
Para instalar a extensão [!DNL Foresee]:
...
Para obter informações sobre as opções de configuração de extensão, consulte a [Prever página de extensão](https://exchange.adobe.com/experiencecloud.details.100164.html) no Adobe Exchange.
