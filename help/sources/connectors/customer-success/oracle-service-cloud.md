...
title: Visão geral do Conector de origem do Oracle Service Cloud
...
# (Beta) Origem da nuvem do Oracle Service

>[!NOTE]
>
>A origem da Nuvem do Oracle Service está na versão beta. Consulte a [visão geral das origens](../../home.md#terms-and-conditions) para obter mais informações sobre o uso de fontes rotuladas como beta.
