...
Os conectores do Source no Adobe Experience Platform fornecem a capacidade de assimilar dados obtidos externamente de forma programada. Este tutorial fornece etapas para criar um [!DNL Apache Spark] no conector de origem [!DNL Azure HDInsights] usando a interface do usuário [!DNL Platform].
...
Para acessar sua conta do [!DNL Spark] em [!DNL Platform], você deve fornecer os seguintes valores:
...
Depois de obter as credenciais necessárias, siga as etapas abaixo para vincular sua conta do [!DNL Spark] e conectar-se ao [!DNL Platform].
...
Seguindo este tutorial, você estabeleceu uma conexão com sua conta do [!DNL Spark]. Agora você pode seguir para o próximo tutorial e [configurar um fluxo de dados para trazer dados para o  [!DNL Platform]](../../dataflow/databases.md).
