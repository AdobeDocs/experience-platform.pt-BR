...
- [Guia do usuário do Construtor de segmentos](../../segmentation/tutorials/create-a-segment.md): a Platform permite que você crie e acesse segmentos facilmente, bem como use diferentes blocos de construção para caracterizar ainda mais seus segmentos.
