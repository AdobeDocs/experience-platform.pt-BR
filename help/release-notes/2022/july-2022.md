...
| Grupo de campos | [[!UICONTROL Detalhes de interação com a mídia]](https://github.com/adobe/xdm/blob/master/docs/reference/fieldgroups/experience-event/experienceevent-media.schema.json) | Um grupo de campos para o [!UICONTROL XDM ExperienceEvent] classe que captura detalhes sobre uma interação de mídia. |
