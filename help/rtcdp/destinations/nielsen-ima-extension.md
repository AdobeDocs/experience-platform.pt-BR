...
description: A extensão Nielsen IMA Handler é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão Nielsen IMA Handler é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do Manipulador IMA Nielsen {#nielsen-ima-extension}

## Visão geral {#overview}

Nielsen IMA Handler é uma extensão de análise na Adobe Real-time Customer Data Platform.
...
Para instalar a extensão Nielsen IMA Handler:
