...
| Autenticação Adobe Pass | ✓ | N/D | Os dados armazenados do titular dos dados são excluídos do sistema. | <ul><li>[Acessar/excluir documentação](https://tve.helpdocsonline.com/how-to-make-a-privacy-request)</li><li>O Pass não tem a capacidade de transferir dados, portanto, as solicitações de recusa de venda não são aplicáveis.</li></ul> |
