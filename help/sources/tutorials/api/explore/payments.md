...
# Explore um sistema de pagamento usando a API de Serviço de Fluxo
...
Este tutorial usa a API de Serviço de Fluxo para explorar aplicativos de pagamento.
...
Usando a ID de conexão para seu sistema de pagamentos, você pode explorar suas tabelas de dados executando solicitações GET. Use a chamada a seguir para localizar o caminho da tabela que deseja inspecionar ou assimilar na Plataforma.
...
Uma resposta bem-sucedida retorna uma matriz de tabelas do seu sistema de pagamentos. Encontre a tabela que você deseja trazer para a Plataforma e anote sua `path` propriedade, pois é necessário fornecê-la na próxima etapa para inspecionar sua estrutura.
