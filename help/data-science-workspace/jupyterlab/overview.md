...
No [!DNL JupyterLab], você pode encerrar sua sessão para impedir que outros recursos sejam usados. Comece selecionando o **ícone de energia** ![ícone de energia](../images/jupyterlab/user-guide/power_button.png) e selecione **[!UICONTROL Desligar]** no popover que parece encerrar sua sessão. As sessões de notebook são encerradas automaticamente após 12 horas sem atividade.

Para reiniciar [!DNL JupyterLab], selecione o **ícone de reiniciar** ![ícone de reiniciar](../images/jupyterlab/user-guide/restart_button.png) localizado diretamente à esquerda do ícone de energia e selecione **[!UICONTROL Reiniciar]** no popover exibido.
