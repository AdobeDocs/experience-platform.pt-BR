...
Ao seguir este tutorial, você criou com sucesso um fluxo de dados para trazer dados da fonte de sucesso do cliente para a Platform. Os dados de entrada agora podem ser usados por serviços [!DNL Platform] downstream, como [!DNL Real-Time Customer Profile] e [!DNL Data Science Workspace]. Consulte os seguintes documentos para obter mais detalhes:
