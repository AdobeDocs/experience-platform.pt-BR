...
Para localizar as extensões de inicialização na interface CDP em tempo real do Adobe, navegue até **[!UICONTROL Destinos > Catálogo]** e selecione **[!UICONTROL Extensões]** no filtro **[!UICONTROL Tipos]** .
