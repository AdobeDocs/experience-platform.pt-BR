...
Você deve ter uma conexão ativa com um aplicativo de pagamentos para explorar os arquivos de origem e a estrutura de arquivos. Leia os seguintes documentos para obter mais informações:
