...
| `auth.params.host` | O domínio exclusivo específico da sua conta criado durante o processo de registro. O formato do subdomínio é `https://yoursubdomain.zendesk.com`. |
