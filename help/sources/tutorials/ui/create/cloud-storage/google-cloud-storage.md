...
Os conectores de origem no Adobe Experience Platform fornecem a capacidade de assimilar dados de origem externa de forma programada. Este tutorial fornece etapas para a criação de um conector de origem [!DNL Google Cloud Storage] (a seguir denominado &quot;GCS&quot;) usando a interface do [!DNL Platform] usuário.
...
Depois de reunir as credenciais necessárias, siga as etapas abaixo para criar uma nova conta GCS para conexão [!DNL Platform].
...
Ao seguir este tutorial, você estabeleceu uma conexão com sua conta GCS. Agora você pode continuar para o próximo tutorial e [configurar um fluxo de dados para trazer dados do seu armazenamento em nuvem para o Platform](../../dataflow/batch/cloud-storage.md).