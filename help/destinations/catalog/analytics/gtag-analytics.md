...
Enviar dados para [!DNL Google Analytics], [!DNL Google Ads], e o [!DNL Google Marketing Platform] via [!DNL Google's Global Site Tag]ou gtag.js. É possível configurar várias contas por produto.
...
![Extensão global de tag do site da Google](../../assets/catalog/analytics/gtag-analytics/catalog.png)
...
Para instalar o [!DNL Google Global Site Tag] extensão:
...
Para obter informações sobre as opções de configuração de extensão, consulte as [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101437.google-global-site-tag-gtag.html) página.
