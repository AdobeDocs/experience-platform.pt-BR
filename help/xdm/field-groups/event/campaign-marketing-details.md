...
title: Grupo de campos de esquema de detalhes de marketing da campanha
description: Saiba mais sobre o grupo de campos de esquema Detalhes de marketing da campanha.
...
[!UICONTROL Detalhes de Marketing da Campanha] é um grupo de campos de esquema padrão para a [[!DNL XDM ExperienceEvent] classe](../../classes/experienceevent.md), usado para descrever informações de campanha de marketing, como grupo de campanha, nome e código de rastreamento.

![](../../images/field-groups/campaign-marketing-details.png)

| Propriedade | Tipo de dados | Descrição |
| --- | --- | --- |
| `marketing` | [Marketing](../../data-types/marketing.md) | Um objeto que descreve informações de campanha de marketing, como grupo de campanha, nome e código de rastreamento. |
