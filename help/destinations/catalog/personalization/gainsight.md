...
# Extensão do [!DNL Gainsight] {#gainsight-extension}

## Visão geral {#overview}

O [!DNL Gainsight] capacita os proprietários de produtos com as ferramentas para entender o comportamento do usuário, impulsionar a adoção de produtos e coletar comentários dos usuários.

[!DNL Gainsight] é uma extensão de personalização em [!DNL Adobe Experience Platform]. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).
...
Para obter informações sobre as opções de configuração de extensão e suporte à instalação, consulte a [página do Gainsight no Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).
