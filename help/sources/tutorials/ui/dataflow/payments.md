...
# Criar um fluxo de dados para uma fonte de pagamentos na interface do usuário

Um fluxo de dados é uma tarefa agendada que recupera e assimila dados de uma fonte para um conjunto de dados no Adobe Experience Platform. Este tutorial fornece etapas sobre como criar um fluxo de dados para uma fonte de pagamentos usando a interface do usuário da plataforma.

>[!NOTE]
>
>Para criar um fluxo de dados, você já deve ter uma conta autenticada com uma fonte de pagamentos. Uma lista de tutoriais para criar diferentes contas de origem de pagamentos na interface do usuário pode ser encontrada no [visão geral das fontes](../../../home.md#payments).
...
Depois de criar sua conta de origem de pagamentos, a **[!UICONTROL Adicionar dados]** será exibida, fornecendo uma interface para explorar a hierarquia da tabela da conta da fonte de pagamentos.
...
Ao seguir este tutorial, você criou com sucesso um fluxo de dados para trazer dados da sua fonte de pagamentos para a Platform. Os dados recebidos agora podem ser usados pelo downstream [!DNL Platform] serviços como [!DNL Real-time Customer Profile] e [!DNL Data Science Workspace]. Consulte os seguintes documentos para obter mais detalhes:
