...
Para inspecionar a estrutura de uma tabela do seu sistema de pagamentos, execute uma solicitação de GET enquanto especifica o caminho de uma tabela como um parâmetro de query.
