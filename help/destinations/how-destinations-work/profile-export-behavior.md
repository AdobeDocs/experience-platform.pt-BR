...
Os [destinos da empresa](/help/destinations/destination-types.md#streaming-profile-export) no Experience Platform são Amazon Kinesis, Hubs de Eventos do Azure e API HTTP.
