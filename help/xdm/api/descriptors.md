...
Os descritores de esquema são metadados no nível do locatário, o que significa que são exclusivos de sua organização e todas as operações do descritor ocorrem no contêiner do locatário.
