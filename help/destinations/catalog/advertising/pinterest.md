---
keywords: Pinterest; pinterest; Rastreamento de conversão do Pinterest; Rastreamento de conversão do pintrest
...
Para obter informações sobre as opções de configuração de extensão e o suporte de instalação, consulte a página [Pinterest Conversion Tracking no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100523.pinterest-conversion-tracking-for-adobe-launch.html).
