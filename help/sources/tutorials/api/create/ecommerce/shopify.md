...
title: Criar uma conexão de origem do conector Shopify usando a API de serviço de fluxo
topic: overview
type: Tutorial
description: Saiba como conectar o Shopify à Adobe Experience Platform usando a API de Serviço de Fluxo.
...
# Criar uma conexão de origem [!DNL Shopify] usando a API [!DNL Flow Service]
