...
# Gerenciar políticas de uso de dados na interface do usuário {#user-guide}
...
>[!NOTE]
>
>Para obter informações sobre como gerenciar políticas de controle de acesso na interface do usuário, consulte [guia da interface do usuário de controle de acesso baseado em atributos](../../access-control/abac/ui/policies.md) em vez disso.
...
Se você tiver acesso às políticas de consentimento, selecione a variável **[!UICONTROL Políticas de consentimento]** alterne para exibi-los na [!UICONTROL Procurar] guia .
