...
>abstract="Para que um segredo possa ser utilizado pelo encaminhamento de eventos, ele deve ser atribuído a um ambiente existente. Se você não tiver ambientes criados para sua propriedade de encaminhamento de eventos, será necessário configurá-los antes de continuar."
...
A próxima tela permite configurar os detalhes do segredo. Para que um segredo possa ser utilizado pelo encaminhamento de eventos, ele deve ser atribuído a um ambiente existente. Se você não tiver ambientes criados para sua propriedade de encaminhamento de eventos, consulte o guia em [ambientes](../publishing/environments.md) para obter orientação sobre como configurá-los antes de continuar.
