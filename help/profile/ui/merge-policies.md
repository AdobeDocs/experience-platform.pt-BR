...
Para trabalhar com carimbos de data e hora personalizados usando a API, consulte o Apêndice do guia [de ponto final das políticas de](../api/merge-policies.md) mesclagem e a seção sobre como [usar carimbos de data e hora](../api/merge-policies.md#custom-timestamps)personalizados.
...
Você pode modificar uma política de mesclagem existente por meio da guia [!UICONTROL Mesclar políticas] selecionando o nome **[!UICONTROL da]** Política para a política de mesclagem que deseja editar.
