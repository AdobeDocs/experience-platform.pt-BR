...
description: Saiba como as Dicas do cliente do agente-usuário funcionam no SDK da Web. As dicas do cliente permitem que os proprietários do site acessem grande parte das mesmas informações disponíveis na sequência Agente do usuário, mas de uma maneira mais preservada da privacidade.
