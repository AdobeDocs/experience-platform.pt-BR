---
keywords: Experience Platform;home;popular topics;armazenamento de nuvem conector;armazenamento de nuvem
solution: Experience Platform
title: Configurar um fluxo de dados para um conector de transmissão de Armazenamentos na nuvem na interface do usuário
topic: overview
type: Tutorial
...
# Configurar um fluxo de dados para uma conexão de streaming de armazenamentos na nuvem na interface do usuário

Um fluxo de dados é uma tarefa programada que recupera e ingere dados de uma fonte para um conjunto de dados [!DNL Platform]. Este tutorial fornece etapas para configurar um novo fluxo de dados usando o conector base do armazenamento em nuvem.
...
Além disso, este tutorial requer que você já tenha criado um conector de armazenamento em nuvem. Uma lista de tutoriais para criar conectores de armazenamento de nuvem diferentes na interface do usuário pode ser encontrada na [visão geral dos conectores de origem](../../../../home.md).

## Selecionar dados

Depois de criar o conector de armazenamento em nuvem, a etapa *Selecionar dados* é exibida, fornecendo uma interface para selecionar a qual fluxo você fará o stream de dados.
...
Na área de trabalho **[!UICONTROL Origens]**, clique na guia **[!UICONTROL Procurar]**. Em seguida, clique no nome da conexão que está associada ao fluxo de dados ativo que você deseja desativar.
