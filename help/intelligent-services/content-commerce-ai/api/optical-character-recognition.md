...
description: Na API AI de Conteúdo e Comércio, o serviço de Presença de Texto / Reconhecimento Ótico de Caracteres (OCR) pode indicar se o texto está presente em uma determinada imagem. Se houver texto, o OCR poderá retornar o texto.
...
Uma resposta bem-sucedida retorna o texto que foi detectado na matriz `feature_value`. O texto é lido e retornado de cima para baixo da esquerda para a direita. Isso significa que se &quot;Eu amo Adobe&quot; foi detectado, sua carga retorna &quot;Eu&quot;, &quot;Amor&quot; e &quot;Adobe&quot; em objetos separados. No objeto, você recebe um `feature_name` que contém a palavra e um `feature_value` que contém uma métrica de confiança para esse texto.
