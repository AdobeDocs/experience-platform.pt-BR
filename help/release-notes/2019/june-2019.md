...
| Agendando | Integrado ao [!DNL Platform] Serviço de orquestração para automatizar o treinamento do modelo, a pontuação e os pipelines de recursos com cronogramas definidos pelo usuário por meio de APIs. |
