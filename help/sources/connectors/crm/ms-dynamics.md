...
topic: overview
description: A documentação abaixo fornece informações sobre como conectar o Microsoft Dynamics à plataforma usando APIs ou a interface do usuário.
...
A documentação abaixo fornece informações sobre como se conectar [!DNL Microsoft Dynamics] a [!DNL Platform] APIs ou à interface do usuário:

## Conectar-se [!DNL Microsoft Dynamics] a [!DNL Platform] APIs
...
## Conectar-se [!DNL Microsoft Dynamics] à [!DNL Platform] interface do usuário
