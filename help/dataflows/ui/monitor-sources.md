...
>abstract="A exibição Assimilação de origem contém informações sobre status da atividade de dados e métricas no serviço do data lake, incluindo registros assimilados e registros com falha. Consulte o guia de definição de métrica para saber mais sobre métricas e gráficos."
>text="Learn more in documentation"

>[!CONTEXTUALHELP]
>id="platform_monitoring_dataflow_run_details_ingestion"
>title="Detalhes da execução do fluxo de dados"
>abstract="O processamento de fontes contém informações sobre o status da atividade de dados e as métricas no serviço do data lake, incluindo registros assimilados e registros com falha. Consulte o guia de definição de métrica para saber mais sobre métricas e gráficos."
>text="Learn more in documentation"
