...
user-guide-title: Conexões do Real-time Customer Data Platform
breadcrumb-title: Conexões do Real-time Customer Data Platform
...
# Conexões do Real-time Customer Data Platform {#rtcdp-connections}

- [Visão geral das conexões RTCDP](home.md)
