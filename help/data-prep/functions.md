...
| Função | Descrição | Parâmetros | Sintaxe | Expressão | Saída de exemplo |
| -------- | ----------- | ---------- | -------| ---------- | ------------- |
| get_url_protocol | Retorna o protocolo do URL fornecido. Se a entrada for inválida, retornará null. | <ul><li>URL: **Obrigatório** A URL da qual o protocolo precisa ser extraído.</li></ul> | get_url_protocol&#x200B;(URL) | get_url_protocol(&quot;&#x200B;.adobe.com/home&quot;) | https |
