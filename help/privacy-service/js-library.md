...
Você também pode instalar a biblioteca por meio de uma extensão de tag. Consulte a visão geral no [Extensão de tag do Adobe Privacy](../tags/extensions/client/privacy/overview.md) para obter mais informações.
