---
keywords: Experience Platform; home; tópicos populares; MariaDB; mariadb; Maria DB; maria db
...
A documentação abaixo fornece informações sobre como se conectar [!DNL MariaDB] para [!DNL Platform] usando APIs ou a interface do usuário:

## Connect [!DNL MariaDB] para [!DNL Platform] uso de APIs
...
## Connect [!DNL MariaDB] para [!DNL Platform] uso da interface do usuário
