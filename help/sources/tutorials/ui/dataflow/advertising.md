...
Além disso, este tutorial exige que você já tenha criado uma conta publicitária. Uma lista de tutoriais para criar diferentes conectores de pagamento na interface do usuário pode ser encontrada na [visão geral dos conectores de origem](../../../home.md).

## Selecionar dados

Depois de criar sua conta publicitária, a etapa **[!UICONTROL Selecionar dados]** é exibida, fornecendo uma interface interativa para explorar sua hierarquia de arquivos.
...
A caixa de diálogo **[!UICONTROL Selecionar esquema]** é exibida. Selecione o schema que deseja aplicar ao novo conjunto de dados e clique em **[!DNL Done]**.
