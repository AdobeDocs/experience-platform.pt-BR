...
![Adobe Experience Cloud destacando o produto Permissões.](assets/permissions/permissions-product.png)
...
![Imagem mostrando o cartão de produto Coleção de dados no Admin Console](assets/permissions/platform-permission-card.png)
...
![Imagem mostrando o cartão de produto Coleção de dados no Admin Console](assets/permissions/data-collection-card.png)
...
![Imagem mostrando os perfis de produto para a Coleção de dados na Admin Console](assets/permissions/new-profile.png)
...
![Imagem mostrando a guia de permissões de um perfil de produto no Admin Console](assets/permissions/edit-permission-categories.png)
...
![Imagem mostrando permissões adicionadas sob a coluna incluída](assets/permissions/added-permissions.png)
...
![Imagem mostrando a seção de direitos da empresa em permissões](assets/permissions/switch-category.png)

Selecione **[!UICONTROL Save]** quando terminar de configurar as permissões.

![Imagem mostrando a configuração de permissão sendo salva para o perfil do produto](assets/permissions/save-permissions.png)

A visualização do perfil de produto será exibida novamente com as permissões adicionadas.

![Imagem mostrando as permissões adicionadas no perfil do produto](assets/permissions/permissions-added.png)
...
![Imagem mostrando a guia Usuários em um perfil de produto no Admin Console](assets/permissions/manage-users.png)
