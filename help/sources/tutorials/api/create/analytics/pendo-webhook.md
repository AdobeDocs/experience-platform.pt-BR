---
title: Criar uma conexão de origem e um fluxo de dados para o Pendo usando a API do Serviço de fluxo
description: Saiba como conectar o Adobe Experience Platform ao Pendo usando a API do Serviço de fluxo.
badge: "Beta"
...
# Criar uma conexão de origem e um fluxo de dados para [!DNL Pendo] usando a API do Serviço de Fluxo
...
O tutorial a seguir o orienta pelas etapas para criar uma conexão de origem e um fluxo de dados para trazer [[!DNL Pendo]](https://Pendo.com/) dados de evento para a Adobe Experience Platform usando a variável [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
## Connect [!DNL Pendo] para a plataforma usando a [!DNL Flow Service] API {#connect-platform-to-flow-api}

O seguinte descreve as etapas necessárias para criar uma conexão de origem e um fluxo de dados para trazer seus [!DNL Pendo] dados de eventos para o Experience Platform.
...
| `data.format` | O formato do [!DNL Pendo] dados que você deseja assimilar. Atualmente, o único formato de dados compatível é `json`. |
...
O último passo para trazer dados do [!DNL Pendo] para Platform é criar um fluxo de dados. Por enquanto, você terá os seguintes valores obrigatórios preparados:
...
### Obter o URL do terminal de transmissão {#get-streaming-url}
...
Uma resposta bem-sucedida retorna informações sobre o fluxo de dados, incluindo o URL do terminal, marcado como `inletUrl`. Consulte a [Configurar Webhook](../../../ui/create/analytics/pendo-webhook.md#get-streaming-endpoint-url) para obter o valor necessário.
