...
Este tutorial o orienta pelas etapas para criar uma conexão básica para [!DNL Google ServiceNow] usando a [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
