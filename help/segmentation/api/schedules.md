...
| `value` | O valor atualizado do estado do agendamento. Esse valor pode ser definido como &quot;ativo&quot; ou &quot;inativo&quot; para ativar ou desativar o agendamento. Observe que você **cannot** desative um agendamento se a organização tiver sido habilitada para transmissão. |
...
| `,` | Esse valor é usado para especificar valores adicionais. Por exemplo, se você colocar `MON, FRI, SAT` no campo dia da semana, isso significaria que os dias da semana incluiriam segunda, sexta e sábado. |
