...
O [TABELA DE SOLTAÇÕES](../sql/syntax.md#drop-table) remove fisicamente apenas um ativo de dados do [!DNL Data Lake] quando existe uma única referência à tabela em todos os bancos de dados em sua organização.
