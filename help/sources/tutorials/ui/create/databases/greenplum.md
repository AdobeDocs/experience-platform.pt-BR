...
Os conectores de origem no Adobe Experience Platform fornecem a capacidade de assimilar dados de origem externa de forma programada. Este tutorial fornece etapas para criar um conector de [!DNL GreenPlum] origem usando a interface do [!DNL Platform] usuário.
...
Depois de reunir as credenciais necessárias, siga as etapas abaixo para criar uma nova [!DNL GreenPlum] conta à qual se conectar [!DNL Platform].
...
Na categoria *[!UICONTROL Bancos]* de dados, selecione **[!UICONTROL GreenPlum]** clique **no ícone + (+)** para criar um novo [!DNL GreenPlum] conector.
...
Se você estiver usando novas credenciais, selecione **[!UICONTROL Nova conta]**. No formulário de entrada exibido, forneça à conexão um nome, uma descrição opcional e suas [!DNL GreenPlum] credenciais. Quando terminar, selecione **[!UICONTROL Connect]** e aguarde algum tempo para a nova conta ser estabelecida.
...
Ao seguir este tutorial, você estabeleceu uma conexão com sua [!DNL GreenPlum] conta. Agora você pode continuar com o próximo tutorial e [configurar um fluxo de dados para trazer dados para o Platform](../../dataflow/databases.md).