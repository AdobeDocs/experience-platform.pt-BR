...
Esses tipos de evento serão mostrados em uma lista suspensa se você estiver usando a extensão Iniciar ou você sempre poderá enviá-los sem Iniciar. Eles podem ser passados como parte da `xdm` opção.
