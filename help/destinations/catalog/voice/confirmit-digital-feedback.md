...
[!DNL Confirmit Digital Feedback] ajuda a transformar o tráfego do site em insights em tempo real. Com [!DNL Confirmit], pesquisas discretas e altamente direcionadas podem ser exibidas de acordo com suas necessidades, incentivando os visitantes a fornecer feedback, como:
...
Para instalar o [!DNL Confirmit] Extensão do Digital Feedback:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte [Página Confirmar feedback digital no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
