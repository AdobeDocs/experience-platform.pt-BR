...
| `accessTokenRequest.httpTemplate.requestBody.value` | String | Use a linguagem de modelo para personalizar campos na solicitação HTTP para o endpoint do token de acesso. Para obter informações sobre como usar modelos para personalizar campos, consulte o [convenções de modelos](#templating-conventions) seção. |
...
| `accessTokenRequest.responseFields.value` | String | Use a linguagem de modelo para acessar campos na resposta HTTP do seu ponto de extremidade de token de acesso. Para obter informações sobre como usar modelos para personalizar campos, consulte o [convenções de modelos](#templating-conventions) seção. |
...
| `accessTokenRequest.validations.actualValue.value` | String | Use a linguagem de modelo para acessar campos na resposta HTTP. Para obter informações sobre como usar modelos para personalizar campos, consulte o [convenções de modelos](#templating-conventions) seção. |
...
| `accessTokenRequest.validations.expectedValue.value` | String | Use a linguagem de modelo para acessar campos na resposta HTTP. Para obter informações sobre como usar modelos para personalizar campos, consulte o [convenções de modelos](#templating-conventions) seção. |
