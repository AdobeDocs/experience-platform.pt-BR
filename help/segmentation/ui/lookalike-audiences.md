...
![O botão Públicos-alvo está realçado, assim como o público-alvo básico que está sendo usado para modelagem por semelhança.](../images/ui/lookalike-audiences/browse.png)
...
![A guia Insights semelhantes está destacada, exibindo os insights semelhantes para o público base.](../images/ui/lookalike-audiences/look-alike-insights.png)
...
![O gráfico de similaridade e alcance está destacado.](../images/ui/lookalike-audiences/similarity-and-reach.png)
...
![A seção Públicos-alvo Semelhantes está destacada.](../images/ui/lookalike-audiences/select-laa.png)
...
![A seção de fatores influentes é destacada.](../images/ui/lookalike-audiences/influential-factors.png)
...
![O botão [!UICONTROL Criar público-alvo semelhante] está realçado.](../images/ui/lookalike-audiences/create-look-alike-audience.png)
...
![O popover [!UICONTROL Criar um público-alvo semelhante] é exibido.](../images/ui/lookalike-audiences/create-audience.png)
...
![As informações básicas estão destacadas no popover [!UICONTROL Criar um público-alvo semelhante].](../images/ui/lookalike-audiences/basic-info.png)

Selecione **[!UICONTROL Criar]** para concluir a criação do seu público-alvo semelhante.

![O botão Criar está realçado no popover [!UICONTROL Criar um público-alvo semelhante].](../images/ui/lookalike-audiences/create-audience.png)
...
A página de detalhes do público-alvo é exibida. Para obter mais informações sobre esta página, leia a [seção de detalhes do público-alvo da visão geral do Portal de público](./audience-portal.md#audience-details).
