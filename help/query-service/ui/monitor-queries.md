...
As consultas que usam blocos anônimos para compreender suas instruções SQL são separadas em suas subconsultas individuais. Isso permite que você inspecione os detalhes da execução de cada bloco de consulta individualmente.
