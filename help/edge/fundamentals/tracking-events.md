...
>[!IMPORTANT]
>
>O `datasetId` opção suportada pela `sendEvent` foi descontinuado. Para substituir uma ID de conjunto de dados, use [substituições de configuração](../datastreams/overrides.md) em vez disso.
