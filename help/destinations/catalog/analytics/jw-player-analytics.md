---
keywords: Reprodutor JW;reprodutor Jw;Reprodutor JW;extensão jw;extensão JW
title: Extensão do JW Player Analytics (Beta)
description: A extensão JW Player Analytics (Beta) é um destino de análise na Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do [!DNL JW Player Analytics] (Beta) {#jw-player-analytics-extension}

## Visão geral {#overview}

Esta extensão instala o adaptador [!DNL JW Player] para conectar eventos [!DNL JW Player] ao Adobe Video Analytics. Aproveite o potencial do Adobe Video Analytics para obter insights detalhados e entender os hábitos de visualização de vídeo de seus clientes.

[!DNL JW Player Analytics] (Beta) é uma extensão do Analytics em [!DNL Adobe Experience Platform]. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html).
...
![Extensão de análise JW](../../assets/catalog/analytics/jw-analytics/catalog.png)
...
Para instalar a extensão do [!DNL JW Player Analytics] (Beta):
...
Para obter informações sobre as opções de configuração de extensão, consulte a [página de extensão do JW Player Analytics (Beta)](https://exchange.adobe.com/experiencecloud.details.101523.jw-player-analytics-launch-extension.html) no Adobe Exchange.
