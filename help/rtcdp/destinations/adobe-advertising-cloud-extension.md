...
description: A extensão do Adobe Advertising Cloud é um destino publicitário na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
Esta é a [!DNL Advertising Cloud] extensão para implementar tags de [!DNL Advertising Cloud] conversão e segmento para o DSP e o Search (atualmente, o DCO não é suportado).
...
Para instalar a extensão do Adobe Advertising Cloud:
