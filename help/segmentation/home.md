...
>abstract="Atualmente, o Platform oferece suporte a três métodos de avaliação de segmentos: segmentação por transmissão, segmentação em lote e segmentação de borda."

>[!CONTEXTUALHELP]
>id="platform_segments_evaluation_streaming"
>title="Avaliação de transmissão"
>abstract="A segmentação de transmissão é um processo contínuo de seleção de dados que atualiza seus segmentos em resposta à atividade do usuário."
...
Atualmente, o Platform oferece suporte a três métodos de avaliação de segmentos: segmentação por transmissão, segmentação em lote e segmentação de borda.
...
>abstract="Como alternativa a um processo de seleção de dados em andamento, a segmentação em lote move todos os dados de perfil de uma só vez pelas definições de segmento para produzir públicos correspondentes. Depois de criado, o segmento é salvo e armazenado para que você possa exportá-lo para uso."

Como alternativa a um processo de seleção de dados em andamento, a segmentação em lote move todos os dados de perfil de uma só vez pelas definições de segmento para produzir públicos correspondentes. Depois de criado, esse segmento é salvo e armazenado para que você possa exportá-lo para uso.
...
>abstract="A segmentação de borda é a capacidade de avaliar segmentos na Platform instantaneamente no Experience Edge, permitindo casos de uso de personalização de mesma página e próxima página."
