...
[!DNL Experience Cloud] O Serviço de ID é uma extensão de personalização no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a [página de extensão do Serviço de ID do Experience Cloud](../../../tags/extensions/web/id-service/overview.md) na documentação de tags.
...
Para obter informações sobre as opções de configuração de extensão e o suporte de instalação, consulte a [página de extensão do Serviço de ID do Experience Cloud](../../../tags/extensions/web/id-service/overview.md) na documentação de tags.
