...
| [[!DNL Adobe Journey Optimizer] suporte a datastreams](../../edge/datastreams/overview.md#aep) | O serviço Adobe Experience Platform para datastreams agora é compatível [!DNL Adobe Journey Optimizer]. Essa opção permite usar canais de entrada baseados na Web e no aplicativo em [!DNL Adobe Journey Optimizer]. |
