...
Os guias da API do cliente exigem uma compreensão funcional dos vários serviços da Platform envolvidos no uso da IA do cliente. Antes do start, reveja os seguintes documentos:
...
- [Guia](../../segmentation/tutorials/create-a-segment.md)do usuário do Construtor de segmentos: A Platform permite que você crie e acesse segmentos com facilidade, além de usar diferentes blocos componentes para caracterizar ainda mais seus segmentos.
