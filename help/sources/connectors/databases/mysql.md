...
topic: overview
description: Saiba como conectar o MySQL à Adobe Experience Platform usando APIs ou a interface do usuário.
...
[!DNL Experience Platform] fornece suporte para assimilar dados de um banco de dados de terceiros. [!DNL Platform] pode se conectar a diferentes tipos de bancos de dados, como relacional, NoSQL ou data warehouses. O suporte para provedores de banco de dados inclui MySQL.
...
A documentação abaixo fornece informações sobre como conectar o MySQL a [!DNL Platform] usando APIs ou a interface do usuário:

## Conectar MySQL a [!DNL Platform] usando APIs

- [Criar uma conexão de origem MySQL usando a API do Serviço de Fluxo](../../tutorials/api/create/databases/mysql.md)
...
## Conecte MySQL a [!DNL Platform] usando a interface do usuário
