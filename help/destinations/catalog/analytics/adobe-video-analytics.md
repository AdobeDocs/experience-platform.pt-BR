...
Para obter informações sobre as opções de configuração de extensão, consulte a [página de extensão Adobe Medium Analytics for Audio and Video](../../../tags/extensions/web/media-analytics/overview.md) na documentação [!DNL Experience Launch].
