...
Para criar uma ID de conexão base, faça uma solicitação POST para o ponto de extremidade `/connections` ao fornecer suas credenciais de autenticação [!DNL HP Vertica] como parte dos parâmetros de solicitação.
