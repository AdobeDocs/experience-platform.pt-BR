...
![Navegue até a instância do serviço da IA do cliente na interface do usuário do Adobe Experience Platform.](../images/insights/navigate-to-service.png)
...
![Painel da IA do cliente mostrando uma lista de instâncias de serviço com seus detalhes.](../images/insights/dashboard.png)

Selecione um nome de instância de serviço para começar.

![Captura de tela mostrando o processo para selecionar um nome de instância de serviço no painel da IA do cliente.](../images/insights/click-the-name.png)
...
![Página de aterrissagem dos insights da IA do cliente mostrando várias visualizações e opções para explorar insights.](../images/insights/landing_page_insights.png)
...
![Painel de instâncias de serviço mostrando detalhes como nome, descrição, frequência de pontuação e outras opções de configuração.](../images/user-guide/service-instance-panel.png)
...
![Mensagem de erro exibida para uma execução de pontuação com falha na IA do cliente.](../images/insights/failed-run.png)
...
![Popover de visualização do conjunto de dados da IA do cliente mostrando vários conjuntos de dados com uma chave codificada por cores para facilitar a identificação.](../images/insights/landing-show-more.png)
...
![Visualização de vários conjuntos de dados mostrando uma chave codificada por cores para facilitar a identificação dos conjuntos de dados usados na IA do cliente.](../images/insights/insights-multi-datasets.png)
...
![Popover de visualização do conjunto de dados mostrando detalhes adicionais para a instância selecionada.](../images/insights/dataset-preview.png)

### Editar uma instância

Para editar uma instância, selecione **[!UICONTROL Editar]** na navegação superior direita.

![Botão Editar na interface da IA do cliente.](../images/insights/edit-button.png)
...
![Popover Editar instância mostrando opções para modificar o nome, a descrição, o status e a frequência de pontuação de uma instância da IA do cliente.](../images/insights/edit-instance.png)
...
![Lista suspensa de ações que mostra opções como Clonar, Excluir, Pontuações de acesso e Exibir histórico de execuções.](../images/insights/more-actions.png)
...
![Visualização de perfis pontuados, categorizados em compartimentos de alta, média e baixa propensão, cada um representado por uma cor distinta.](../images/insights/scoring-summary.png)
...
![Visualização do anel de pontuação mostrando a distribuição de perfis entre compartimentos de alta, média e baixa propensão.](../images/insights/scoring-ring.png)
...
![Visualização que mostra a distribuição de pontuações em diferentes grupos de propensão na IA do cliente.](../images/insights/distribution-of-scores.png)
...
![Visualização de fatores influentes para cada classe de propensão, destacando os 10 principais fatores que influenciam o comportamento do cliente.](../images/insights/influential-factors.png)
...
![Visualização de detalhamento mostrando um detalhamento detalhado de fatores influentes para um bucket de propensão selecionado.](../images/insights/drilldown.png)
...
![Comparação de fatores de distribuição entre compartimentos de propensão, destacando diferenças em fatores influentes.](../images/insights/drilldown-compare.png)
...
![Botão para criar um segmento a partir de fatores influentes nos insights da IA do cliente.](../images/insights/influential-factors-create-segment.png)

![Botão para criar um segmento a partir de fatores influentes nos insights da IA do cliente.](../images/insights/create-segment.png)
...
![Interface para salvar segmentos mostrando campos para inserir o nome e a descrição do segmento antes de salvar.](../images/insights/segment-saving.png)
...
![Painel de segmentos exibindo uma lista de todos os segmentos disponíveis na interface do usuário do Experience Platform.](../images/insights/Segments-dashboard.png)
...
![Guia Resumo de desempenho mostrando taxas de churn ou conversão entre compartimentos de propensão, com opções para filtrar por intervalo de datas e exibir resultados de execução de pontuação individuais.](../images/insights/summary_tab.png)
...
![Visualização de compartimentos de propensão de churn mostrando a distribuição de perfis em categorias de alta, média e baixa propensão.](../images/insights/churn_tab.png)
...
![Seletor de datas mostrando opções para filtrar resultados por um intervalo de datas específico.](../images/insights/date_selector.png)
...
![Visualização de resultados de execução de pontuação individual mostrando a distribuição de perfis em categorias com churn/convertidas e sem churn/não convertidas.](../images/insights/scoring_tab.png)
...
![Gráfico de elevação que mostra melhoria do modelo preditivo em relação ao direcionamento aleatório. Valores altos de elevação de decis antecipados indicam um modelo forte.](../images/user-guide/lift-chart.png)
...
![Gráfico de ganhos que ilustra a porcentagem cumulativa de resultados positivos alcançados ao direcionar usuários de alta propensão versus direcionamento aleatório.](../images/user-guide/gains-chart.png)
