...
topic: tutorial
type: Tutorial
description: O Adobe Experience Platform Data Science Workspace fornece os meios para atingir sua meta usando a Receita de recomendações de produto pré-criada. Siga este tutorial para ver como você pode acessar e entender seus dados de varejo, criar e otimizar um Modelo de aprendizado de máquina e gerar insights no Data Science Workspace.
...
[!DNL Adobe Experience Platform] [!DNL Data Science Workspace] O fornece os meios para atingir sua meta usando a Receita de recomendações  [do produto pré-criada](../pre-built-recipes/product-recommendations.md). Siga este tutorial para ver como você pode acessar e entender seus dados de varejo, criar e otimizar um Modelo de aprendizado de máquina e gerar insights em [!DNL Data Science Workspace].
...
- [[!DNL Experience Data Model]](../../xdm/home.md): O esforço de padronização levado pela Adobe para definir esquemas padrão como  [!DNL Profile] e ExperienceEvent, para o Gerenciamento de experiência do cliente.
...
Faça logon em [Adobe Experience Platform](https://platform.adobe.com/) e selecione **[!UICONTROL Datasets]** para listar todos os conjuntos de dados existentes e selecionar o conjunto de dados que deseja explorar. Nesse caso, o conjunto de dados [!DNL Analytics] **Golden Data Set postValues**.

![](../images/models-recipes/model-walkthrough/dataset-browse.png)

A página de atividade do conjunto de dados é aberta, listando as informações relacionadas ao conjunto de dados. Você pode selecionar **[!UICONTROL Visualizar conjunto de dados]** próximo ao canto superior direito para examinar registros de amostra. Você também pode exibir o esquema do conjunto de dados selecionado. Selecione o link do schema no painel direito. Uma oferta é exibida, selecionar o link em **[!UICONTROL nome do schema]** abre o schema em uma nova guia.
...
O segundo componente do ciclo de vida [!DNL Data Science Workspace] envolve a criação de Fórmulas e Fórmulas. A Receita de recomendações de produto foi criada para gerar recomendações de produto em escala utilizando dados de compras anteriores e aprendizado de máquina.
...
### Explore a receita das recomendações de produto

Na Experience Platform, navegue até **[!UICONTROL Modelos]** na coluna de navegação à esquerda e selecione **[!UICONTROL Receitas]** na navegação superior para exibir uma lista de fórmulas disponíveis para sua organização.

![](../images/models-recipes/model-walkthrough/recipe-tab.png)

Em seguida, localize e abra a **[!UICONTROL Receita do Recommendations]** fornecida selecionando o nome. A página Visão geral da receita é exibida.

![](../images/models-recipes/model-walkthrough/Recipe-view.png)

Em seguida, no painel direito, selecione **[!UICONTROL Recommendations Input Schema]** para visualizar o esquema que alimenta a receita. Os campos de esquema &quot;[!UICONTROL itemId]&quot; e &quot;[!UICONTROL userId]&quot; correspondem a um produto comprado ([!UICONTROL interactionType]) por esse cliente em um horário específico ([!UICONTROL timestamp]). Siga as mesmas etapas para revisar os campos do **[!UICONTROL Esquema de saída do Recommendations]**.

![](../images/models-recipes/model-walkthrough/input-output.png)

Agora você revisou os esquemas de entrada e saída exigidos pela Receita das recomendações do produto. Prossiga para a próxima seção para saber como criar, treinar e avaliar um Modelo de recomendações de produto.
...
Na Experience Platform, navegue até **[!UICONTROL Modelos]** na coluna de navegação esquerda e selecione **[!UICONTROL Receitas]** na navegação superior. Isso exibe uma lista de fórmulas disponíveis para sua organização.Selecione a fórmula de recomendação do produto.

![](../images/models-recipes/model-walkthrough/recipe-tab.png)

Na página da fórmula, selecione **[!UICONTROL Criar Modelo]**.

![criar modelo](../images/models-recipes/model-walkthrough/create-model-recipe.png)

O fluxo de trabalho de criação de modelo começa selecionando uma fórmula. Selecione a **[!UICONTROL Receita de recomendações]** e selecione **[!UICONTROL Próximo]** no canto superior direito.
...
Na página **Visão geral do modelo**, selecione **[!UICONTROL Treinamento]** próximo ao canto superior direito para criar uma nova execução de treinamento. Selecione o mesmo conjunto de dados de entrada usado ao criar o modelo e selecione **[!UICONTROL Next]**.

![](../images/models-recipes/model-walkthrough/select-train.png)

A página **[!UICONTROL Configuração]** é exibida. Aqui você pode configurar o valor de execução de treinamento `num_recommendations`, também conhecido como um hiperparâmetro. Um modelo treinado e otimizado utilizará os hiperparâmetros de melhor desempenho com base nos resultados da execução do treinamento.
...
Em seguida, selecione o **[!UICONTROL Conjunto de dados de entrada de recomendações]** como o conjunto de dados de entrada de pontuação, que é o mesmo conjunto de dados usado quando você criou o Modelo e executou suas execuções de treinamento. Em seguida, selecione **[!UICONTROL Next]**.

![](../images/models-recipes/model-walkthrough/score-input.png)

Depois de ter seu conjunto de dados de entrada, selecione o **[!UICONTROL Conjunto de dados de saída do Recommendations]** como o conjunto de dados de saída da pontuação. Os resultados da pontuação são armazenados neste conjunto de dados como um lote.
...
Na página de execução da pontuação, selecione a execução de pontuação concluída e selecione **[!UICONTROL Visualizar conjunto de dados de resultados da pontuação]** no painel direito.
