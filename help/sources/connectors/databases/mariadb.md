...
A documentação abaixo fornece informações sobre como conectar o [!DNL MariaDB] ao [!DNL Experience Platform] usando APIs ou a interface do usuário:

## Conectar [!DNL MariaDB] a [!DNL Experience Platform] usando APIs
...
## Conectar [!DNL MariaDB] a [!DNL Experience Platform] usando a interface
