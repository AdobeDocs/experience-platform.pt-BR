...
Linguagem do Query do Perfil (PQL) oferta funciona para simplificar a interação com strings. Para obter mais informações sobre outras funções PQL, consulte a visão geral [do idioma do Query do](./overview.md)Perfil.
