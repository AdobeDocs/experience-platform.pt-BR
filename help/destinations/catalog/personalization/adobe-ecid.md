...
[!DNL Experience Cloud] O serviço de ID é uma extensão de personalização na Plataforma de dados do cliente em tempo real. Para obter mais informações sobre a funcionalidade de extensão, consulte a página [de extensão do Serviço de ID de](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) Experience Cloud na [!DNL Experience Platform Launch] documentação.
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte a página [de extensão do serviço de ID de](https://experienceleague.adobe.com/docs/launch/using/extensions-ref/adobe-extension/id-service-extension/overview.html) Experience Cloud na [!DNL Experience Launch] documentação.
