...
topic: overview
description: Este tutorial fornece etapas para a criação de um conector de origem do Salesforce Service Cloud (a seguir denominado "SSC") usando a interface do usuário da plataforma.
