...
| `"The user has not given permission to send push notifications."` | O usuário não concedeu permissão para notificação (`Notification.permission === "granted"`) |
...
A extensão de marca do Web SDK equivalente a este campo está usando a ação [[!UICONTROL Send Push Subscription]](/help/tags/extensions/client/web-sdk/actions/send-push-subscription.md) em uma regra de marca.
...
>* [API do Service Worker](https://developer.mozilla.org/pt-BR/docs/Web/API/Service_Worker_API)
