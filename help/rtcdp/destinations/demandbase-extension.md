...
description: A extensão Demandbase é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão Demandbase é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão Demandbase {#demandbase-extension}

## Visão geral {#overview}

Obtenha insights da conta Demandbase B2B diretamente no Adobe Analytics, onde você pode segmentar o tráfego e o comportamento por setor, Receita e suas contas de públicos alvos. Esta visualização baseada em conta fornece insights exclusivos sobre o envolvimento, a conversão e a origem de seus visitantes mais valiosos.

Demandbase é uma extensão de análise na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101605.html).
...
Para instalar a extensão Demandbase:
