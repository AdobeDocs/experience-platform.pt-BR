...
title: Criar um fluxo de dados para fontes de protocolos usando a API do serviço de fluxo
...
Este tutorial aborda as etapas para recuperar dados de uma fonte de protocolos e trazê-los para a plataforma usando [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
