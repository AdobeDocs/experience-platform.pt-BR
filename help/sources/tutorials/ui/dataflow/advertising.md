...
Um fluxo de dados é uma tarefa programada que recupera e ingere dados de uma fonte para um conjunto de dados da plataforma Adobe Experience. Este tutorial fornece etapas para configurar um novo fluxo de dados usando sua conta de publicidade.
...
Depois de criar sua conta de publicidade, a etapa *Selecionar dados* é exibida, fornecendo uma interface interativa para que você explore sua hierarquia de arquivos.
...
![programação](../../../images/tutorials/dataflow/advertising/schedule.png)
