...
A documentação abaixo fornece informações sobre como conectar o IBM DB2 à Platform usando APIs ou a interface do usuário:

## Conecte o IBM DB2 ao Platform usando APIs
...
## Conecte o IBM DB2 ao Platform usando a interface do usuário
