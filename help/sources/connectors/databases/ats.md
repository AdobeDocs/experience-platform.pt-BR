...
topic: overview
description: A documentação abaixo fornece informações sobre como conectar o Armazenamento de tabela do Azure à plataforma usando APIs ou a interface do usuário.
...
[!DNL Experience Platform] fornece suporte para assimilar dados de um banco de dados de terceiros. [!DNL Platform] pode se conectar a diferentes tipos de bancos de dados, como relacional, NoSQL ou data warehouses. O suporte para provedores de banco de dados inclui [!DNL Azure Table Storage].
...
A documentação abaixo fornece informações sobre como se conectar [!DNL Azure Table Storage] a [!DNL Platform] APIs ou à interface do usuário:

## Conectar-se [!DNL Azure Table Storage] a [!DNL Platform] APIs
...
## Conectar-se [!DNL Azure Table Storage] à [!DNL Platform] interface do usuário
