...
Na categoria *[!UICONTROL Bancos]* de dados, selecione **[!UICONTROL Couchbase]** seguida por **[!UICONTROL Adicionar dados]** para criar um novo [!DNL Couchbase] conector.
...
Ao seguir este tutorial, você estabeleceu uma conexão com sua [!DNL Couchbase] conta. Agora você pode continuar com o próximo tutorial e [configurar um fluxo de dados para trazer dados para a Plataforma](../../dataflow/databases.md).