...
Branch é uma extensão de publicidade na Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a [página de recursos](https://branch.io/features/) no site da Ramificação.
