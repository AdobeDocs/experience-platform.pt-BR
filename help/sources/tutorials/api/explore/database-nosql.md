...
Usando a ID de conexão do seu banco de dados, você pode explorar as tabelas de dados executando solicitações do GET. Use a chamada a seguir para localizar o caminho da tabela que deseja inspecionar ou assimilar em [!DNL Platform].
...
Uma resposta bem-sucedida retorna uma matriz de tabelas do seu banco de dados. Encontre a tabela que deseja trazer para [!DNL Platform] e anote sua propriedade `path`, pois é necessário fornecê-la na próxima etapa para inspecionar sua estrutura.
