---
title: Variáveis do Adobe Analytics mapeadas automaticamente no Adobe Experience Platform Web SDK
description: Saiba quais variáveis são mapeadas automaticamente no Adobe Analytics com o Experience Platform Web SDK
seo-description: Saiba quais variáveis são mapeadas automaticamente no Adobe Analytics com o Adobe Experience Platform Web SDK
keywords: adobe analytics;variáveis;analytics;mapeamento automático;mapeado automaticamente;
...
Abaixo está uma lista de variáveis que o Adobe Experience Platform Edge Network mapeia automaticamente no Adobe Analytics.
...
| `media.mediaTimed.primaryAssetReference.showType` | `c.a.media.type` | Mapeamento de dados de contexto do AppMeasurement `c.a.media.type` com VIDEO_SHOW_TYPE de conversão. |
