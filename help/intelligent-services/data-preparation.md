...
Para obter mais exemplos e informações sobre requisitos de dados históricos, visite o [IA do cliente](./customer-ai/data-requirements.md#data-requirements) ou [Attribution AI](./attribution-ai/input-output.md#data-requirements) seção requisitos de dados históricos na documentação de entrada/saída.
...
>[!IMPORTANT]
>
>Se você configurou um conector recentemente, deve verificar se o conjunto de dados tem o comprimento mínimo de dados necessário. Revise a seção dados históricos na [documentação de entrada/saída](./customer-ai/data-requirements.md) para a IA do cliente e verifique se você tem dados suficientes para a meta de previsão.
