...
Com os dados carregados, você pode usar o lado direito da interface para visualizar a hierarquia de arquivos. Selecione **[!UICONTROL Próximo]** para continuar.
