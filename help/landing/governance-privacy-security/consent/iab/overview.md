...
description: Saiba como configurar suas operações e schemas de dados para transmitir opções de consentimento do usuário ao ativar segmentos para destinos no Adobe Experience Platform.
