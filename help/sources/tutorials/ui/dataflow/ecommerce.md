...
Depois de criar sua conta de origem de comércio eletrônico, a variável **[!UICONTROL Adicionar dados]** é exibida, fornecendo uma interface para você explorar a hierarquia da tabela da conta de origem de comércio eletrônico.
