...
# Ajuda da plataforma de dados do cliente em tempo real {#rtcdp}
...
* Introdução {#intro}
   ...
   * CDP B2B Edition em tempo real {#rtcdpb2b-intro}
      * [Introdução à CDP B2B Edition em tempo real](./b2b-use-case.md)
* Administração {#admin}
...
* Segmentos {#segmentation}
   ...
   * [Segmentação B2B](segmentation/b2b.md)
