...
description: A extensão do Facebook Pixel é um destino de publicidade no Platform de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
[!DNL Facebook Pixel] é uma extensão de publicidade na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte o site [do](https://developers.facebook.com/docs/facebook-pixel/)Facebook Pixel.
