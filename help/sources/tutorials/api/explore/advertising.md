...
Usando a conexão básica para seu sistema de publicidade, você pode explorar suas tabelas de dados realizando solicitações de GET. Use a chamada a seguir para localizar o caminho da tabela que deseja inspecionar ou assimilar em [!DNL Platform].
...
Uma resposta bem-sucedida é uma matriz de tabelas de acordo com seu sistema de publicidade. Encontre a tabela que deseja trazer para [!DNL Platform] e anote sua propriedade `path`, conforme necessário na próxima etapa para inspecionar sua estrutura.
