...
seo-title: Extensão da Adobe Advertising Cloud
description: A extensão da Adobe Advertising Cloud é um destino de publicidade na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
Esta é a extensão da Advertising Cloud para implementar a conversão da Advertising Cloud e tags de segmento para DSP e Search (atualmente, o DCO não é compatível).

A Adobe Advertising Cloud é uma extensão de publicidade na Adobe Real-time Customer Data Platform.
...
![Extensão da Adobe Advertising Cloud](/help/rtcdp/destinations/assets/adobe-advertising-cloud-extension.png)
...
Para instalar a extensão da Adobe Advertising Cloud:
