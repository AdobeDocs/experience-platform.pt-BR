---
keywords: D&B Visitor Intelligence;D&B;extensão de inteligência de visitantes
title: Extensão D&B Visitor Intelligence
description: A extensão D&B Visitor Intelligence é um destino de personalização no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# [!DNL D&B Visitor Intelligence] extensão {#dnb-extension}

## Visão geral {#overview}

Analise visitantes desconhecidos e converta-os em clientes potenciais.

[!DNL D&B Visitor Intelligence] é uma extensão de personalização no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte [Site da D&amp;B](https://www.dnb.com/).
...
![Extensão D&amp;B Visitor Intelligence](../../assets/catalog/personalization/dnb/catalog.png)
