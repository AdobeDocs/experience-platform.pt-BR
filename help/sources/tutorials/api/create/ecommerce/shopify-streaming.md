...
## Transmitir dados do [!DNL Shopify] para a plataforma usando a API do Serviço de Fluxo

Veja a seguir as etapas que você precisa realizar para criar uma conexão de origem e um fluxo de dados para transmitir seus dados do [!DNL Shopify] para a Platform.
...
| `data.format` | O formato dos dados [!DNL Shopify] que você deseja trazer para a Platform. |
...
A última etapa para trazer dados de [!DNL Shopify] para a Platform é criar um fluxo de dados. Até agora, você tem os seguintes valores necessários preparados:
