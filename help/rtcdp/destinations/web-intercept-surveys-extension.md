...
description: A extensão do Pesquisa de intercepto do QuestionPro é um destino pesquisa na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão do Pesquisa de interceptação do QuestionPro é um destino pesquisa na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do Pesquisas Intercept do QuestionPro {#questionpro-extension}

## Visão geral {#overview}

O Pesquisas de interceptação do QueryPro é uma plataforma para implantar pesquisas e coletar dados de atitudes no ponto da transação ou quando os usuários entram/saem de seu site.

As Pesquisas intercept do QuestionPro são uma extensão de pesquisa na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
...
![Extensão do Pesquisas Intercept do QuestionPro](assets/web-intercept-surveys-extension.png)
...
Para instalar a extensão do Pesquisa do Intercept do QuestionPro:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte a página Pesquisas do [QuestionárioPro Intercept no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
