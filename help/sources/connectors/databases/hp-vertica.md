...
A documentação abaixo fornece informações sobre como se conectar [!DNL HP Vertica] para [!DNL Platform] usando APIs ou a interface do usuário:

## Connect [!DNL HP Vertica] para [!DNL Platform] uso de APIs
...
## Connect [!DNL HP Vertica] para [!DNL Platform] uso da interface do usuário
