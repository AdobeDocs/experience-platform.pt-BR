...
Se você já tiver uma conexão básica S3, poderá ignorar o restante desse documento e prosseguir para o tutorial sobre como [configurar um fluxo de dados](../../dataflow/batch/cloud-storage.md).
...
Depois de reunir as credenciais necessárias, siga as etapas abaixo para criar uma nova conta S3 à qual se conectar [!DNL Platform].
...
Na categoria *[!UICONTROL Bancos]* de dados, selecione **[!UICONTROL Amazon S3]** e clique em **Adicionar dados** para criar um novo conector S3.
...
Se você estiver usando novas credenciais, selecione **[!UICONTROL Nova conta]**. No formulário de entrada exibido, forneça à conexão um nome, uma descrição opcional e suas credenciais S3. Quando terminar, selecione **[!UICONTROL Connect]** e aguarde algum tempo para a nova conta ser estabelecida.
...
Ao seguir este tutorial, você estabeleceu uma conexão com sua conta S3. Agora você pode continuar para o próximo tutorial e [configurar um fluxo de dados para trazer dados do seu armazenamento em nuvem para a Plataforma](../../dataflow/batch/cloud-storage.md).