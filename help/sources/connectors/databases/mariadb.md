---
keywords: Experience Platform;página inicial;tópicos populares;MariaDB;mariadb;Maria DB;maria db
solution: Experience Platform
title: Visão geral do conector de origem do MariaDB
...
O Experience Platform fornece suporte para assimilação de dados de um banco de dados de terceiros. [!DNL Platform] O pode se conectar a diferentes tipos de bancos de dados, como bancos relacionais, NoSQL ou data warehouses. O suporte para provedores de banco de dados inclui [!DNL MariaDB].
...
A documentação abaixo fornece informações sobre como se conectar [!DNL MariaDB] para [!DNL Platform] uso de APIs ou da interface do usuário:

## Conectar [!DNL MariaDB] para [!DNL Platform] uso de APIs
...
## Conectar [!DNL MariaDB] para [!DNL Platform] uso da interface
