...
![A guia Visão geral do painel de uso de licença com o seletor de sandbox realçado.](../images/license-usage/select-sandbox.png)
...
![A guia Visão geral do painel de uso da licença com a lista suspensa de intervalo de datas realçada.](../images/license-usage/select-date-range.png)

Também é possível selecionar **[!UICONTROL Data personalizada]** para escolher o período mostrado.

![A guia Visão geral do painel de uso da licença com as opções de intervalo de datas personalizado destacadas.](../images/license-usage/select-custom-date.png)
...
![A guia Visão geral do painel de uso da licença com o gráfico de linhas do widget de métrica de uso da licença de amostra destacado.](../images/license-usage/widgets.png)
...
| <ul><li>PLATAFORMA DE DADOS DO CLIENTE DE RT:OD</li><li>PLATAFORMA DE DADOS DO CLIENTE DE RT:OD PRFL PARA 10M</li><li>PLATAFORMA DE DADOS DO CLIENTE DE RT:OD PRFL PARA 50M</li></ul> | [Adobe Real-time Customer Data Platform](https://helpx.adobe.com/legal/product-descriptions/real-time-customer-data-platform.html) |
