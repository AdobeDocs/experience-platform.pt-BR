...
Para usar Fontes de autoatendimento (SDK em lote), você deve garantir que tenha acesso a uma sandbox de organização IMS provisionada com Fontes do Adobe Experience Platform.
