...
A plataforma Experience oferece suporte para a assimilação de dados de um banco de dados de terceiros. A plataforma pode se conectar a diferentes tipos de bancos de dados, como relacional, NoSQL ou data warehouses. O suporte para provedores de banco de dados inclui a Oracle.

A documentação abaixo fornece informações sobre como conectar o Oracle à Plataforma usando APIs:
