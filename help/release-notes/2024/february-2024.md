...
| Recurso | Descrição |
| --- | --- |
| [!BADGE Beta]{type=Informative} [!DNL Acxiom] origem | Use a [[!DNL Acxiom Prospecting Data Import] origem](../../sources/tutorials/ui/create/data-partners/acxiom-prospecting-data-import.md) para recuperar e mapear dados do serviço de cliente potencial [!DNL Acxiom] para o Experience Platform. |
