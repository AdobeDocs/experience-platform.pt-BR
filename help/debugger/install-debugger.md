...
Depois de instalar a extensão do Chrome ou o complemento Firefox, um ícone (![](images/start-icon.jpg)) é adicionada à barra de extensão. Selecione este ícone para abrir a extensão.
