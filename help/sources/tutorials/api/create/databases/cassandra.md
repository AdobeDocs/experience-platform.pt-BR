...
title: Criar uma conexão de origem Apache Cassandra usando a API de serviço de fluxo
topic: overview
type: Tutorial
description: Saiba como conectar o Apache Cassandra à Adobe Experience Platform usando a API de Serviço de Fluxo.
