...
É possível estabelecer o namespace `CORE` definindo a Experience Cloud ID para o visitante por meio da [Identidade na Coleção de Dados](/help/collection/identity/overview.md), do [SDK Móvel](https://developer.adobe.com/client-sdks/documentation/mobile-core/identity/) ou da [API do Serviço Experience Cloud ID](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html?lang=pt-BR).
