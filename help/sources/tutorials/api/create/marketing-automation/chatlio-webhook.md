---
title: Criar uma conexão de origem e um fluxo de dados para o Chatlio usando a API de serviço de fluxo
...
# Criar uma conexão de origem e um fluxo de dados para [!DNL Chatlio] usando a API do Serviço de Fluxo
...
O tutorial a seguir o orienta pelas etapas para criar uma conexão de origem e um fluxo de dados para trazer [[!DNL Chatlio]](https://chatlio.com/) dados de evento para a Adobe Experience Platform usando a variável [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
...
## Connect [!DNL Chatlio] para a plataforma usando a [!DNL Flow Service] API {#connect-platform-to-flow-api}

O seguinte descreve as etapas necessárias para criar uma conexão de origem e um fluxo de dados para trazer seus [!DNL Chatlio] dados de eventos para o Experience Platform.
...
| `data.format` | O formato do [!DNL Chatlio] dados que você deseja assimilar. Atualmente, o único formato de dados compatível é `json`. |
...
| `data.format` | O formato do [!DNL Chatlio] dados que você deseja assimilar. |
...
O último passo para trazer dados do [!DNL Chatlio] para Platform é criar um fluxo de dados. Por enquanto, você terá os seguintes valores obrigatórios preparados:
...
Uma resposta bem-sucedida retorna informações sobre o fluxo de dados, incluindo o URL do terminal, marcado como `inletUrl`. Consulte a [Configurar Webhook](../../../ui/create/marketing-automation/chatlio-webhook.md#get-streaming-endpoint-url) para obter o valor necessário.
