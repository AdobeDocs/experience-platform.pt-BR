...
>[!WARNING]
>
>O ponto de extremidade `/constraints` para avaliação baseada em conjunto de dados está obsoleto. Para avaliar a violação de política ou executar vários trabalhos de avaliação, use a [API de avaliação em massa (`/bulk-eval`)](../api/evaluation.md#bulk).
