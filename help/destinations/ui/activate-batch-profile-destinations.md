...
>abstract="Selecionar **Exportar arquivos completos** para exportar um instantâneo completo de todos os perfis qualificados para o segmento. Selecionar **Exportar arquivos incrementais** para exportar apenas os perfis qualificados para o segmento desde a última exportação. <br> A primeira exportação de arquivo incremental inclui todos os perfis qualificados para o segmento, atuando como um preenchimento retroativo. Os arquivos incrementais futuros incluem apenas os perfis qualificados para o segmento desde a primeira exportação de arquivo incremental."
...
>title="Ativar após a avaliação do segmento"
...
>title="Ativação programada"
>abstract="A ativação é executada em uma hora fixa do dia."
...
>abstract="Para destinos baseados em arquivo, um nome de arquivo exclusivo é gerado por segmento. Use o editor de nome de arquivo para criar e editar um nome de arquivo exclusivo ou manter o nome padrão."
...
>abstract="Selecione os atributos do esquema XDM que todos os perfis exportados devem incluir. Perfis sem a chave obrigatória não são exportados para o destino. Se você não selecionar uma chave obrigatória, todos os perfis qualificados serão exportados, independentemente dos atributos."
...
>abstract="Elimine vários registros do mesmo perfil nos arquivos de exportação selecionando uma chave de desduplicação. Selecione um único namespace ou até dois atributos de esquema XDM como uma chave de desduplicação. Se você não selecionar uma chave de desduplicação, as entradas de perfil nos arquivos de exportação poderão ser duplicadas."
