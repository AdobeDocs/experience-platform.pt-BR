...
A guia **[!UICONTROL Sequências de dados]** exibe uma lista de sequências de dados existentes, incluindo o nome amigável, a ID e a data da última modificação. Para [exibir os detalhes e configurar serviços](#view-details), selecione o nome de um fluxo de dados.

Para revelar mais opções para um determinado fluxo de dados, selecione o ícone &quot;mais&quot; (**..**). Para atualizar o [configuração básica](#configure) para o fluxo de dados, selecione **[!UICONTROL Editar]**. Para remover o fluxo de dados, selecione **[!UICONTROL Excluir]**.
...
Se você configurar um fluxo de dados para uso no Experience Platform e também usar o SDK da Web, também deverá selecionar um [esquema do Experience Data Model (XDM) baseado em eventos](../xdm/classes/experienceevent.md) para representar os dados que você planeja assimilar.
...
Se você ativar qualquer um dos campos acima para a coleta de dados, defina corretamente a variável [`context`](/help/web-sdk/commands/configure/context.md) propriedade de matriz ao configurar o SDK da Web.
...
>[!IMPORTANT]
>
>As configurações mostradas na tabela abaixo são mutuamente exclusivas. Não é possível selecionar as duas informações do agente do usuário *e* dados de pesquisa do dispositivo ao mesmo tempo.
...
![Opções de configuração avançadas](assets/configure/advanced-settings.png)
...
| [!UICONTROL Media Analytics] | Habilita o processamento de dados de rastreamento de transmissão para integração de Edge Network por meio de SDKs de Experience Platform ou [API Media Edge](https://developer.adobe.com/cja-apis/docs/endpoints/media-edge/getting-started/). Saiba mais sobre o Media Analytics no [documentação](https://experienceleague.adobe.com/docs/media-analytics/using/media-overview.html?lang=pt-BR). |
...
Esse serviço controla se e como os dados são enviados para o Adobe Analytics. Consulte [Envio de dados para o Adobe Analytics](/help/web-sdk/use-cases/adobe-analytics.md).
