---
keywords: Experience Platform;home;popular topics;identidades de etiquetas
...
Para obter instruções sobre como usar a API do Registro do Schema para rotular um campo como identidade, visite [guia do ponto de extremidade dos descritores](../../xdm/api/descriptors.md#create).

## Próximas etapas

Vá para o próximo tutorial para [identidades de cluster de lista](./list-cluster-identites.md)