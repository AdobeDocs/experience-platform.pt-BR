...
description: A extensão Bizible é um destino de email na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão Bizible é um destino de email na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão Bizível {#bizible-extension}

## Visão geral {#overview}

É bizarro a solução de atribuição B2B líder do setor que oferece visibilidade inigualável aos seus dados, para que você possa tomar decisões inteligentes que potencializem o crescimento.

Bizible é uma extensão de email na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101055.bizible-analytics.html).
...
Para instalar a extensão Bizible:
