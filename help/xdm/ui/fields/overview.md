...
Depois que você tiver o [!DNL Schema Editor] aberto, controles para adicionar ou editar campos são exibidos na tela. Esses controles aparecem ao lado do nome do esquema, bem como quaisquer campos do tipo objeto que tenham sido definidos na classe ou grupo de campos selecionado.
...
| [!UICONTROL Nome de exibição] | Um nome de exibição para o campo. Este é o nome que será usado para representar o campo dentro da tela Editor de esquemas. |
