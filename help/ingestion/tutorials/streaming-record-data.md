...
Para criar um conjunto de dados, primeiro será necessário criar um novo schema que implemente a [!DNL XDM Individual Profile] classe. Para obter mais informações sobre como criar schemas, leia o guia [do desenvolvedor da API do Registro do](../../xdm/api/getting-started.md)Schema.
