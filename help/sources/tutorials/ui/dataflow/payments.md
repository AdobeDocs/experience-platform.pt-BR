...
# Configurar um fluxo de dados para um conector de pagamento na interface do usuário

Um fluxo de dados é uma tarefa programada que recupera e ingere dados de uma fonte para um conjunto de dados da plataforma Adobe Experience. Este tutorial fornece etapas para configurar um novo fluxo de dados usando sua conta de pagamentos.
...
Além disso, este tutorial requer que você já tenha criado uma conta de pagamentos. Uma lista de tutoriais para criar diferentes conectores de pagamento na interface do usuário pode ser encontrada na visão geral [dos conectores de](../../../home.md)origem.

## Selecionar dados

Depois de criar sua conta de pagamentos, a etapa *Selecionar dados* é exibida, fornecendo uma interface interativa para que você explore sua hierarquia de arquivos.
...
Selecione o diretório que deseja usar e, em seguida, selecione **Avançar**.
...
![use-exist-dataset](../../../images/tutorials/dataflow/payments/existing-dataset.png)
...
![select-exists-dataset](../../../images/tutorials/dataflow/payments/select-dataset.png)
...
A etapa de detalhes *do fluxo do conjunto de* dados é exibida, onde você deve fornecer um nome e uma descrição opcional para o fluxo do conjunto de dados. Selecione **Próximo** ao terminar.
