...
Por conseguinte, é necessário que cada identidade enviada [!DNL Privacy Service] seja acompanhada de uma **namespace** que forneça o contexto, relacionando o valor de identificação com o seu sistema de origens. Uma namespace pode representar um conceito genérico, como um endereço de email (&quot;Email&quot;) ou associar a identidade a um aplicativo específico, como uma ID da Adobe Advertising Cloud (&quot;AdCloud&quot;) ou uma ID da Adobe Target (&quot;TNTID&quot;).
