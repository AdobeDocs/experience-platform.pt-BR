...
seo-title: Extensão do Marketo Munchkin
description: A extensão do Marketo Munchkin é um destino de personalização na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão do Marketo Munchkin é um destino de personalização na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do Marketo Munchkin {#marketo-munchkin-extension}

## Visão geral {#overview}

Desde o gerenciamento de clientes potenciais até o marketing baseado em conta, a Plataforma de Envolvimento do Marketing simplifica a maneira como você planeja, organiza e mede o envolvimento com clientes e prospectos em cada estágio de sua experiência.

O JavaScript Munchkin de Marketo permite rastrear visitas de página de usuários finais e cliques em landings page de marketing e páginas externas da Web.

O Marketo Munchkin é uma extensão de email na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html).
...
![Extensão do Marketo Munchkin](assets/marketo-munchkin-extension.png)
...
Para instalar a extensão do Marketo Munchkin:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte a página [Marketo Munchkin no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101054.marketo-munchkin.html).
