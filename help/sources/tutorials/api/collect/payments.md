...
Este tutorial aborda as etapas para recuperar dados de um aplicativo de pagamentos e assimilá-los na Plataforma por meio de conectores de origem e APIs.
...
As seções a seguir fornecem informações adicionais que você precisará saber para se conectar com êxito a um aplicativo de pagamentos usando a API de Serviço de Fluxo.
...
Uma resposta bem-sucedida retorna os detalhes da especificação de fluxo de dados responsável por trazer os dados do seu aplicativo de pagamentos para a Plataforma. Essa ID é necessária na próxima etapa para criar um novo fluxo de dados.
