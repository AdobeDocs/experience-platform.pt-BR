...
| `1001-401` | Não autorizado | Usuário não autorizado. Entre em contato com o administrador para obter acesso ao recurso. |
...
| `1005-500` | Erro interno | Erro interno. Tente novamente e entre em contato com o suporte ao cliente se o problema persistir. |
| `1006-408` | Tempo limite da solicitação | Ocorreu um erro ao processar a solicitação. A solicitação expirou. Tente novamente e entre em contato com o suporte ao cliente se o problema persistir. |
...
| `1008-401` |  | Token de autorização inválido | O token de autorização não tem acesso a esta organização ou a organização não existe. Verifique se a organização existe ou entre em contato com o administrador para obter acesso. |
...
| `1011-503` | Serviço indisponível | Serviço temporariamente indisponível. Tente novamente e entre em contato com o suporte ao cliente se o problema persistir. |
...
| `1013-412` | Falha na pré-condição | A condição definida pelos cabeçalhos If-Unmodified-Since ou If-None-Match não é atendida. Verifique e tente novamente. |
| `1014-400` | Argumento inválido de solicitação inválida | A solicitação não pôde ser processada. {detailedMessage} |
...
| `1101-500` | Erro interno | Erro interno. Tente novamente e entre em contato com o suporte ao cliente se o problema persistir. |
| `1102-404` | Recurso não encontrado | O recurso solicitado não foi encontrado. {detailedMessage} |
| `1103-503` | Serviço indisponível | Serviço temporariamente indisponível. Tente novamente e entre em contato com o suporte ao cliente se o problema persistir. |
...
| `1107-412` | Falha na pré-condição | A condição definida pelos cabeçalhos If-Unmodified-Since ou If-None-Match não é atendida. {detailedMessage} |

## Erros de criptografia

| Código de erro | Título | Mensagem detalhada |
| --- | --- | --- |
| `1200-500` | Erro interno | Erro interno. Tente novamente e entre em contato com o suporte ao cliente se o problema persistir. |
| `1201-400` | Solicitação inválida | A flowId não pode ser nula ou vazia. Forneça uma flowId válida na solicitação e tente novamente. |
| `1202-400` | Solicitação inválida | A publicKeyId está ausente nas transformações do fluxo={transformações}. Forneça publicKeyId na solicitação e tente novamente. |
| `1203-400` | Solicitação inválida | A chave de criptografia não existe em relação à keyID={keyID} nas transformações do fluxo={transformações}. Verifique a keyID fornecida e tente novamente. |
...
| `1205-400` | Solicitação inválida | A senha está ausente na seção params da solicitação fornecida. Forneça a senha em parâmetros e tente novamente. |

## Erros de REST API

| Código de erro | Título | Mensagem detalhada |
| --- | --- | --- |
| `1300-400` | Solicitação inválida | A solicitação de conexão de patch não é compatível com o conector {connectorType}. Verifique a solicitação fornecida e tente novamente. |
| `1301-400` | Solicitação inválida | O parâmetro authSpecType fornecido : {authSpecType} não é compatível. Forneça um tipo de especificação de autenticação válido e tente novamente. |
| `1302-400` | Solicitação inválida | O tipo de autenticação fornecido = {authType} não é compatível com o conector={connectorType}. Forneça um tipo de autenticação válido para o conector fornecido. |
| `1303-400` | Solicitação inválida | O URL não pôde ser codificado com os parâmetros de autenticação fornecidos porque a codificação de URL não é compatível com {value}. Verifique seus parâmetros de autenticação e tente novamente. |
| `1304-400` | Solicitação inválida | O campo obrigatório {field} não é fornecido. Forneça o {field} e tente novamente. |
| `1305-400` | Solicitação inválida | O tipo de conector fornecido = {connectorType} não é compatível com esta operação. |
...
| `1311-400` | Solicitação inválida | O publicKeyId fornecido em parâmetros é inválido. Forneça um publicKeyId válido e tente novamente. |
...
| `1317-400` | Solicitação inválida | Os parâmetros de agendamento fornecidos estão vazios, mas não devem estar vazios. Forneça parâmetros de agendamento válidos e tente novamente. |
| `1318-400` | Solicitação inválida | {combineMessage}. Verifique a solicitação fornecida e tente novamente. |
...
| `1322-400` | Solicitação inválida | A conexão de origem não pode ser nula para criar a referência de esquema. Forneça uma conexão de origem válida e tente novamente. |
| `1323-400` | Solicitação inválida | A {entity} não pode ser nula ou vazia na conexão de origem: {sourceConnection}. Forneça uma {entity} válida e tente novamente. |
...
| `1327-400` | Solicitação inválida | O formato de dados de origem fornecido={sourceFormat} em SourceConnection não é compatível. Os valores permitidos são: {values}. Forneça os valores permitidos e tente novamente. |
...
| `1333-400` | Solicitação inválida | O flowRunAction={flowRunAction} não é compatível com a origem com a id de especificação={specId}. Forneça uma ação de execução de fluxo válida e tente novamente. |
...
| `1335-400` | Solicitação inválida | Erro ao serializar os parâmetros de filtro para exploração. Verifique sua solicitação de parâmetro de filtro e tente novamente. |
...
| `1337-400` | Solicitação inválida | O {QueryParam} não pode estar vazio para objectType={objectType}. Forneça um {QueryParam} válido e tente novamente. |
...
| `1340-400` | Solicitação inválida | Ocorreu um erro ao analisar {time}. Verifique o formato de hora fornecido na solicitação e tente novamente. |
...
| `1347-400` | Solicitação inválida | A definição dls:csvDelimiters em &quot;odi.json&quot; não é compatível. Os csvDelimiters compatíveis são: [&#39;,&#39;]. Forneça as definições apropriadas em &quot;odi.json&quot; e tente novamente. |
...
| `1351-400` | Solicitação inválida | O operador fornecido {operator} não é compatível com o filtro na origem para este conector. Forneça um operador válido e tente novamente. |
| `1352-400` | Solicitação inválida | O operador fornecido {operator} não pode ser mapeado para qualquer operador nativo compatível para {ql}. Forneça um operador válido e tente novamente. |
| `1353-400` | Solicitação inválida | O filtro na origem ainda não é compatível com o conector {connectorType}. Verifique os conectores compatíveis na documentação: https://experienceleague.adobe.com/docs/experience-platform/sources/api-tutorials/filter.html. |
...
| `1355-400` | Solicitação inválida | O tipo de filtro fornecido é inválido. O tipo de filtro compatível é: PQL. Forneça um tipo de filtro válido e tente novamente. |
...
| `1361-400` | Solicitação inválida | O intervalo não é permitido com assimilação única. Remova o intervalo ou altere a frequência e tente novamente. |
...
| `1364-400` | Solicitação inválida | O sinalizador de preenchimento retroativo não é permitido quando a frequência está definida como um. Remova o sinalizador de preenchimento retroativo quando a frequência estiver definida como uma vez e tente novamente. |
...
| `1372-400` | Solicitação inválida | A operação atual não é permitida. A exploração por meio da especificação de conexão não é permitida para a ID de especificação de conexão={connectionSpecId}. |
| `1373-400` | Solicitação inválida | FlowSpecType ausente na solicitação. Forneça um flowSpecType válido e tente novamente. |
| `1374-400` | Solicitação inválida | Os parâmetros de consulta fornecidos são inválidos. Você não pode ter o sinalizador determineProperties e as propriedades definidas pelo usuário na mesma solicitação. Corrija sua solicitação e tente novamente. |
| `1375-400` | Solicitação inválida | Falha na detecção das propriedades do arquivo. Insira as propriedades manualmente. |
| `1376-400` | Solicitação inválida | A detecção de propriedades do arquivo não é compatível com a especificação de conexão id={connectionSpecId}. Forneça as propriedades do arquivo manualmente. |
...
| `1378-400` | Solicitação inválida | Ocorreu um erro ao validar a coluna de entrada {column} para filtro na origem. O nome da coluna deve ser válido na tabela. Forneça um nome de coluna válido e tente novamente. |
| `1379-400` | Solicitação inválida | Ocorreu um erro ao validar a entrada {value} para o filtro na origem. O DataType da coluna na origem é {columnDataType} e o DataType do valor [String] não corresponde. Forneça um {value} válido e tente novamente. |
...
| `1383-400` | Solicitação inválida | A coluna delta está ausente nos parâmetros recebidos para a criação de uma execução de fluxo. Forneça a coluna delta em parâmetros e tente novamente. |
...
| `1385-400` | Solicitação inválida | O connectorType={connectorType} fornecido não é compatível com a criação de execuções de fluxo. Forneça um connectorType válido e tente novamente. |
| `1386-400` | Solicitação inválida | O flowId={flowId} com scheduleParams frequency={frequency} não é compatível com a criação de execuções de fluxo. Forneça uma frequência válida e tente novamente. |
| `1387-400` | Solicitação inválida | O flowRunId={flowRunId} está em um estado inválido={state} para acionar novamente. Tente novamente dentro de alguns minutos e entre em contato com o suporte ao cliente se o problema persistir. |
| `1388-400` | Solicitação inválida | O fluxo={flow} está no estado={state} e não pode ser acionado novamente. O fluxo deve estar no estado ativado para ser acionado novamente. |
| `1389-400` | Solicitação inválida | Erro ao analisar a cadeia de caracteres codificada em base64 fornecida. Forneça uma cadeia de caracteres de filtro codificada válida e tente novamente. |
...
| `1395-400` | Solicitação inválida | A conexão de origem encontrada no fluxo é nula ou vazia. Forneça uma conexão de origem válida no fluxo e tente novamente. |
...
| `1401-400` | Solicitação inválida | A ação de execução de fluxo fornecida={flowRunAction} não é compatível. Forneça uma ação de execução de fluxo válida e tente novamente. |
| `1402-500` | Erro interno | Erro interno. Tente novamente e entre em contato com o suporte ao cliente se o problema persistir. |
| `1403-400` | Solicitação inválida | A hora de início passou e você não pode mais alterar a frequência para uma vez. |
...
| `1601-500` | Erro interno | Erro interno. Tente novamente e entre em contato com o suporte ao cliente se o problema persistir. |
| `1602-404` | Recurso não encontrado | O recurso solicitado não foi encontrado. {detailedMessage} |
| `1603-503` | Serviço indisponível | Serviço temporariamente indisponível. Tente novamente. Entre em contato com o suporte ao cliente se o problema persistir. |
...
| `1607-412` | Falha na pré-condição | A condição definida pelos cabeçalhos If-Unmodified-Since ou If-None-Match não é atendida. {detailedMessage} |

## Erros de Data Landing Zone

| Código de erro | Título | Mensagem detalhada |
| --- | --- | --- |
| `1700-500` | Erro interno | Erro interno. Tente novamente e entre em contato com o suporte ao cliente se o problema persistir. |
...
| `1705-400` | Solicitação inválida | A ação de zona de aterrissagem de dados fornecida não é compatível. Forneça uma ação válida e tente novamente. |
...
| `1707-400` | Solicitação inválida | O serviço não pôde ser inicializado porque a configuração da zona de aterrissagem não pode ser nula ou vazia. Certifique-se de que a configuração da zona de aterrissagem não seja nula e tente novamente. |
...
| `1710-400` | Solicitação inválida | A zona de aterrissagem fornecida do tipo: {landingZoneUseCase} não é compatível. Forneça um tipo de zona de aterrissagem válido e tente novamente. |
...
| `1714-400` | Solicitação inválida | O clientId={clientId} não está autorizado a executar esta operação. Verifique sua solicitação com permissões e tente novamente. |
