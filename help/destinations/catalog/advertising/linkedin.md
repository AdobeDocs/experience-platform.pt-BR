...
Instale o [!DNL LinkedIn Insight Tag] para usar o rastreamento de conversão, o redirecionamento e os recursos demográficos do site.

[!DNL LinkedIn Insight Tag] O é uma extensão de publicidade no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte [Tag Insight do LinkedIn](https://business.linkedin.com/marketing-solutions/insight-tag).
...
Para obter informações sobre as opções de configuração de extensão e o suporte de instalação, consulte [Tag Insight do LinkedIn](https://business.linkedin.com/marketing-solutions/insight-tag).
