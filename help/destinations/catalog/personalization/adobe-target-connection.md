...
Ao configurar a conexão do Adobe Target para [usar uma ID de sequência de dados](#parameters), você deve ter o [SDK da Web da Adobe Experience Platform](/help/web-sdk/home.md) implementado.
...
O Adobe Target *lê* dados de perfil do Edge Network Adobe Experience Platform, portanto, nenhum dado é exportado.
