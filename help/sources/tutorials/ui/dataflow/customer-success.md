...
Depois de criar o conector de sucesso do cliente, a etapa **[!UICONTROL Selecionar dados]** é exibida, fornecendo uma interface interativa para explorar a hierarquia de arquivos.
