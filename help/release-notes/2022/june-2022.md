...
| [Adobe Advertising DSP](../../destinations/catalog/advertising/adobe-advertising-dsp-connection.md) | O destino da Adobe Advertising Cloud [!DNL Demand-Side Platform] (DSP) permite compartilhar segmentos primários autenticados com anunciantes e usuários aprovados para ativação de campanha com o DSP. |
...
| [Renderizar apresentações](/help/collection/js/commands/applypropositions.md) em aplicativos de página única sem incrementar métricas. | O comando `applyPropositions` recém-adicionado permite renderizar ou executar uma matriz de propostas de [!DNL Target] em aplicativos de página única, sem incrementar as métricas [!DNL Analytics] e [!DNL Target]. Essa melhoria aumenta a precisão dos relatórios. |
| [Identidade na Coleção de Dados](/help/collection/identity/overview.md) | O Adobe Experience Platform Web SDK agora oferece suporte a recursos de compartilhamento de ID de visitante que permitem fornecer experiências personalizadas com mais precisão, entre aplicativos móveis e conteúdo da Web móvel e entre domínios. |
