...
Além disso, este tutorial requer que você já tenha criado uma conta CRM. Uma lista de tutoriais para criar diferentes conectores de CRM na interface do usuário pode ser encontrada no [visão geral dos conectores de origem](../../../home.md).

## Selecionar dados

Depois de criar sua conta CRM, a variável [!UICONTROL Selecionar dados] será exibida, fornecendo uma interface para explorar sua hierarquia de arquivos.
...
Para assimilar dados em um conjunto de dados existente, selecione **[!UICONTROL Conjunto de dados existente]**, em seguida, selecione o ícone de dados ![dados](../../../images/tutorials/dataflow/crm/data.png) ao lado da barra de entrada.
...
>[!TIP]
>
>Se estiver usando o [!DNL Salesforce] fonte como parte da CDP B2B, consulte [[!DNL Salesforce] tabelas de mapeamento de campo](../../../connectors/adobe-applications/mapping/salesforce.md) para obter um guia sobre os conjuntos de mapeamento adequados entre [!DNL Salesforce] campos de origem e campos de destino XDM.
...
Em seguida, da [!UICONTROL Mapeamento] , selecione **[!UICONTROL Próximo]** para continuar.
