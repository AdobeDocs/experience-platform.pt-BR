...
Todos os recursos no Experience Platform são isolados para sandboxes virtuais específicas. As solicitações para o Destination SDK exigem cabeçalhos que especificam o nome da sandbox em que a operação ocorre:
...
* Ler [Use o Destination SDK para configurar seu destino](./configure-destination-instructions.md) para as próximas etapas.
