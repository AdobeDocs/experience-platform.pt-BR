...
O Destination SDK suporta vários métodos de autenticação para o seu destino. Entre esses, está a opção de autenticar em seu destino usando o [Estrutura de autenticação do OAuth 2](https://tools.ietf.org/html/rfc6749).
...
Para definir esse método de autenticação para o seu destino, adicione as seguintes linhas na sua configuração, quando você [criar uma configuração de destino](../../authoring-api/destination-configuration/create-destination-configuration.md):
...
| `accessTokenRequest.responseFields.value` | String | Use a linguagem de modelo para acessar campos na resposta HTTP a partir do endpoint do token de acesso. Para obter informações sobre como usar modelos para personalizar campos, consulte a seção [convenções de modelos](#templating-conventions) seção. |
...
| `accessTokenRequest.validations.actualValue.value` | String | Use a linguagem de modelo para acessar campos na resposta HTTP. Para obter informações sobre como usar modelos para personalizar campos, consulte a seção [convenções de modelos](#templating-conventions) seção. |
...
| `accessTokenRequest.validations.expectedValue.value` | String | Use a linguagem de modelo para acessar campos na resposta HTTP. Para obter informações sobre como usar modelos para personalizar campos, consulte a seção [convenções de modelos](#templating-conventions) seção. |
...
Ao ler este artigo, você agora entende os padrões de autenticação do OAuth 2 compatíveis com o Adobe Experience Platform e sabe como configurar seu destino com suporte à autenticação do OAuth 2. Em seguida, você pode configurar o destino compatível com OAuth 2 usando o Destination SDK. Ler [Use o Destination SDK para configurar seu destino](../../guides/configure-destination-instructions.md) para as próximas etapas.
