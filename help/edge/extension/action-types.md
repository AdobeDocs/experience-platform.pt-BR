...
Depois de configurar o [Extensão de tag do Adobe Experience Platform Web SDK](web-sdk-extension-configuration.md), configure os tipos de ação.
...
Depois de definir suas ações, [configurar os tipos de elemento de dados](data-element-types.md).
