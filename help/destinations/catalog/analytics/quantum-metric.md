---
keywords: Extensão de Métrica Quântica;Métrica Quântica;métrica quântica;métrica quântica
title: Extensão de métrica Quantum
description: A extensão Métrica quântica é um destino de análise no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do [!DNL Quantum Metric] {#quantum-metric-extension}

## Visão geral {#overview}

A extensão de tag [!DNL Quantum Metric] facilita a implantação sem código dos recursos de coleta de dados do [!DNL Quantum Metric's]. Além disso, essa extensão oferece a capacidade de capturar elementos de dados que contêm informações úteis da API [!DNL Quantum Metric].

[!DNL Quantum Metric] é uma extensão do Analytics em [!DNL Adobe Experience Platform]. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
...
![Extensão de Métrica Quantum](../../assets/catalog/analytics/quantum-metric/catalog.png)
...
Para obter informações sobre as opções de configuração de extensão e suporte à instalação, consulte a [página Métrica do Quantum no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
