...
>[!NOTE]
>O conector Amazon Kineses está em beta. Consulte a visão geral [das](../../../../home.md#terms-and-conditions) Fontes para obter mais informações sobre o uso de conectores com rótulo beta.
...
Este tutorial usa a API de Serviço de Fluxo para guiá-lo pelas etapas para conectar o Experience Platform a uma conta da Amazon Kinesis.
...
| `region` |  | A região da sua conta Kinesis. |
...
| `auth.params.region` | A região da sua conta Kinesis. |
| `connectionSpec.id` | A ID da especificação de conexão Kinesis: `86043421-563b-46ec-8e6c-e23184711bf6` |
