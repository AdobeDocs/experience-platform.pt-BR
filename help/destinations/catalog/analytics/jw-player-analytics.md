---
keywords: JW player; jw player; JW Player; extensão jw; extensão JW
...
Esta extensão instala o adaptador [!DNL JW Player] para conectar os eventos [!DNL JW Player] ao Adobe Video Analytics. Aproveite o poder do Adobe Video Analytics para obter insights detalhados sobre a compreensão dos hábitos de exibição de vídeo de seus clientes.
