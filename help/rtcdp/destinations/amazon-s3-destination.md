...
* **[!DNL Amazon S3]chave de acesso e chave[!DNL Amazon S3]secreta **: Em[!DNL Amazon S3], gere uma chave de acesso - par de chaves de acesso secreto para conceder à Adobe o acesso CDP em tempo real à sua[!DNL Amazon S3]conta.
