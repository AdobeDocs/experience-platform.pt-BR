...
Além disso, este tutorial exige que você já tenha criado uma conta de protocolos. Uma lista de tutoriais para criar diferentes conectores de protocolo na interface do usuário pode ser encontrada no [visão geral dos conectores de origem](../../../home.md).

## Selecionar dados

Depois de criar sua conta de protocolos, a **[!UICONTROL Selecionar dados]** será exibida, fornecendo uma interface interativa para explorar sua hierarquia de arquivos.
...
O **[!UICONTROL Detalhes do fluxo de dados]** é exibida, permitindo nomear e fornecer uma breve descrição sobre o novo fluxo de dados.
