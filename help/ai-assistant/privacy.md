...
* Todas as políticas existentes de [controle de acesso](../access-control/home.md) serão atendidas pelo Assistente de IA.
...
* Você deve receber permissão explícita para interagir com o Assistente de IA.
   * Você pode definir permissões de forma diferente para o Experience Platform e o Journey Optimizer usando a [IU de Permissões](../access-control/abac/ui/permissions.md) e pode usar a [Admin Console](../access-control/ui/browse.md) para atribuir permissões para o Customer Journey Analytics.
...
**Isso significa que, se algum novo rótulo for adicionado aos campos e objetos ou se qualquer nova política for criada, o Assistente de IA levará até 24 horas para respeitá-los. Durante essas 24 horas, os usuários com acesso recém-restrito ainda poderão acessar esses campos e objetos.*
