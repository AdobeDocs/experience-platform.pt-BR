...
Para verificar se os dados foram exportados com êxito, verifique [!DNL Amazon S3] armazenamento e verifique se os arquivos exportados contêm as populações de perfis esperadas.
