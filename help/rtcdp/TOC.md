...
* Destinos {#destinations}
   ...
   * Catálogo de destinos {#destinations-cat}
      ...
      * Destinos de armazenamento em nuvem{#cloud-storage}
         * [Visão geral dos destinos de armazenamento em nuvem](destinations/cloud-storage-destinations.md)
         * [Fluxo de trabalho para criar destinos de armazenamento em nuvem](/help/rtcdp/destinations/cloud-storage-destinations-workflow.md)
...
* Perfil do cliente em tempo real {#profile}
   ...
   * [Visualizador de perfil](profile/profile-viewer.md)
