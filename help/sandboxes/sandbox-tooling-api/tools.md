...
As ferramentas de sandbox permitem selecionar diferentes artefatos e exportá-los em um pacote. Um pacote pode consistir em um único objeto ou em vários objetos. Todos os objetos incluídos em um pacote devem ser da mesma sandbox.
