...
topic: overview
description: Saiba como conectar o Azure Synapse Analytics à Adobe Experience Platform usando APIs ou a interface do usuário.
...
- [Criar uma conexão de origem do Azure Synapse Analytics usando a API do Serviço de Fluxo](../../tutorials/api/create/databases/synapse-analytics.md)
