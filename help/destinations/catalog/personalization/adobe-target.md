...
Para obter informações sobre as opções de configuração de extensão, consulte a [página de extensão do Adobe Target](../../../tags/extensions/web/target/overview.md) na documentação de tags.
