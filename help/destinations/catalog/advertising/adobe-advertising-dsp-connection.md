...
Esta conexão substitui a [conexão herdada do Adobe Advertising DSP](adobe-advertising-cloud-dsp-connection-legacy.md), que dá suporte somente a endereços de email com hash.
...
>additional-url="https://experienceleague.adobe.com/pt-br/docs/experience-platform/destinations/catalog/advertising/adobe-advertising-dsp-connection#preconfigured-mappings" text="Leia mais sobre os mapeamentos pré-configurados"
