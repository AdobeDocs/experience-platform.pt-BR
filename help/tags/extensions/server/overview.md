...
Esta é uma lista de documentação das extensões de encaminhamento de eventos do lado do servidor. Para obter uma lista de extensões disponíveis no lado do cliente, consulte a [referência de extensões de tag](../client/overview.md).
...
* [API de conversão de [!DNL LinkedIn]](./linkedin/overview.md)
...
* [API de eventos da Web do [!DNL Tiktok]](./tiktok/overview.md)
