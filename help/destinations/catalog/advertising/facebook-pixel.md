...
[!DNL Facebook Pixel] é uma extensão de publicidade no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte o [site Facebook Pixel](https://developers.facebook.com/docs/facebook-pixel/).
...
![Extensão do Facebook Pixel](../../assets/catalog/advertising/facebook-pixel/catalog.png)
