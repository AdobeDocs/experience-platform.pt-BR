...
Use as caixas de seleção à esquerda dos nomes dos públicos-alvo da conta para selecionar os públicos-alvo que deseja exportar para o destino e selecione **[!UICONTROL Next]**.

>[!NOTE]
>
>Somente *públicos-alvo da conta* são exibidos nesta exibição, e nenhum outro tipo de público-alvo é exibido.
...
>[!NOTE]
>
>Na etapa de agendamento ao exportar públicos da conta para destinos de armazenamento na nuvem, o fluxo de trabalho para ativar públicos da conta permite exportar apenas [arquivos completos](/help/destinations/ui/activate-batch-profile-destinations.md#export-full-files) e [arquivos incrementais](/help/destinations/ui/activate-batch-profile-destinations.md#export-incremental-files) _em um agendamento diário_. Não há suporte para exportações por hora. **[!UICONTROL After audience evaluation]** é o único tipo de avaliação com suporte.
