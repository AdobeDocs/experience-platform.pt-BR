...
topic: queries
type: Tutorial
description: Este documento descreve exemplos completos e de subseleção de query para desduplicar três casos de uso comuns de ExperienceEvents, compras e métricas.
