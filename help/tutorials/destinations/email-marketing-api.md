...
Para fazer chamadas para [!DNL Platform] APIs, você deve primeiro concluir o tutorial [de](../authentication.md)autenticação. A conclusão do tutorial de autenticação fornece os valores para cada um dos cabeçalhos necessários em todas as chamadas de [!DNL Experience Platform] API, como mostrado abaixo:
...
![Etapas de destino visão geral etapa 1](../images/destinations/flow-api-destinations-step1.png)
...
![Etapas de destino visão geral etapa 3](../images/destinations/flow-api-destinations-step3.png)
...
![Etapas de destino visão geral etapa 5](../images/destinations/flow-api-destinations-step5.png)
...
![Etapas de destino visão geral etapa 6](../images/destinations/flow-api-destinations-step6.png)
