...
Crie uma conexão de saída ativa com [!DNL Google Cloud Storage] para exportar arquivos de dados de [!DNL Adobe Experience Platform] periodicamente para seus próprios buckets.
