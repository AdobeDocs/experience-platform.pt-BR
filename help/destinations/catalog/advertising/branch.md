---
keywords: ramificação;extensão ramificação;ramificação destino
title: Extensão de ramificação
description: A extensão Branch é um destino de anúncio no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do [!DNL Branch] {#branch-extension}

## Visão geral {#overview}

A ramificação fornece links e soluções eficientes que ajudam você a adquirir, engajar e medir todos os dispositivos, canais e plataformas.

A ramificação é uma extensão de publicidade em [!DNL Adobe Experience Platform]. Para obter mais informações sobre a funcionalidade de extensão, consulte a [página de recursos](https://branch.io/features/) no site da Ramificação.
...
![Extensão da ramificação](../../assets/catalog/advertising/branch/catalog.png)
