...
title: Criar um fluxo de dados para uma origem da Integração do OneTrust usando a API do Serviço de Fluxo
...
# Criar um fluxo de dados para um [!DNL OneTrust Integration] fonte usando o [!DNL Flow Service] API
