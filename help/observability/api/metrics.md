...
| `INSGHT-1003-401` | Erro de validação de sandbox | A solicitação não pôde ser processada devido a um erro de validação de sandbox. Verifique se o nome da sandbox fornecido na `x-sandbox-name` o cabeçalho representa uma sandbox válida e ativada para sua organização antes de tentar a solicitação novamente. |
