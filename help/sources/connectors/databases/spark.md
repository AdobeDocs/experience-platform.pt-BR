...
A documentação abaixo fornece informações sobre como conectar [!DNL Apache Spark] em [!DNL Azure HDInsights] a [!DNL Experience Platform] usando APIs ou a interface do usuário:

## Conectar [!DNL Apache Spark] em [!DNL Azure HDInsights] a [!DNL Experience Platform] usando APIs
...
## Conectar [!DNL Apache Spark] em [!DNL Azure HDInsights] a [!DNL Experience Platform] usando a interface
