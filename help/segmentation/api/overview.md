...
topic: guide
description: Este documento de visão geral fornece introduções de alto nível para cada um dos pontos de extremidade da API do Serviço de segmentação e links para os guias de ponto de extremidade associados para obter detalhes.
