---
keywords: Manipulador de IMA Nielsen;Manipulador de IMA nielsen;Nielsen ima;Nielsen IMA
title: Extensão do Manipulador de IMA Nielsen
...
[!DNL Nielsen IMA Handler] é uma extensão do analytics no Adobe Experience Platform.
...
![Extensão de manipulador IMA Nielsen](../../assets/catalog/analytics/nielsen-ima/catalog.png)
...
Para instalar o [!DNL Nielsen IMA Handler] extensão:
