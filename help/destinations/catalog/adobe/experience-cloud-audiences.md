...
Para enviar públicos-alvo para [!DNL Adobe Analytics], você precisa de uma licença do Audience Manager. Para obter mais detalhes, consulte a [visão geral do Audience Analytics](https://experienceleague.adobe.com/docs/analytics/integration/audience-analytics/mc-audiences-aam.html?lang=en).
...
Antes de enviar públicos-alvo para [!DNL Adobe Analytics], você deve [implementar o Serviço de Identidade da Experience Cloud para o Analytics e o Audience Manager](https://experienceleague.adobe.com/docs/id-service/using/implementation/setup-aam-analytics.html?lang=en).
...
> * Você *não precisa* de uma licença do Audience Manager para compartilhar públicos do [!DNL Real-Time CDP] com o [!DNL Adobe Advertising], [!DNL Adobe Target], Marketo e outras soluções da Experience Cloud, mencionadas na [seção acima](#share-segments-with-other-solutions).
