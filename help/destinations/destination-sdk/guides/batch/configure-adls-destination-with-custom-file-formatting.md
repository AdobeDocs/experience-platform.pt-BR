...
title: (Beta) Configure um destino do Armazenamento do Azure Data Lake com opções personalizadas de formatação de arquivos e configuração personalizada de nome de arquivo.
...
# (Beta) Configure um [!DNL Azure Data Lake Storage] destino com opções de formatação de arquivo personalizadas e configuração de nome de arquivo personalizado
...
Esta página descreve como usar o Destination SDK para configurar um [!DNL Azure Data Lake Storage] destino com personalizado [opções de formatação de arquivo](../../server-and-file-configuration.md#file-configuration) e um [configuração do nome do arquivo](../../file-based-destination-configuration.md#file-name-configuration).
...
Comece usando o `/destination-server` endpoint para criar uma configuração de servidor e arquivo. Para obter descrições detalhadas dos parâmetros na solicitação HTTP, leia o [especificações de configuração de servidor e arquivo para destinos com base em arquivo](../../server-and-file-configuration.md#adls-example) e o [configurações de formatação de arquivo](../../server-and-file-configuration.md#file-configuration).
...
A carga abaixo inclui um [!DNL Azure Data Lake Storage] configuração, com personalizado [Formatação de arquivo CSV](../../server-and-file-configuration.md#file-configuration) parâmetros de configuração que os usuários podem definir na interface do usuário do Experience Platform.
...
![Gravação de tela mostrando a página de catálogo de destinos com um cartão de destino selecionado.](../../assets/adls-destination-card.gif)
