...
# Confirmar extensão de feedback digital

## Visão geral {#overview}

A solução Confirmar Feedback Digital ajuda você a transformar o tráfego de seu site em insights em tempo real. Com a mensagem Confirmar, pesquisas discretas e altamente direcionadas podem ser exibidas de acordo com suas necessidades, incentivando os visitantes a fornecer feedback, como:
...
Para instalar a extensão Confirmar feedback digital:
