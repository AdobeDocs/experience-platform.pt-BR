...
Depois de concluir as etapas descritas no documento acima, visite o [Entrada e saída](./data-requirements.md) documentação. Este documento fornece uma breve visão geral de quais tipos de dados são usados e produzidos no Customer AI.
