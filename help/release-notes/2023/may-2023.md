...
| Recurso | Descrição |
| --- | --- |
| Correção de direitos de licença | O painel [!UICONTROL License Usage] e os dados de licença individual de clientes foram atualizados para resolver discrepâncias anteriores entre os direitos de licença registrados nas Ordens de Venda e aqueles originalmente relatados no painel [!UICONTROL License Usage] do Experience Platform. As atualizações de dados de licenças individuais ocorrerão em fases, entre o ínicio de junho de 2023 até o dia 11 desse mesmo mês. Os valores de uso reais permanecem precisos.<br><br>A Experience Platform fornece vários recursos para gerenciar o volume de uso:<br><ul><li>[Revisar e aplicar as práticas recomendadas para gerenciar o uso de dados e licenças](https://experienceleague.adobe.com/docs/experience-platform/landing/license/data-management-best-practices.html?lang=pt-BR).</li><li>Aplicar regras e condições de filtragem para [incluir ou excluir seletivamente dados da ingestão no perfil do cliente em tempo real](https://experienceleague.adobe.com/docs/experience-platform/sources/ui-tutorials/create/adobe-applications/analytics.html?lang=pt-BR#filtering-for-profile) para dados do Analytics, antes que sejam ingeridos no perfil.</li><li>[Entre em contato com o suporte da Adobe para aplicar prazos de expiração para perfis pseudônimos.](https://experienceleague.adobe.com/docs/experience-platform/profile/pseudonymous-profiles.html?lang=pt-BR)</li><li>[Entre em contato com o suporte da Adobe para habilitar as expirações de evento de experiência nos conjuntos de dados desejados.](https://experienceleague.adobe.com/docs/experience-platform/profile/event-expirations.html?lang=pt-BR)</li><li>Entre em contato com a pessoa representante da Adobe para discutir opções para aumentar seus direitos de licença.</li></ul> |
...
| Recurso | Descrição |
| --- | --- |
| Disponibilidade beta de modelos de ingestão de dados | Os modelos de ingestão de dados fornecem aos arquitetos e engenheiros de dados os modelos padrão e ferramentas de automação necessários para acelerar o processo de ingestão de dados, incluindo a criação de esquemas e conjuntos de dados e a configuração de regras de mapeamento. No momento, os modelos de ingestão de dados estão disponíveis para as origens [[!DNL Marketo Engage]](../../sources/connectors/adobe-applications/marketo/marketo.md), [[!DNL Salesforce]](../../sources/connectors/crm/salesforce.md) e [[!DNL Microsoft Dynamics]](../../sources/connectors/crm/ms-dynamics.md). Para obter mais informações, leia o guia de [uso de modelos na interface](../../sources/tutorials/ui/templates.md). |

Para saber mais sobre ingestão de dados, leia a [visão geral da ingestão de dados](../../ingestion/home.md).
...
| Destino | Descrição |
| ----------- | ----------- |
| **[[!UICONTROL Mailchimp Interest Categories]](../../destinations/catalog/email-marketing/mailchimp-interest-categories.md)** | **[!UICONTROL Mailchimp]** é uma plataforma de automação de marketing popular e um serviço de marketing por email usado pelas empresas para gerenciar e conversar com contatos (clientes, clientes ou outras partes interessadas) usando listas de endereçamento e campanhas de marketing por email. Use esse conector para classificar seus contatos com base em seus interesses e preferências. |
...
| Grupo de campos | [[!UICONTROL XDM Individual Prospect Profile]](https://github.com/adobe/xdm/pull/1721/files) | A opção `partnerProspect` das marcas de metadados foi adicionada à classe [!UICONTROL XDM Individual Prospect Profile]. |
| Tipo de dados | (Vários) | Vários campos foram adicionados para o tipo de dados [[!UICONTROL Media details information]](https://github.com/adobe/xdm/pull/1716/files). |
| Tipo de dados | [[!UICONTROL Session details information]](https://github.com/adobe/xdm/pull/1716/files) | Um novo campo foi adicionado para indicar se um redirecionamento ocorreu. |
| Grupo de campos | [[!UICONTROL MediaAnalytics Interaction Details]](https://github.com/adobe/xdm/pull/1716/files) | Um novo campo relacionado aos relatórios de mídia foi adicionado. |
...
Para saber mais sobre o Serviço de consultas, leia a [Visão geral do Serviço de consultas](../../query-service/home.md).
...
| Suporte da interface para o modo de rascunho | Agora é possível pausar e salvar o seu progresso durante o fluxo de trabalho de origens por meio da interface. Você pode selecionar **[!UICONTROL Save as draft]** durante as etapas de detalhes, mapeamento e agendamento do fluxo de dados para salvar seu fluxo de dados como rascunho para conclusão posterior. Leia o guia sobre [como salvar fluxos de dados como rascunhos na interface](../../sources/tutorials/ui/draft.md) para obter mais informações. |
