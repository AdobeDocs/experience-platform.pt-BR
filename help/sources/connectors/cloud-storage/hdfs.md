...
## Connect [!DNL Apache] HDFS para [!DNL Platform]

A documentação abaixo fornece informações sobre como se conectar [!DNL Apache] HDFS para [!DNL Platform] usando APIs ou a interface do usuário:
