...
O tipo de bloco **[!UICONTROL Split]** permite dividir o novo público em vários subpúblicos. Você pode dividir esse público com base na porcentagem ou por um atributo. Ao dividir o público em subpúblicos, essa divisão é **persistente**. Isso significa que o perfil estará no mesmo subpúblico-alvo em cada avaliação.
