...
* **[!UICONTROL Account ID]**: Preencha a ID da sua conta com o Google. Essa pode ser a sua ID de rede ou a ID do link de Audiência. Normalmente, essa é uma ID de oito dígitos.
