---
keywords: Experience Platform;página inicial;tópicos populares;nuvem de marketing do salesforce;Marketing Cloud do Salesforce;automação de marketing
...
[!DNL Experience Platform] O fornece suporte para assimilação de dados de sistemas de automação de marketing de terceiros. O suporte para provedores de automação de marketing inclui [!DNL Salesforce Marketing Cloud].
