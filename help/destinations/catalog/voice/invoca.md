...
[!DNL Invoca] O traz dados de chamada e insights de voz para a jornada digital do cliente. Com [!DNL Invoca’s] na call intelligence platform, os profissionais de marketing finalmente contam com o analytics para medir os resultados das chamadas e vincular as conversões offline ao gasto digital.

[!DNL Invoca Tags] O é uma voz da extensão do cliente no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão em [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html).
...
![Extensão Invoca](../../assets/catalog/voice/invoca/catalog.png)
...
Para instalar o [!DNL Invoca Tags] extensão:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte [Página de Tags Invoca no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html).
