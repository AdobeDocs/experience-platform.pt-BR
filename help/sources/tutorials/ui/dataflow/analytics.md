---
keywords: Experience Platform, home, tópicos populares, analytics, mixpanel
solution: Experience Platform
title: Criar um fluxo de dados usando uma fonte do Analytics na interface do usuário
...
# Criar um fluxo de dados usando uma fonte de análise na interface do usuário

Um fluxo de dados é uma tarefa agendada que recupera e assimila dados de uma fonte para um conjunto de dados no Adobe Experience Platform. Este tutorial fornece etapas sobre como criar um fluxo de dados para uma fonte de análise usando a interface do usuário da plataforma.

>[!NOTE]
>
>Para criar um fluxo de dados, você já deve ter uma conta autenticada no [!DNL Mixpanel] fonte. Veja o tutorial em [criar um [!DNL Mixpanel] conexão de origem na interface do usuário](../../ui/create/analytics/mixpanel.md) para obter mais informações.
...
Ao seguir este tutorial, você criou com sucesso um fluxo de dados para trazer dados da sua fonte de análise para a Platform. Os dados recebidos agora podem ser usados pelo downstream [!DNL Platform] serviços como [!DNL Real-time Customer Profile] e [!DNL Data Science Workspace]. Consulte os seguintes documentos para obter mais detalhes:
