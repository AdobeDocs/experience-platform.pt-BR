...
description: A extensão Parse.ly Analytics é um destino de análise na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão do Parse.ly Analytics é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do Parse.ly Analytics {#parsely-analytics-extension}

## Visão geral {#overview}

O Parse.ly Analytics ajuda mais de 2.500 empresas a usar dados para entender suas audiências online. Essa extensão instala um trecho do JavaScript, que acompanha como os visitantes interagem com o conteúdo do site.

O Parse.ly é uma extensão de análise na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte Análise [](https://www.parse.ly/)Parse.ly.
...
![Extensão do Parse.ly Analytics](assets/parsely-extension.png)
...
Para instalar a extensão Parse.ly:
