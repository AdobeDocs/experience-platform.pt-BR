...
Essa mensagem de erro é exibida quando a organização de IMS não recebe as permissões apropriadas para [!DNL Identity Service]. Contate o administrador do sistema para resolver esse problema.
...
Veja a seguir uma lista das mensagens de erro relacionadas a [!DNL Identity Service] que você pode encontrar ao usar o [API de assimilação de dados](https://www.adobe.io/experience-platform-apis/references/data-ingestion/).
...
Esse erro é exibido quando um registro assimilado apresenta uma identidade cujo namespace associado não existe ou está inacessível para sua Organização IMS.
...
Ao assimilar dados em lote, essa mensagem de erro é exibida quando a organização de IMS não recebe as permissões apropriadas para [!DNL Identity Service]. Contate o administrador do sistema para resolver esse problema.
