---
keywords: Experience Platform;home;popular topics;configurar fluxo de dados;conector de sucesso do cliente
solution: Experience Platform
title: Configurar um fluxo de dados para uma conexão de fonte de sucesso do cliente na interface do usuário
topic: overview
type: Tutorial
description: Um fluxo de dados é uma tarefa programada que recupera e ingere dados de uma fonte para um conjunto de dados [!DNL Platform] dataset. Este tutorial fornece etapas para configurar um novo fluxo de dados usando sua conta de sucesso do cliente.
...
Um fluxo de dados é uma tarefa programada que recupera e ingere dados de uma fonte para um conjunto de dados [!DNL Platform]. Este tutorial fornece etapas para configurar um novo fluxo de dados usando sua conta de sucesso do cliente.
...
Depois de criar o conector de sucesso do cliente, a etapa **[!UICONTROL Selecionar dados]** é exibida, fornecendo uma interface interativa para você explorar a hierarquia de arquivos.
...
![use-exist-dataset](../../../images/tutorials/dataflow/customer-success/use-existing-dataset.png)
...
![select-exists-dataset](../../../images/tutorials/dataflow/customer-success/select-dataset.png)
