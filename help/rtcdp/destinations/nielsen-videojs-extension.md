...
description: A extensão Nielsen VideoJS Player Player Handler é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão Nielsen VideoJS Player Player Handler é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do manipulador do player Nielsen VideoJS {#nielsen-vjs-extension}

## Visão geral {#overview}

A extensão de lançamento do Nielsen Digital SDK oferta a medição da audiência por meio dos seguintes produtos de medição digital:
...
Nielsen VideoJS Player Handler é uma extensão de análise na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.nielsen-digital-sdk-extension.html).
...
![Extensão do manipulador do player Nielsen VideoJS](assets/nielsen-videojs-extension.png)
...
Para instalar a extensão Nielsen VideoJS Player Player:
