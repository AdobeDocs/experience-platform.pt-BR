...
Siga as etapas nesta página de documentação para criar uma conexão de destino [!DNL Merkury Connections] e ativar públicos-alvo usando a interface do usuário [!DNL Adobe Experience Platform].
