---
title: Documentação do produto Real-Time CDP
description: Comece a usar o Adobe Real-Time CDP, entenda a funcionalidade avançada que ele oferece e como ele pode ajudar sua empresa. Use esta página como ponto de partida para saber mais sobre o produto.
...
>[!TAB Composição de público-alvo federado]
...
[![imagem](assets/do-not-localize/learn-more-button.svg)](https://experienceleague.adobe.com/pt-br/docs/federated-audience-composition/using/home)
...
Resuma facilmente os dados do evento em atributos de perfil por meio de uma interface intuitiva para melhorar a segmentação, a personalização e a ativação baseadas em comportamento. Com esse recurso, você pode criar atributos computados de maneira automatizada, gerenciá-los e usá-los na segmentação, destinos do Real-Time CDP ou Adobe Journey Optimizer. Além disso, os atributos computados simplificam a segmentação e os fluxos de trabalho de jornada para ajudá-lo a fornecer experiências relevantes de maneira contínua.

[![imagem](assets/do-not-localize/learn-more-button.svg)](/help/profile/computed-attributes/overview.md)
...
>[!TAB Suporte a dados de parceiros]

Execute marketing de funil superior no Real-Time CDP, com perfis de prospecto e IDs de parceiros fornecidos pelos parceiros, para alcançar novos clientes e enriquecer seus dados primários. Aproveite identificadores sem cookies e PII com hash de parceiros de dados de sua escolha para alcançar novos clientes na rede e reduzir a dependência de cookies de terceiros.

[![imagem](assets/do-not-localize/learn-more-button.svg)](/help/rtcdp/partner-data/prospecting.md)

>[!ENDTABS]

## Comece com as noções básicas {#start-with-basics}

Comece lendo o material nos links abaixo para se familiarizar com os conceitos, as interfaces do usuário, os fluxos de trabalho e os casos de uso sugeridos do Real-Time CDP.
...
<table style="table-layout:fixed">
  <tr style="border: 0;">
    ...
    <div><strong>Interface do usuário</strong><br/>Entenda os elementos da página inicial da interface do usuário do Real-Time CDP, como navegar e otimizar sua experiência no produto.</div>
    </td>
    <td>
...
## Explorar os pilares principais do Real-Time CDP e a documentação {#explore-core-pillars}

Entenda os quatro pilares principais do Adobe Real-Time CDP que ajudam você a:

* Coletar ou assimilar dados por meio de vários conectores de origem e métodos de coleta de dados;
* Gerencie e segmente seus perfis mais valiosos em públicos-alvo;
* Saiba que você está gerenciando dados enquanto mantém a conformidade com várias regulamentações, restrições e políticas aplicáveis ao uso de dados;
* Faça marketing para seus clientes e personalize a experiência deles em todos os canais.

![Trecho de um slide mostrando os quatro pilares do Adobe Real-Time CDP.](/help/rtcdp/assets/rtcdp-four-pillars.png)

Explore os links de documentação do produto abaixo para entender como os quatro pilares principais do Adobe Real-Time CDP podem ajudar você a obter casos de uso de sua empresa.
...
<table style="table-layout:auto">
  <tr style="border: 0;">
    ...
    <td>
      ...
      <strong>Governança e confiança de dados</strong><br/>Entenda como garantir a conformidade com várias regulamentações, restrições e políticas aplicáveis ao uso de dados. <br/><a href="/help/data-governance/home.md">Governança de dados</a> - <a href="/help/data-governance/labels/overview.md">Rótulos de uso de dados</a> - <a href="/help/data-governance/policies/overview.md">Políticas de uso de dados</a>
    </td>
    <td>
...
## Vídeos de introdução em destaque {#featured-videos}

Assista a estes três vídeos introdutórios para obter uma compreensão mais profunda do Real-Time CDP, sua arquitetura, interface e como ele se encaixa em um Adobe Experience Cloud maior.

<table style="margin-top: 0 !important">
<tr>
  <td>
    <a href="https://experienceleague.adobe.com/docs/platform-learn/tutorials/intro-to-platform/native-applications.html?lang=pt-BR">
      <img alt="Real-Time CDP como parte do vídeo do Adobe Experience Cloud" src="/help/rtcdp/assets/platform-apps-overview.png" />
    </a>
    <div>
      <a href="https://experienceleague.adobe.com/docs/platform-learn/tutorials/intro-to-platform/native-applications.html?lang=pt-BR">
    <strong>Real-Time CDP como parte da Adobe Experience Cloud</strong>
    </a>
    </div>
    <p>
  ...
  <td>
    <a href="https://experienceleague.adobe.com/docs/platform-learn/tutorials/intro-to-platform/interface-tour.html?lang=pt-BR">
      <img alt="imagem em miniatura do vídeo &quot;Tour de interface do Adobe Experience Platform&quot;" src="/help/rtcdp/assets/rtcdp-ui-overview.png" />
    </a>
    <div>
      <a href="https://experienceleague.adobe.com/docs/platform-learn/tutorials/intro-to-platform/interface-tour.html?lang=pt-BR">
    <strong>Tour de interface do Adobe Experience Platform</strong>
    </a>
    </div>
    <p>
    <em>Saiba como navegar na interface do usuário do Real-Time CDP</em>
    <p>
  </td>
  </tr>
  </table>
