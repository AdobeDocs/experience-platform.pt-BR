...
Selecione **[!UICONTROL List view]** para exibir a linhagem de dados como uma lista. Para voltar ao gráfico visual, selecione **[!UICONTROL Path view]**.
