...
Selecionar o ícone de informações ![ícone de informações](./images/user-guide/info-icon.png) ao lado de um conjunto de dados abre o popover de visualização do conjunto de dados.
