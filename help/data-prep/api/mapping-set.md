...
Você pode recuperar uma lista de todos os conjuntos de mapeamento para sua Organização IMS fazendo uma solicitação GET para o `/mappingSets` terminal.
...
A solicitação a seguir recuperará os dois últimos conjuntos de mapeamento em sua Organização IMS.
