...
seo-title: Extensão Clicktale
description: A extensão Clicktale é um destino analítico na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão Clicktale é um destino analítico na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão Clicktale {#clicktale-extension}

## Visão geral {#overview}

A integração da tabela de cliques com o Experience Platform Launch permite a implantação do código da tabela de cliques e a capacidade de mapear elementos de dados no Launch, usando o Editor visual da tabela de cliques.

O Clicktale é uma extensão de análise na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100082.html).
...
![Extensão Clicktale](assets/clicktale-extension.png)
...
Para instalar a extensão Clicktale:
...
Para obter informações sobre as opções de configuração de extensão, consulte a página [de extensão](https://exchange.adobe.com/experiencecloud.details.100082.html) Clicktale no Adobe Exchange.
