...
Uma resposta bem-sucedida retorna uma lista de regras para a propriedade especificada.
...
Uma resposta bem-sucedida retorna os detalhes da regra.
...
Uma resposta bem-sucedida retorna os detalhes da regra recém-criada.
...
A solicitação a seguir atualiza o `name` de uma regra existente.
...
Uma resposta bem-sucedida retorna os detalhes da regra atualizada.
...
Uma resposta bem-sucedida retorna o status HTTP 204 (Sem conteúdo) sem corpo de resposta, indicando que a regra foi excluída.
...
Uma resposta bem-sucedida retorna uma lista de bibliotecas que usam a regra especificada.
...
### Listar as revisões relacionadas de uma regra {#revisions}

Você pode listar as revisões de uma regra ao anexar `/revisions` ao caminho de uma solicitação de pesquisa.
...
Uma resposta bem-sucedida retorna uma lista de revisões que usam a regra especificada.
...
Uma resposta bem-sucedida retorna os detalhes da extensão da regra especificada.
...
Uma resposta bem-sucedida retorna os detalhes da propriedade da regra especificada.
