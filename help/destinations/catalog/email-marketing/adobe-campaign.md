...
* **[!UICONTROL Nome do Bucket]**: *Para conexões S3*. Digite o local do bucket do S3 no qual o [!DNL Experience Platform] depositará seus dados de exportação como arquivos CSV.
* **[!UICONTROL Caminho da Pasta]**: forneça o caminho no local de armazenamento onde o [!DNL Experience Platform] depositará os dados de exportação como arquivos CSV.
