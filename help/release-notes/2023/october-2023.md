...
| Recurso | Descrição |
| --- | --- |
| Métricas de uso de destinos | Novas métricas foram adicionadas ao painel de uso de licença. As métricas **[!UICONTROL Audience Activation Size]** e **[!UICONTROL Data Export Size]** fornecem uma maneira conveniente de rastrear a quantidade de dados exportados do Experience Platform em relação aos direitos de uso de licença. Consulte a documentação das [métricas disponíveis](../../dashboards/guides/license-usage.md#available-metrics) para obter descrições dessas e de outras métricas de uso de licença. |
