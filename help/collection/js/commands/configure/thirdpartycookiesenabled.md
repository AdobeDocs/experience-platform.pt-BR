...
A propriedade `thirdPartyCookiesEnabled` também controla se um [`CORE ID`](/help/collection/identity/overview.md#core-id-and-third-party-identity) pode ser solicitado nas chamadas [`getIdentity`](../getidentity.md).
