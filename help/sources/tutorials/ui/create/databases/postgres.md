...
Os conectores de origem na Adobe Experience Platform fornecem a capacidade de assimilar dados de origem externa de forma programada. Este tutorial fornece etapas para a criação de um conector de origem [!DNL PostgreSQL] (a seguir denominado &quot;PSQL&quot;) usando a interface do usuário [!DNL Platform].
...
Se você já tiver uma conexão PSQL válida, poderá ignorar o restante desse documento e prosseguir para o tutorial em [configurar um fluxo de dados](../../dataflow/databases.md).
...
Depois de coletar as credenciais necessárias, siga as etapas abaixo para vincular sua conta PSQL a [!DNL Platform].
