...
- [Visão geral](../../rtcdp/overview.md)do Perfil do cliente em tempo real: Construída com a Plataforma de dados do cliente em tempo real [!DNL Adobe Experience Platform](CDP em tempo real), as empresas ajudam a reunir dados conhecidos e desconhecidos para ativar perfis do cliente com decisões inteligentes durante toda a jornada do cliente. A CDP em tempo real combina várias fontes de dados corporativos para criar perfis unificados em tempo real que podem ser usados para fornecer experiências personalizadas individuais do cliente em todos os canais e dispositivos.
