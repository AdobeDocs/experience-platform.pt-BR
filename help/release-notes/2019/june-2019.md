...
| Agendamento | Integrado ao Serviço de Orquestração do [!DNL Experience Platform] para automatizar o treinamento do modelo, a pontuação e os pipelines de recursos com cronogramas definidos pelo usuário por meio de APIs. |
...
| Criação de conjunto de dados | Criar conjuntos de dados em [!DNL Experience Platform] por meio da sintaxe SQL padrão. |
