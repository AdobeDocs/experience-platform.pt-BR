...
>[!IMPORTANT]
>
>Esta página de documentação foi criada pelo *Snap Inc* equipe. No momento, esse é um produto beta e a funcionalidade está sujeita a alterações. Para qualquer consulta ou solicitação de atualização, entre em contato diretamente em *dev-support@snap.com*
