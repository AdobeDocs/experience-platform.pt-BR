...
description: A extensão Adform é um destino analítico na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão Adform é um destino analítico na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
A extensão de rastreamento de site Adform permite que os anunciantes implementem Pontos de rastreamento de formulário sem esforço em seus sites usando a plataforma Experience Platform Launch.

O Adform é uma extensão de análise na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103195.adform-website-tracking.html)
...
![Adicionar extensão](/help/rtcdp/destinations/assets/adform-extension.png)
