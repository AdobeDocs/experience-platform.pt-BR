...
description: A extensão de tag do LinkedIn Insight é um destino de publicidade no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
[!DNL LinkedIn Insight Tag] é uma extensão de publicidade no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte [Marca do LinkedIn Insight](https://business.linkedin.com/marketing-solutions/insight-tag).
...
![Extensão da Marca LinkedIn Insight](../../assets/catalog/advertising/linkedin/catalog.png)
