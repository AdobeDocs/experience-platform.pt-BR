---
keywords: Experience Platform;página inicial;tópicos populares;esquema crm;crm;CRM;salesforce;Salesforce
...
| `TENANT_ID` | Uma ID usada para garantir que os recursos criados tenham o namespace adequado e estejam contidos na Organização IMS. | `b2bcdpproductiontest` |
