...
Para enviar dados de público-alvo para [!DNL Oracle Eloqua], primeiro [conecte o destino](#connect-destination) em [!DNL Adobe Experience Platform] e depois [configure uma importação de dados](#import-data-into-eloqua) do local de armazenamento para [!DNL Oracle Eloqua].
