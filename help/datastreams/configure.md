...
Consulte [Implementar o Adobe Analytics com o Edge Network](https://experienceleague.adobe.com/pt-br/docs/analytics/implementation/aep-edge/overview) no guia de implementação [!DNL Analytics] para obter mais informações.
