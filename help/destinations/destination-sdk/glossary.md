...
# Glossário do Destination SDK [!DNL Adobe Experience Platform]

Consulte este glossário para obter definições de termos usados no Destination SDK. Para outros termos do [!DNL Adobe Experience Platform], consulte o [glossário do Experience Platform](/help/landing/glossary.md).
