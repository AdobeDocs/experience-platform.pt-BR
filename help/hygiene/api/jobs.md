...
A carga da solicitação está estruturada de forma semelhante à de uma [solicitação de exclusão na API Privacy Service](../../privacy-service/api/privacy-jobs.md#access-delete). Inclui uma matriz `users` cujos objetos representam os usuários cujos dados serão excluídos.
