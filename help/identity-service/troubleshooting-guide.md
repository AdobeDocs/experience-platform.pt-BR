...
Veja a seguir uma lista de mensagens de erro relacionadas a [!DNL Identity Service] você pode encontrar ao usar a variável [API de assimilação em lote](https://developer.adobe.com/experience-platform-apis/references/batch-ingestion/).
