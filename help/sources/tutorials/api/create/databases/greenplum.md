...
title: Criar uma conexão de origem GreenPlum usando a API de serviço de fluxo
topic: overview
type: Tutorial
description: Saiba como conectar o GreenPlum à Adobe Experience Platform usando a API do Serviço de Fluxo.
...
# Criar uma conexão de origem [!DNL GreenPlum] usando a API [!DNL Flow Service]
