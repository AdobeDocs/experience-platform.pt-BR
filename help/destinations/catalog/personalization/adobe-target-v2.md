...
Para obter informações sobre as opções de configuração de extensão, consulte o [Página de extensão do Adobe Target v2](../../../tags/extensions/client/target-v2/overview.md) na documentação das tags.
