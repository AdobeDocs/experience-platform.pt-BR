...
| [[!DNL Data Landing Zone]](../../destinations/catalog/cloud-storage/data-landing-zone.md) | Novo | O [!DNL Data Landing Zone] é uma interface de armazenamento de dados do [!DNL Azure Blob] provisionada pela Adobe Experience Platform, que concede acesso a um recurso seguro de armazenamento de arquivos baseado em nuvem para exportar arquivos para fora da Platform. Este novo destino oferece funcionalidade aprimorada de exportação de arquivos e oferece suporte a exportações do conjunto de dados do [!BADGE Beta]{type=Informative}. |
...
| Atualização do [[!DNL Amazon S3] ](../../destinations/catalog/cloud-storage/amazon-s3.md#changelog) | Atualização dos pacotes | Com essa atualização, o destino fornece funcionalidade aprimorada de exportação de arquivos e oferece suporte a exportações do conjunto de dados do [!BADGE Beta]{type=Informative}. |
| Atualização do [[!DNL Azure Blob] ](../../destinations/catalog/cloud-storage/azure-blob.md#changelog) | Atualização dos pacotes | Com essa atualização, o destino fornece funcionalidade aprimorada de exportação de arquivos e oferece suporte a exportações do conjunto de dados do [!BADGE Beta]{type=Informative}. |
| Atualização do [[!DNL SFTP] ](../../destinations/catalog/cloud-storage/sftp.md#changelog) | Atualização dos pacotes | Com essa atualização, o destino fornece funcionalidade aprimorada de exportação de arquivos e oferece suporte a exportações do conjunto de dados do [!BADGE Beta]{type=Informative}. |
...
| Recurso | Descrição |
| ------- | ----------- |
| Portal de público-alvo | O Portal de público-alvo oferece uma nova experiência de navegação para acessar, criar e gerenciar públicos-alvo na Adobe Experience Platform. No Portal de público-alvo, você pode visualizar públicos-alvo gerados pela Platform e externamente, melhorar a eficiência do trabalho por meio de filtragem, pastas e tags, criar públicos-alvo gerados pela Platform e importar públicos gerados externamente por meio de arquivos CSV. Para obter mais informações sobre o Audience Portal, leia a [Visão geral do Audience Portal](../../segmentation/ui/audience-portal.md). |
...
| Compatibilidade com o [!DNL Phoenix] | Agora você pode usar a origem do [[!DNL Phoenix] ](../../sources/connectors/databases/phoenix.md) para trazer dados do seu banco de dados do [!DNL Phoenix] para a Experience Platform. |
...
| --- | --- | --- |
| Classe | [[!UICONTROL Perfil de cliente potencial individual do XDM]](https://github.com/adobe/xdm/pull/1758/files) | Use esta classe para atrair perfis em potencial provenientes de casos de uso de conquista de cliente do topo de funil dos fornecedores de dados. |
