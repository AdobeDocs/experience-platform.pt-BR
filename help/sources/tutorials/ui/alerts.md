...
>title="Assinar alertas de fontes"
>abstract="Os alertas permitem receber notificações com base no status dos fluxos de dados das fontes. É possível definir notificações de alerta para obter atualizações se o fluxo de dados tiver sido iniciado, tiver sido bem-sucedido, tiver falhado ou não tiver assimilado dados."
