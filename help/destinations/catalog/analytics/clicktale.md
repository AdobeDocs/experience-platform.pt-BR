...
A variável [!DNL Clicktale] A extensão de tag permite implantar código e mapear elementos de dados usando [!DNL Clicktale's] Editor visual.
...
Para instalar o [!DNL Clicktale] extensão:
...
Para obter informações sobre as opções de configuração de extensão, consulte [Página de extensão do Clicktale](https://exchange.adobe.com/experiencecloud.details.100082.html) no Adobe Exchange.
