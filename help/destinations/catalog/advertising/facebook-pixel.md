---
keywords: extensões de pixels do facebook;extensão de pixels do facebook;destinos de pixels do facebook;pixel do facebook
title: Extensão facebook Pixel
description: A extensão Facebook Pixel é um destino de publicidade no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
A variável [!DNL Facebook Pixel] O é uma ferramenta de análise que permite medir a eficácia de sua publicidade, entendendo as ações que as pessoas tomam em seu site.

[!DNL Facebook Pixel] O é uma extensão publicitária no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte [Site do facebook Pixel](https://developers.facebook.com/docs/facebook-pixel/).
...
![Extensão facebook Pixel](../../assets/catalog/advertising/facebook-pixel/catalog.png)
...
Para instalar o [!DNL Facebook Pixel] extensão:
