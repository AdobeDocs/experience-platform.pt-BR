---
keywords: ramificação; extensão da ramificação; destino da ramificação
...
A Ramificação fornece links e soluções eficientes que ajudam a adquirir, envolver e medir em todos os dispositivos, canais e plataformas.

Ramificação é uma extensão de publicidade no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a [página de recursos](https://branch.io/features/) no site do Branch.
