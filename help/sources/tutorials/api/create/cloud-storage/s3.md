---
title: Conecte o Amazon S3 ao Experience Platform usando a API do serviço de fluxo
...
# Conectar [!DNL Amazon S3] ao Experience Platform usando a API [!DNL Flow Service]
...
Leia as etapas abaixo para obter informações sobre como conectar sua origem [!DNL Amazon S3] ao Experience Platform no Azure.
...
## Conectar [!DNL Amazon S3] ao Experience Platform no Amazon Web Services (AWS) {#aws}
