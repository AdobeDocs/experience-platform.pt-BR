...
![Selecionar nova sequência de dados.](assets/configure/new-datastream-button.png)
...
Use as configurações de **[!UICONTROL Device Lookup]** para selecionar informações específicas de dispositivo que deseja coletar.
