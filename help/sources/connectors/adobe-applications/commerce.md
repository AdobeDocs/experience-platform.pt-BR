...
* Depois de instalar com êxito a extensão do conector, entre na sua conta do Adobe no Experience Cloud e [confirme a ID da organização](https://experienceleague.adobe.com/docs/core-services/interface/administration/organizations.html#concept_EA8AEE5B02CF46ACBDAD6A8508646255). Essa ID está associada à empresa de Experience Cloud provisionados. Ela é formatada como uma sequência de 24 caracteres alfanuméricos e inclui um `@AdobeOrg` obrigatório.
