...
Este tutorial usa a API de Serviço de Fluxo para guiá-lo pelas etapas para conectar a plataforma de experiência ao Amazon Redshift (a seguir, &quot;Redshift&quot;).
...
Para criar uma conexão Redshift, um conjunto de especificações de conexão Redshift deve existir no Serviço de fluxo. A primeira etapa na conexão da Plataforma ao Redshift é recuperar essas especificações.
