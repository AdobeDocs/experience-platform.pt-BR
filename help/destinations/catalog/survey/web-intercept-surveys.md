---
keywords: QuestionPro Intercept Pesquisas;questionPro intercept pesquisas;QuestionPro;questionpro
title: Extensão de Pesquisas de Interceptação QuestionPro
description: A extensão de Pesquisas de intercepto QuestionPro é um destino de pesquisa no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do [!DNL QuestionPro Intercept Surveys] {#questionpro-extension}

## Visão geral {#overview}

O [!DNL QuestionPro Intercept Surveys] é uma plataforma para implantar pesquisas e coletar dados de atitude no ponto de transação ou quando os usuários entram/saem do site.

[!DNL QuestionPro Intercept Surveys] é uma extensão de pesquisa em [!DNL Adobe Experience Platform]. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
...
![Extensão de Pesquisas de Interceptação QuestionPro](../../assets/catalog/survey/web-intercept-surveys/catalog.png)
...
Para obter informações sobre as opções de configuração de extensão e suporte à instalação, consulte a [página Pesquisas de interceptação do QuestionPro no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
