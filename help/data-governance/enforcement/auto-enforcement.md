...
Foi feito um aprimoramento para a aplicação de políticas de consentimento em destinos em lote e de transmissão, incluindo ativações de mídia paga. Esse aprimoramento está disponível para clientes do Privacy e Security Shield ou Healthcare Shield e remove proativamente perfis de destinos de lote e streaming conforme o status de consentimento é alterado. Também garante que as alterações de consentimento sejam propagadas imediatamente para que o público-alvo correto seja sempre direcionado.
