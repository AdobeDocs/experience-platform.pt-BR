...
>[!NOTE]
>
>O conector do Armazenamento de Arquivo do Azure está em beta. Consulte a [Visão geral das fontes](../../home.md#terms-and-conditions) para obter mais informações sobre o uso de conectores marcados com beta.
...
A documentação abaixo fornece informações sobre como conectar [!DNL Azure File Storage] a [!DNL Platform] usando APIs ou a interface do usuário:
