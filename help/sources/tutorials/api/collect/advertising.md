---
keywords: Experience Platform;home;popular topics;serviço de fluxo;publicidade;google adwords;publicidade
solution: Experience Platform
title: Coletar dados de publicidade usando conectores de fonte e APIs
topic: overview
type: Tutorial
description: Este tutorial aborda as etapas para recuperar dados de um aplicativo de publicidade de terceiros e assimilá-los à Plataforma usando conectores de origem e a API de Serviço de Fluxo.
...
# Coletar dados de publicidade usando conectores de fonte e APIs
...
| -------- | ----------- |
| `baseConnectionId` | A ID de conexão exclusiva do aplicativo de publicidade que você está acessando. |
| `params.path` | O caminho do arquivo de origem. |
| `connectionSpec.id` | A ID de especificação de conexão associada ao aplicativo de publicidade. |
...
Um dataflow é responsável por coletar dados de fontes e trazê-los para a Plataforma. Para criar um fluxo de dados, você deve primeiro obter as especificações do fluxo de dados responsáveis pela coleta de dados de publicidade.
...
O último passo para coletar dados de publicidade é criar um fluxo de dados. Agora, você tem os seguintes valores obrigatórios preparados:
