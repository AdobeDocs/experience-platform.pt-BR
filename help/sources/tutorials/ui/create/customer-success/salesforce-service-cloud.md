...
Para acessar sua conta SSC na Plataforma, forneça os seguintes valores:
...
Depois de reunir as credenciais necessárias, siga as etapas abaixo para criar uma nova conta SSC para se conectar à Plataforma.
