...
Depois de criar sua conta publicitária, a etapa **[!UICONTROL Select data]** é exibida, fornecendo uma interface interativa para explorar sua hierarquia de arquivos.
...
A caixa de diálogo **[!UICONTROL Select schema]** é exibida. Selecione o schema que deseja aplicar ao novo conjunto de dados e clique em **[!DNL Done]**.
