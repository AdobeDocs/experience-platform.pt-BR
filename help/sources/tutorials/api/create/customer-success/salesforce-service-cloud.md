---
keywords: Experience Platform;home;popular tópicos;ssc;SSC;Salesforce Service Cloud;salesforce service cloud;;home;popular topics;ssc;SSC;Salesforce Service Cloud;salesforce service cloud
solution: Experience Platform
title: Criar uma conexão de origem da Salesforce Service Cloud usando a API de serviço de fluxo
topic: overview
type: Tutorial
description: Saiba como conectar a Adobe Experience Platform à Salesforce Service Cloud usando a API de Serviço de Fluxo.
