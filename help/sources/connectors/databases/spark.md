...
topic: overview
description: Saiba como conectar o Apache Spark no Azure HDInsights à Adobe Experience Platform usando APIs ou a interface do usuário.
...
[!DNL Experience Platform] fornece suporte para assimilar dados de um banco de dados de terceiros. [!DNL Platform] pode se conectar a diferentes tipos de bancos de dados, como relacional, NoSQL ou data warehouses. O suporte para provedores de banco de dados inclui [!DNL Apache Spark] em [!DNL Azure HDInsights].
...
A documentação abaixo fornece informações sobre como conectar [!DNL Apache Spark] em [!DNL Azure HDInsights] a [!DNL Platform] usando APIs ou a interface do usuário:

## Conecte [!DNL Apache Spark] em [!DNL Azure HDInsights] a [!DNL Platform] usando APIs

- [Criar um Apache Spark na conexão de origem do Azure HDInsights usando a API de Serviço de Fluxo](../../tutorials/api/create/databases/spark.md)
