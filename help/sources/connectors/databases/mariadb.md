...
topic: overview
description: A documentação abaixo fornece informações sobre como conectar o MariaDB à Plataforma usando APIs ou a interface do usuário.
...
O Experience Platform oferece suporte para assimilar dados de um banco de dados de terceiros. [!DNL Platform] pode se conectar a diferentes tipos de bancos de dados, como relacional, NoSQL ou data warehouses. O suporte para provedores de banco de dados inclui [!DNL MariaDB].
...
A documentação abaixo fornece informações sobre como se conectar [!DNL MariaDB] a [!DNL Platform] APIs ou à interface do usuário:

## Conectar-se [!DNL MariaDB] a [!DNL Platform] APIs

- [Crie um conector MariaDB usando a API de Serviço de Fluxo](../../tutorials/api/create/databases/mariadb.md)
...
## Conectar-se [!DNL MariaDB] à [!DNL Platform] interface do usuário

- [Criar um conector de origem MariaDB na interface do usuário](../../tutorials/ui/create/databases/mariadb.md)
