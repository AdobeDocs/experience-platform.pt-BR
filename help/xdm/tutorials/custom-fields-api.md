...
Como opção, você pode fornecer rótulos voltados para o cliente para cada valor em uma `meta:enum` , com cada rótulo vinculado a um valor correspondente em `enum`.
