---
keywords: Invocar;invoca;Invoca;invoca
title: Extensão Tags da Invoca
description: A extensão Invoca Tags é uma voz do destino do cliente no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do [!DNL Invoca Tags] {#invoca-extension}

## Visão geral {#overview}

O [!DNL Invoca] traz dados de chamada e insights de voz para a jornada digital do cliente. Com a plataforma de inteligência de chamadas [!DNL Invoca’s], os profissionais de marketing finalmente contam com análises para medir os resultados das chamadas e vincular as conversões offline ao gasto digital.

[!DNL Invoca Tags] é uma voz da extensão do cliente em [!DNL Adobe Experience Platform]. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html).
...
![Invocar extensão](../../assets/catalog/voice/invoca/catalog.png)
...
Para instalar a extensão [!DNL Invoca Tags]:
...
Para obter informações sobre as opções de configuração de extensão e suporte à instalação, consulte a página [Marcas de invocação no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html).
