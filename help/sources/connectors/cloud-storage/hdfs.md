...
title: Visão geral do conector de origem HDFS Apache
topic: overview
...
A Adobe Experience Platform fornece conectividade nativa para provedores de nuvem como AWS, [!DNL Google Cloud Platform] e [!DNL Azure], permitindo que você extraia seus dados desses sistemas. Os dados ingeridos podem ser formatados como JSON, Parquet ou delimitados. O suporte para provedores de armazenamentos em nuvem inclui [!DNL Apache] HDFS.
...
## Ligar [!DNL Apache] HDFS a [!DNL Platform]
...
- [Criar uma conexão de origem HDFS usando a API de Serviço de Fluxo](../../tutorials/api/create/cloud-storage/hdfs.md)
