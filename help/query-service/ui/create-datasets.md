...
4. Clique em **[!UICONTROL Create Dataset]**. ![Imagem](../images/ui/output-dataset.png)
...
6. Insira uma descrição do conjunto de dados e clique em **[!UICONTROL Run Query]**.![Imagem](../images/ui/run-query.png)
