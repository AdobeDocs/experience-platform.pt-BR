...
| Recurso | Descrição |
| --- | --- |
| Apresentando o [!DNL Identity Graph Linking Rules] | O [!DNL Identity Graph Linking Rules] foi projetado para ajudar você a manter perfis de clientes precisos para marketing personalizado, evitando o colapso dos gráficos.<ul><li>Use a [Ferramenta de simulação de gráfico](../../identity-service/identity-graph-linking-rules/graph-simulation.md) para testar e validar suas configurações.</li><li>Consulte o [painel de identidade](../../identity-service/identity-graph-linking-rules/implementation-guide.md#validate-your-graphs) para monitorar qualquer instância de recolhimento de gráficos em sua organização.</li><li>Para começar, leia o [[!DNL Identity Graph Linking Rules] guia de implementação](../../identity-service/identity-graph-linking-rules/implementation-guide.md).</li></ul> **Observação**: haverá alterações em seus dados até que você defina manualmente suas configurações de identidade. |
