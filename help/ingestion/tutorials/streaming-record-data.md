...
| Propriedade | Descrição |
| -------- | ----------- |
| `{TENANT_ID}` | Essa ID é usada para garantir que os recursos criados tenham o namespace adequado e estejam contidos na Organização IMS. Para obter mais informações sobre a ID do locatário, leia a [guia de registro de esquema](../../xdm/api/getting-started.md#know-your-tenant-id). |
