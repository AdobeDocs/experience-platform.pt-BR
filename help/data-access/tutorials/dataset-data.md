...
## Recuperar uma lista de lotes em sua Organização IMS
...
A resposta inclui um objeto que lista todos os lotes relacionados à Organização IMS, com cada valor de nível superior representando um lote. Os objetos de lote individuais contêm os detalhes desse lote específico. A resposta abaixo foi minimizada por questões de espaço.
...
Depois de ter uma ID de arquivo exclusiva, você pode usar a variável [!DNL Data Access] API para acessar os detalhes específicos do arquivo, incluindo nome, tamanho em bytes e um link para baixá-lo.
