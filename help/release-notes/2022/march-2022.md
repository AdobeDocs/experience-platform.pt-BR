...
Para obter mais informações sobre painéis de Destinos na Platform, consulte a [Visão geral dos painéis de Destinos](../../dashboards/guides/destinations.md).
...
| [API do Edge Network Server](../../server-api/overview.md) | A API do servidor permite que os clientes interajam com o Edge Network Experience Platform usando um novo endpoint autenticado para atender a uma variedade de casos de uso de coleta de dados, personalização, publicidade e marketing. |
...
| Recurso | Descrição |
| --- | --- |
| Novas fontes agora disponíveis para uso de B2B | Agora você pode usar todas as fontes disponíveis na Platform para casos de uso de B2B. Consulte o [catálogo de fontes](../../sources/home.md) para obter uma lista completa das fontes disponíveis. |
| Disponibilidade geral da nova origem [!DNL Oracle Eloqua] | Agora você pode usar a origem [!DNL Oracle Eloqua] para assimilar dados facilmente da sua instância [!DNL Oracle Eloqua] (conta, campanha, contatos) na Platform. Consulte a documentação sobre [criação de uma [!DNL Oracle Eloqua] conexão de origem](../../sources/connectors/marketing-automation/oracle-eloqua.md) para obter mais informações. |
