...
A extensão [!DNL Yext Conversion Tracking] permite medir conversões que podem ser atribuídas ao uso de produtos Yext.

[!DNL Yext Conversion Tracking] é uma extensão do Analytics no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
