...
- [Visão geral da origem do Adobe Workfront](connectors/adobe-applications/workfront.md)
   - [Criar uma conexão de origem do Workfront na interface](./tutorials/ui/create/adobe-applications/workfront.md)
