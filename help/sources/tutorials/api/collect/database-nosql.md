...
| `params.dataSetId` | A ID do conjunto de dados de destino coletado na etapa anterior. |
| `connectionSpec.id` | A ID da especificação de conexão usada para se conectar ao Data Lake. Essa ID é: `c604ff05-7f1a-43c0-8e18-33bf874cb11c`. |
