...
Uma resposta bem-sucedida retorna os detalhes da especificação de fluxo de dados responsável por trazer os dados do seu sistema de publicidade para a Plataforma. Armazene o valor do `id` campo conforme necessário na próxima etapa para criar um novo fluxo de dados.
