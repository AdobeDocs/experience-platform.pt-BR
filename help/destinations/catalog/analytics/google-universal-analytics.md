...
[!DNL Google Universal Analytics] O permite avaliar o ROI da publicidade, além de rastrear Flashes, vídeos e sites e aplicativos de redes sociais.
...
Para instalar o [!DNL Google Universal Analytics] extensão:
...
Para obter informações sobre as opções de configuração de extensão, consulte [Página de extensão do Google Universal Analytics](https://exchange.adobe.com/experiencecloud.details.102829.google-universal-analytics.html) no Adobe Exchange.
