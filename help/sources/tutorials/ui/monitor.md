...
Na página **[!UICONTROL Contas]** , é possível visualização de uma lista de fluxos de dados ou conjuntos de dados de público alvo existentes associados à conta acessada.Selecione o controle secundário para exibir mais opções disponíveis para o fluxo de dados selecionado. Essas opções são descritas a seguir:
...
O painel de classificação é exibido. Selecione a fonte que deseja acessar no menu de rolagem e selecione o fluxo de dados na lista à direita. Você também pode selecionar o controle secundário para exibir mais opções disponíveis para o fluxo de dados selecionado.
