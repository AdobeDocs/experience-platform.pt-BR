...
![Estrutura do grupo de campos](../../images/field-groups/patient.png)

| Nome de exibição | Propriedade | Tipo de dados | Descrição |
| --- | --- | --- | --- |
| [!UICONTROL Endereço] | `address` | Matriz de [[!UICONTROL Endereço]](../../data-types/healthcare/address.md) | As informações de endereço do paciente. |
...
| [!UICONTROL Profissional geral] | `generalPractioner` | Matriz de [[!UICONTROL Referência]](../../data-types/healthcare/reference.md) | O prestador de cuidados primários do paciente. |
| [!UICONTROL Identificador] | `identifier` | Matriz de [[!UICONTROL Identificador]](../../data-types/healthcare/identifier.md) | Um identificador para o paciente. |
...
| [!UICONTROL Gerenciando a Organização] | `managingOrganization` | [[!UICONTROL Referência]](../../data-types/healthcare/reference.md) | A organização de custódia do registro do paciente. |
| [!UICONTROL Estado civil] | `maritalStatus` | [[!UICONTROL Conceito codificável]](../../data-types/healthcare/codeable-concept.md) | O estado civil do paciente. |
| [!UICONTROL Nome] | `name` | Matriz de [[!UICONTROL Nome humano]](../../data-types/healthcare/human-name.md) | O nome associado ao paciente. |
| [!UICONTROL Detalhes de contato] | `telecom` | Matriz de [[!UICONTROL Ponto de Contato]](../../data-types/healthcare/contact-point.md) | Um detalhe de contato, como número de telefone ou endereço de e-mail, pelo qual o paciente pode ser contatado. |
...
![estrutura de contato](../../images/field-groups/healthcare-patient/contact.png)
