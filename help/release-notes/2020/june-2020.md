...
| Recurso | Descrição |
| ------- | ----------- |
| Suporte adicional à API e à interface do usuário para sistemas de armazenamento em nuvem | Novos conectores de origem para o Apache HDFS |
| Suporte adicional à API e à interface do usuário para bancos de dados | Novos conectores de origem para Couchbase. |
