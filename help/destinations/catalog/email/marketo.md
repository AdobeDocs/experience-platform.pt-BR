...
# [!DNL Marketo] extensão {#marketo-extension}

## Visão geral {#overview}

[!DNL Marketo]O poderoso software de automação de marketing da ajuda os profissionais de marketing a principais na arte e na ciência do marketing digital para atrair clientes e clientes potenciais.

[!DNL Marketo] é uma extensão de email no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte [página de extensão no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.106250.bounteous-extension-for-adobe-launch-and-marketo.html).
...
Para instalar o [!DNL Marketo] extensão:

1. No [Interface da plataforma](https://platform.adobe.com/), vá para **[!UICONTROL Destinos]** > **[!UICONTROL Catálogo]**.
2. Selecione a extensão no catálogo ou use a barra de pesquisa.
3. Clique no destino para realçá-lo e selecione **[!UICONTROL Configurar]** no painel direito. Se a variável **[!UICONTROL Configurar]** estiver acinzentado, você não tem a **[!UICONTROL manage_properties]** permissão. Consulte [Pré-requisitos](#prerequisites).
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte [Página do Marketo sobre o Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.106250.bounteous-extension-for-adobe-launch-and-marketo.html).
