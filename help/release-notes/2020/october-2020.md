...
| Recurso | Descrição |
| ------- | ----------- |
| Adições à API de visualização do perfil | A API de visualização do perfil (`/previewsamplestatus`) agora inclui a capacidade de exibir um detalhamento do total de fragmentos de perfil em sua organização, bem como exibir a distribuição de fragmentos de perfil nos namespaces de identidade. |
