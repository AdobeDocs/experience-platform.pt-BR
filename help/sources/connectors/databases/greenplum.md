...
topic: overview
description: A documentação abaixo fornece informações sobre como conectar o GreenPlum à plataforma usando APIs ou a interface do usuário.
...
Diferentes tipos de bancos de dados de terceiros são suportados, incluindo depósitos relacionais, NoSQL ou de dados. O suporte para provedores de banco de dados inclui [!DNL GreenPlum].
...
A documentação abaixo fornece informações sobre como se conectar [!DNL GreenPlum] a [!DNL Platform] APIs ou à interface do usuário:

## Conectar-se [!DNL GreenPlum] a [!DNL Platform] APIs
...
## Conectar-se [!DNL GreenPlum] à [!DNL Platform] interface do usuário
