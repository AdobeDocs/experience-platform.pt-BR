...
Depois que uma violação é acionada, o botão **[!UICONTROL Salvar]** é desativado para a ativação até que os componentes apropriados sejam atualizados para atender às políticas de uso de dados.
