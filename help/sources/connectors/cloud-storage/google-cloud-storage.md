...
A documentação abaixo fornece informações sobre como conectar o [!DNL Google Cloud Storage] à Plataforma usando APIs ou a interface do usuário:
