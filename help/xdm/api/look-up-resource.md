...
description: Você pode pesquisar recursos específicos na API do Registro do Schema fazendo uma solicitação de GET que inclui o $id (URI codificado por URL) do recurso no caminho da solicitação.
