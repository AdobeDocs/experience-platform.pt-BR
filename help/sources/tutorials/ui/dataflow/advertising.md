...
title: Criar um fluxo de dados usando uma fonte de publicidade na interface
type: Tutorial
...
Depois de criar sua conta de origem de publicidade, a variável **[!UICONTROL Adicionar dados]** é exibida, fornecendo uma interface para explorar a hierarquia da tabela da conta de origem de publicidade.
...
Ao seguir este tutorial, você criou com sucesso um fluxo de dados para trazer dados da sua fonte de publicidade para a Platform. Os dados recebidos agora podem ser usados pelo downstream [!DNL Platform] serviços como [!DNL Real-Time Customer Profile] e [!DNL Data Science Workspace]. Consulte os seguintes documentos para obter mais detalhes:
