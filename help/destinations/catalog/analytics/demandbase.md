---
keywords: extensão do demandbase;demandbase;destino do demandbase
title: Extensão Demandbase
description: A extensão do Demandbase é um destino de análise no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do [!DNL Demandbase] {#demandbase-extension}

## Visão geral {#overview}

Obtenha insights da conta B2B [!DNL Demandbase] diretamente para o [!DNL Adobe Analytics], onde é possível segmentar o tráfego e o comportamento por Setor, Receita e contas de destino. Essa visualização baseada em conta fornece insights exclusivos sobre engajamento, conversão e a fonte para seus visitantes mais valiosos.

[!DNL Demandbase] é uma extensão do Analytics em [!DNL Adobe Experience Platform]. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101605.html).
...
![Extensão do Demandbase](../../assets/catalog/analytics/demandbase/catalog.png)
...
Para obter informações sobre as opções de configuração de extensão, consulte a [página de extensão do Demandbase](https://exchange.adobe.com/experiencecloud.details.101605.html) no Adobe Exchange.
