...
type: Tutorial
description: Saiba como criar uma conexão de origem do Apache Hadoop Distributed File System usando a interface do Adobe Experience Platform.
...
Depois de obter as credenciais necessárias, siga as etapas abaixo para vincular sua conta HDFS a [!DNL Experience Platform].
...
Seguindo este tutorial, você estabeleceu uma conexão com sua conta HDFS. Agora você pode seguir para o próximo tutorial e [configurar um fluxo de dados para trazer dados do seu armazenamento na nuvem para o  [!DNL Experience Platform]](../../dataflow/batch/cloud-storage.md).
