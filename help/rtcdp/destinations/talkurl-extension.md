...
description: A extensão Caixa de entrada do URL de fala é uma voz do destino do cliente na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão Caixa de entrada do URL de fala é uma voz do destino do cliente na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão da Caixa de Entrada do URL de Conversação {#talk-url-extension}
...
A Caixa de entrada do URL de fala é uma voz da extensão do cliente na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html).
...
![Extensão da Caixa de Entrada do URL de Conversação](assets/talkurl-extension.png)
...
Para instalar a extensão da Caixa de entrada do URL de fala:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte a página Caixa de entrada do URL de [conversa no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html).
