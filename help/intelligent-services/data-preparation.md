...
Para obter mais exemplos e informações sobre requisitos de dados históricos, visite a [Customer AI](./customer-ai/data-requirements.md#data-requirements) ou [Attribution AI](./attribution-ai/input-output.md#data-requirements) seção de requisitos de dados históricos na documentação de entrada/saída.
...
| Padrão | IA de atribuição | Customer AI |
| --- | --- | --- |
