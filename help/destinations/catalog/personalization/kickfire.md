...
# [!DNL KickFire] extensão {#kickfire-extension}

## Visão geral {#overview}

[!DNL KickFire's] A inteligência de endereços IP e os dados firmográficos B2B permitem traduzir endereços IP para empresas, identificar visitantes anônimos da Web e integrar dados de conta à sua pilha de tecnologia, tudo com base no endereço IP de uma empresa.

[!DNL KickFire] é uma extensão de personalização no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte [Site do Kickfire](https://www.kickfire.com/).
...
Para instalar o [!DNL KickFire] extensão:
