...
Após configurar o [Extensão de tag do SDK da Web da Adobe Experience Platform](web-sdk-extension-configuration.md), configure seus tipos de ação.
...
Depois de definir suas ações, [configurar os tipos de elementos de dados](data-element-types.md).
