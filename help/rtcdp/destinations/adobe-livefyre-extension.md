...
description: A extensão do Adobe Livefyre é um destino social na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão Adobe Livefyre {#bing-ads-extension}
...
O Adobe Livefyre é uma extensão social da Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100464.html).
...
Para instalar a extensão do Adobe Livefyre:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte a página do [Adobe Livefyre no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100464.html).
