...
Uma resposta bem-sucedida retorna um `response` matriz que contém um `feature_value` e `feature_name` para cada uma das imagens visualmente semelhantes encontradas no catálogo.
