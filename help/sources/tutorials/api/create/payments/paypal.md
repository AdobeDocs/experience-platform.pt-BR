---
keywords: Experience Platform;home;popular topics;Conector PayPal;paypal;Paypal
solution: Experience Platform
title: Criar uma conexão de origem PayPal usando a API de serviço de fluxo
topic: overview
type: Tutorial
description: Saiba como conectar o PayPal à Adobe Experience Platform usando a API de Serviço de Fluxo.
...
# Criar uma conexão de origem [!DNL PayPal] usando a API [!DNL Flow Service]
