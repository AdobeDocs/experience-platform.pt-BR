...
topic: overview
description: Este tutorial fornece etapas para a criação de um conector de origem IBM DB2 (a seguir denominado "DB2") usando a interface do usuário da plataforma.
