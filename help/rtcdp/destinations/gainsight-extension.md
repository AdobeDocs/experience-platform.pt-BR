...
description: A extensão Gainsight é um destino de personalização na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão Gainsight é um destino de personalização na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão de gansight {#gainsight-extension}

## Visão geral {#overview}

O Gainsight capacita os proprietários de produtos com as ferramentas para entender profundamente o comportamento do usuário, impulsionar a adoção de produtos e coletar feedback dos usuários.

O Gainsight é uma extensão de personalização na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.103343.html).
...
Para instalar a extensão Gainsight:
