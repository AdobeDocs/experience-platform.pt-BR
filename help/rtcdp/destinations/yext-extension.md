...
description: A extensão de Rastreamento de conversão de saída é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão do Rastreamento de conversão de texto é um destino analítico na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão de Rastreamento de Conversão de Texto {#yext-extension}

## Visão geral {#overview}

A Extensão de rastreamento de conversão de texto permite medir conversões que podem ser atribuídas ao uso de produtos de texto.

O Rastreamento de conversão de texto é uma extensão de análise na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
...
Para instalar a extensão de rastreamento de conversão do Yext:
