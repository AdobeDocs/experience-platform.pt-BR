...
title: Criar uma conexão de origem HubSpot usando a API de Serviço de Fluxo
topic: overview
type: Tutorial
description: Saiba como conectar o Adobe Experience Platform ao HubSpot usando a API de Serviço de Fluxo.
...
# Criar uma conexão de origem [!DNL HubSpot] usando a API [!DNL Flow Service]
