...
- **Atribuição de funil completo**: entenda o impacto do marketing em toda a jornada do cliente. Por exemplo, assinatura de conta gratuita para conversão paga e muito além.
- **Avaliações de parceiros**: avalie a eficácia de agências e parceiros, com base nos resultados da atribuição.

### Recursos adicionais

A Attribution AI também oferece integração com outras soluções de Adobe, como o [!DNL Customer Journey Analytics]. Isso permite usar essas soluções para utilizar o modelo algorítmico personalizável a fim de avaliar o desempenho da mídia e fornecer insights analíticos.

## Próximas etapas

Você pode começar seguindo o guia de [introdução](./getting-started.md). Este guia orienta você na configuração de todas as pré-solicitações necessárias para o Attribution AI. Se você já tiver suas credenciais e seus dados prontos, visite o [guia do usuário do Attribution AI](./user-guide.md). Este guia orienta você na criação de uma instância e no envio para treinamento e pontuação.
