...
| m_browser_height | ambiente.browserDetails.viewportHeight | integer | A altura do navegador, em pixels. |
| m_browser_width | ambiente.browserDetails.viewportWidth | integer | A largura do navegador, em pixels. |
...
| m_domain | ambiente.domain | string | A variável usada na dimensão Domínio. Isso se baseará no provedor de serviço da Internet do usuário (ISP). |
...
| accept_language | ambiente.browserDetails.acceptLanguage | string | Lista todos os idiomas aceitos, conforme indicado no cabeçalho HTTP Accept-Language. |
...
| j_jscript | ambiente.browserDetails.javaScriptVersion | string | A versão do JavaScript suportada pelo navegador. |
| user_agent | ambiente.browserDetails.userAgent | string | A string do agente do usuário enviada no cabeçalho HTTP. |
...
| pointofinterest | placeContext.POIintervention.POIDetail.</span>name | string | Usada pelos serviços móveis. Representa o ponto de interesse. |
| pointofinterestdistance | placeContext.POIintervention.POIDetail.geoInteractionDetails.distanceToCenter | número | Usada pelos serviços móveis. Representa a distância do ponto de interesse. |
| mobileplaceaccuracy | placeContext.POIintervention.POIDetail.geoInteractionDetails.deviceGeoAccuracy | número | Coletada da variável de dados de contexto a.loc.acc. Indica a precisão do GPS em metros no momento da coleta. |
...
| mobileplaceentry | placeContext.POIintervention.poiEntries | Objeto | <!-- MISSING --> | {id (cadeia), valor (número)} |
| mobileplaceexit | placeContext.POIintervention.poiExits | Objeto | <!-- MISSING --> | {id (cadeia), valor (número)} |
| videotime | media.mediaTimed.timePlayed | Objeto | <!-- MISSING --> | {id (cadeia), valor (número)} |
| videostart | media.mediaTimed.impressões | Objeto | <!-- MISSING --> | {id (cadeia), valor (número)} |
| videocomplete | media.mediaTimed.complete | Objeto | <!-- MISSING --> | {id (cadeia), valor (número)} |
| videosegmentviews | media.mediaTimed.mediaSegmentViews | Objeto | <!-- MISSING --> | {id (cadeia), valor (número)} |
| videoadstart | publicidades.impressões | Objeto | <!-- MISSING --> | {id (cadeia), valor (número)} |
| videoadcomplete | publish.complete | Objeto | <!-- MISSING --> | {id (cadeia), valor (número)} |
| videoadtime | publish.timePlayed | Objeto | <!-- MISSING --> | {id (cadeia), valor (número)} |
| videochapterstart | media.mediaTimed.mediaChapter.impressões | Objeto | <!-- MISSING --> | {id (cadeia), valor (número)} |
| videochaptercomplete | media.mediaTimed.mediaChapter.complete | Objeto | <!-- MISSING --> | {id (cadeia), valor (número)} |
| videochaptertime | media.mediaTimed.mediaChapter.timePlayed | Objeto | <!-- MISSING --> | {id (cadeia), valor (número)} |
| videoplay | media.mediaTimed.start | Objeto | <!-- MISSING --> | {id (cadeia), valor (número)} |
...
| videoresume | media.mediaTimed.resume | Objeto | <!-- MISSING --> | {id (cadeia), valor (número)} |
...
| m_cookies | ambiente.browserDetails.cookiesEnabled | booleano | Uma variável usada na dimensão Suporte a cookies. |
...
| m_java_enabled | ambiente.browserDetails.javaEnabled | booleano | Um sinalizador que indica se o Java está ativado. |
