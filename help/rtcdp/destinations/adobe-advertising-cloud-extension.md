...
description: A extensão Adobe Advertising Cloud é um destino publicitário no Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
A Adobe Advertising Cloud é uma extensão de anúncio no Adobe Real-time Customer Data Platform.
