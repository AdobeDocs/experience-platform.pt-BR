...
A autenticação é necessária para fazer chamadas para [!DNL Adobe Experience Platform]e é composto por Chave da API, ID da organização, um token de usuário e um token de serviço.
...
>[!NOTE]
>
>A organização é definida na variável `client_context`.
