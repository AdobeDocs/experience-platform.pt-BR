...
Para instalar o [!DNL Nielsen BSDK] extensão:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte [Página do BSDK Nielsen no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101361.html).
