---
keywords: Confirmar feedback digital;confirmar extensão;confirmar;Confirmit
title: Confirmar extensão do Feedback digital
description: A extensão Confirmar feedback digital é uma Voz do destino do Cliente na Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do [!DNL Confirmit Digital Feedback]

## Visão geral {#overview}

A solução [!DNL Confirmit Digital Feedback] ajuda a transformar o tráfego do site em insights em tempo real. Com o [!DNL Confirmit], pesquisas não invasivas e altamente direcionadas podem ser exibidas de acordo com suas necessidades, incentivando os visitantes a fornecer feedback, por exemplo:

* Feedback do site
* Satisfação da transação
* Motivo da intenção de saída
* Informações de abandono do carrinho
* Satisfação geral do cliente
* E muito mais

O Feedback Digital do [!DNL Confirmit] é uma Voz da extensão do Cliente na Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
...
![Confirmar extensão do Feedback Digital](../../assets/catalog/voice/confirmit-digital-feedback/catalog.png)
...
Para instalar a extensão de Feedback Digital do [!DNL Confirmit]:
...
Para obter informações sobre as opções de configuração de extensão e suporte à instalação, consulte a [página Confirmar feedback digital no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
