---
keywords: extensão do demandbase, demandbase, destino demandbase
title: Extensão do Demandbase
description: A extensão Demandbase é um destino de análise no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
Obtenha [!DNL Demandbase] insights da conta B2B diretamente no Adobe Analytics, onde você pode segmentar o tráfego e o comportamento pelo Setor, Receita e suas contas de destino. Essa exibição baseada em conta fornece insights únicos sobre engajamento, conversão e a fonte de seus visitantes mais valiosos.
