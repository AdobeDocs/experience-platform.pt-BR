...
>[!IMPORTANT]
>
>A extensão gtag do Google descrita aqui foi substituída pela extensão [[!DNL Google Global Site Tag (gtag)]](https://exchange.adobe.com/apps/ec/101437/google-global-site-tag-gtag) desenvolvida por [!DNL Acronym]. Você pode encontrar a extensão [!DNL Google Global Site Tag (gtag)] no espaço de trabalho [[!UICONTROL Tags]](../../../tags/home.md) na interface da Coleção de Dados ou na interface do Experience Platform.
...
O Google gtag é uma extensão de publicidade em [!DNL Adobe Experience Platform]. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.102805.google-gtag.html).
