...
A variável [!DNL Quantum Metric] a extensão de tag facilita a implantação sem código do [!DNL Quantum Metric's] recursos de coleção de dados. Além disso, essa extensão oferece a capacidade de capturar elementos de dados que contêm informações úteis do [!DNL Quantum Metric] API.
...
Para instalar o [!DNL Quantum Metric] extensão:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte [Página Métrica Quantum no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101535.quantum-metric-extension-for-adobe-launch.html).
