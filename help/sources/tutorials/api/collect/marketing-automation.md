...
Este tutorial aborda as etapas para recuperar dados de um sistema de automação de marketing de terceiros e assimilá-los na plataforma por meio de conectores de origem e da [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
