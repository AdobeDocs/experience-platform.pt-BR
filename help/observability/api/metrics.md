...
| timeseries.identity.graph.imsorg.uniqueidentities.count | Número de identidades exclusivas armazenadas no gráfico de identidade da sua organização. | N/D |
...
| timeseries.identity.graph.imsorg.graphstrength.uniqueidentities.count | Número de identidades exclusivas armazenadas no gráfico de identidade de sua organização para uma intensidade de gráfico específica (&quot;desconhecido&quot;, &quot;fraco&quot; ou &quot;forte&quot;). | Intensidade do gráfico (**Obrigatório**) |
...
| `INSGHT-1003-401` | Erro de validação da sandbox | Não foi possível processar a solicitação devido a um erro de validação de sandbox. Certifique-se de que o nome da sandbox que você forneceu no `x-sandbox-name` representa uma sandbox válida e ativada para sua organização antes de tentar a solicitação novamente. |
