...
> [!NOTE]
> O conector MySQL está em beta. Os recursos e a documentação estão sujeitos a alterações.
...
Depois de coletar as credenciais necessárias, você pode seguir as etapas abaixo para criar uma nova conexão básica de entrada para vincular sua conta MySQL à Plataforma.
