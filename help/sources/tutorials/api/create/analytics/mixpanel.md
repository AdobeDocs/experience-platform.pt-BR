---
title: Criar uma conexão de origem e um fluxo de dados para Mixpanel usando a API do serviço de fluxo
...
# Criar uma conexão de origem e um fluxo de dados para [!DNL Mixpanel] usando o [!DNL Flow Service] API
