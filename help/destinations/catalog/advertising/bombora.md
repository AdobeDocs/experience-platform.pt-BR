...
>[!AVAILABILITY]
>
>A funcionalidade para ativar públicos-alvo da conta para o destino Bombora ABM Audiences está disponível para empresas que compram as edições [Business-to-Business](/help/rtcdp/overview.md#rtcdp-b2b) e [Business-to-Person](/help/rtcdp/overview.md#rtcdp-b2p) de [!DNL Real-Time Customer Data Platform].
...
Para ajudá-lo a entender melhor como e quando você deve usar o destino Bombora, veja a seguir exemplos de casos de uso que [!DNL Adobe Experience Platform] clientes podem resolver usando esse destino.
