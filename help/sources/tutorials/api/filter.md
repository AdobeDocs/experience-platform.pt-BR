...
>[!IMPORTANT]
>
>No momento, o suporte para filtrar dados em nível de linha para uma fonte está disponível somente para a variável [[!DNL Google BigQuery]](../../connectors/databases/bigquery.md) e [[!DNL Snowflake]](../../connectors/databases/snowflake.md) fontes.
