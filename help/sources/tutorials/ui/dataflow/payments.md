...
Depois de criar sua conta de pagamentos, a etapa **[!UICONTROL Select data]** é exibida, fornecendo uma interface interativa para explorar sua hierarquia de arquivos.
