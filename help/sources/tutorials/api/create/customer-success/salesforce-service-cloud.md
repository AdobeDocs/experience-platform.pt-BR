---
title: Criar uma conexão do Salesforce Service Cloud Source usando a API do Flow Service
...
Para criar uma ID de conexão base, faça uma solicitação POST para o ponto de extremidade `/connections` enquanto fornece suas credenciais de autenticação [!DNL Salesforce Service Cloud] como parte dos parâmetros de solicitação.
