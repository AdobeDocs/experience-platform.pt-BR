...
Obter [!DNL Demandbase] Os insights da conta B2B diretamente no Adobe Analytics, onde você pode segmentar o tráfego e o comportamento por setor, receita e suas contas de destino. Essa visualização baseada em conta fornece insights exclusivos sobre engajamento, conversão e a fonte para seus visitantes mais valiosos.

[!DNL Demandbase] é uma extensão do analytics no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão em [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101605.html).
...
Para instalar o [!DNL Demandbase] extensão:
...
Para obter informações sobre as opções de configuração de extensão, consulte [Página de extensão do Demandbase](https://exchange.adobe.com/experiencecloud.details.101605.html) no Adobe Exchange.
