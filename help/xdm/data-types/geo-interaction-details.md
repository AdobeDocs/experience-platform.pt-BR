...
# [!UICONTROL Detalhes da interação geográfica] tipo de dados

[!UICONTROL Detalhes da interação geográfica] é um tipo de dados XDM padrão que descreve o estado atual da inclusão em uma área definida geograficamente.
