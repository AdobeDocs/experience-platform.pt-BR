...
O `COPY` despeja a saída de qualquer `SELECT` consulta a um local especificado. O usuário deve ter acesso a esse local para que esse comando seja bem-sucedido.
