...
title: Atualizar uma especificação de conexão usando a API do Serviço de Fluxo (Beta)
...
# Atualizar uma especificação de conexão usando a API do Serviço de Fluxo (Beta)
