...
>[!IMPORTANT]
>
>No momento, esse destino está na versão beta e só está disponível para um número limitado de clientes. Para solicitar acesso à [!DNL Google Ad Manager 360] conexão, entre em contato com o representante da Adobe e forneça [!DNL IMS Organization ID].
...
| `metadata.segment.alias` -> `list_id` | Mapeia nomes de segmento do Experience Platform para IDs de segmento na plataforma do Google. |
