---
keywords: D&B Visitor Intelligence;D&B;extensão de inteligência do visitante
...
[!DNL D&B Visitor Intelligence] é uma extensão de personalização no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte o [site da D&amp;B](https://www.dnb.com/).
...
![Extensão de Inteligência de Visitantes D&amp;B](../../assets/catalog/personalization/dnb/catalog.png)
