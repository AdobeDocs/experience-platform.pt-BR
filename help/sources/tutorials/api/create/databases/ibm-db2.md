...
Este tutorial usa a API [!DNL Flow Service] para guiá-lo pelas etapas para conectar o IBM DB2 (a seguir denominado &quot;DB2&quot;) a [!DNL Experience Platform].
...
Ao seguir este tutorial, você criou uma conexão IBM DB2 usando a API [!DNL Flow Service] e obteve o valor de ID exclusivo da conexão. Você pode usar essa ID no próximo tutorial à medida que aprende a [explorar bancos de dados usando a API de Serviço de Fluxo](../../explore/database-nosql.md).
