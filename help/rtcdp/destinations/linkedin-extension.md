...
description: A extensão da tag do LinkedIn Insight é um destino publicitário na plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão da tag do LinkedIn Insight é um destino publicitário na plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão de tag do LinkedIn Insight {#linkedin-insights-extension}

## Visão geral {#overview}

Instale a tag do LinkedIn Insight para usar os recursos demográficos de rastreamento de conversão, redefinição de metas e site.

A tag do LinkedIn Insight é uma extensão de publicidade na plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte Tag [do](https://business.linkedin.com/marketing-solutions/insight-tag)LinkedIn Insight.
...
![Extensão de tag do LinkedIn Insight](assets/linkedin-extension.png)
...
Para instalar a extensão da tag do LinkedIn Insight:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte Tag [do](https://business.linkedin.com/marketing-solutions/insight-tag)LinkedIn Insight.
