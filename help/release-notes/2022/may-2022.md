...
| Recurso | Descrição |
| --- | --- |
| Expirações do conjunto de dados | [Agendar expirações](../../hygiene/ui/dataset-expiration.md) para conjuntos de dados da plataforma. |
