...
type: Tutorial
description: Um fluxo de dados é uma tarefa agendada que recupera e assimila dados de uma origem para um conjunto de dados do Experience Platform. Este tutorial fornece etapas sobre como criar um fluxo de dados para uma origem de pagamentos usando a interface do usuário do Experience Platform.
...
Um fluxo de dados é uma tarefa agendada que recupera e assimila dados de uma origem para um conjunto de dados na Adobe Experience Platform. Este tutorial fornece etapas sobre como criar um fluxo de dados para uma origem de pagamentos usando a interface do Experience Platform.
...
Ao seguir este tutorial, você criou com êxito um fluxo de dados para trazer dados da sua fonte de pagamentos para a Experience Platform. Os dados de entrada agora podem ser usados por serviços [!DNL Experience Platform] downstream, como [!DNL Real-Time Customer Profile] e [!DNL Data Science Workspace]. Consulte os seguintes documentos para obter mais detalhes:
