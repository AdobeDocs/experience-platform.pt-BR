...
description: A extensão das Marcas Invoca é uma voz do destino do cliente na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão Tags Invoca {#invoca-extension}

## Visão geral {#overview}

A Invoca os dados das chamadas e insights de voz na jornada do cliente digital. Com a plataforma de inteligência de chamada da Invoca, os profissionais de marketing finalmente têm análises para medir resultados de chamadas e vincular as conversões offline de volta ao gasto digital.

A Invoca Tags é uma voz da extensão do cliente na Adobe Real-time Customer Data Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100067.invoca.html).
...
Para instalar a extensão Invoca Tags:
