...
Configurar [!DNL ForeSee] implantações de produtos usando tags.
...
![Fechar extensão](../../assets/catalog/survey/foresee/catalog.png)
...
Para instalar o [!DNL Foresee] extensão:
...
Para obter informações sobre as opções de configuração de extensão, consulte [Fechar página de extensão](https://exchange.adobe.com/experiencecloud.details.100164.html) no Adobe Exchange.
