---
keywords: Rastreamento de conversão de Yext;Yext;yext;rastreamento de conversão de yext
title: Extensão de rastreamento de conversão do Yext
description: A extensão de rastreamento de conversão do Yext é um destino de análise no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
A variável [!DNL Yext Conversion Tracking] A extensão permite medir conversões que podem ser atribuídas ao uso de produtos Yext.

[!DNL Yext Conversion Tracking] é uma extensão do analytics no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão em [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
...
![Extensão de rastreamento de conversão do Yext](../../assets/catalog/analytics/yext/catalog.png)
...
Para instalar o [!DNL Yext Conversion Tracking] extensão:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte [Página de rastreamento de conversão de Yext no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103174.yext-conversion-tracking.html).
