...
title: Extensão de tag do LinkedIn Insight
description: A extensão Insight Tag do LinkedIn é um destino de publicidade na Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do [!DNL LinkedIn Insight Tag] {#linkedin-insights-extension}

## Visão geral {#overview}

Instale o [!DNL LinkedIn Insight Tag] para usar os recursos de rastreamento de conversão, redirecionamento e demografia de sites.

[!DNL LinkedIn Insight Tag] é uma extensão de publicidade em [!DNL Adobe Experience Platform]. Para obter mais informações sobre a funcionalidade de extensão, consulte [Marca Insight do LinkedIn](https://business.linkedin.com/marketing-solutions/insight-tag).
...
![Extensão da Marca Insight do LinkedIn](../../assets/catalog/advertising/linkedin/catalog.png)
...
Para instalar a extensão [!DNL LinkedIn Insight Tag]:
...
Para obter informações sobre as opções de configuração de extensão e suporte à instalação, consulte [Marca do LinkedIn Insight](https://business.linkedin.com/marketing-solutions/insight-tag).
