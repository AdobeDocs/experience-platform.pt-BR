...
* Cada opção de formatação de arquivo disponível é documentada em comprimento no [configuração de formatação de arquivo](../../functionality/destination-server/file-formatting.md) seção.
* Complete as etapas para [configurar um destino baseado em arquivo](../../guides/configure-file-based-destination-instructions.md) usando o Destination SDK.
...
![Gravação de tela mostrando várias opções de formatação de arquivo para arquivos em lote.](../../assets/guides/batch/file-formatting-options.gif)
...
![Imagem que mostra a ordem das opções de formatação de arquivo na interface do usuário do Experience Platform.](../../assets/guides/batch/file-formatting-order.png)
...
![Imagem que mostra o agrupamento de opções CSV na interface do usuário.](../../assets/guides/batch/file-formatting-grouping.png)
