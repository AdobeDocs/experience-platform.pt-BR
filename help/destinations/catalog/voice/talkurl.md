---
keywords: Caixa de entrada do URL Talk;caixa de entrada do URL talk;caixa de entrada do URL Talk;caixa de entrada do URL talk;URL talk;URL Talk;URL Talk
title: Extensão da Caixa de entrada do Talk URL
description: A extensão Caixa de entrada de URL do Talk é uma voz do destino do cliente no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do [!DNL Talk URL Inbox] {#talk-url-extension}

Receba mensagens de voz dos visitantes da sua página da Web. Inclui interface hospedada e aprendizado de máquina baseado em nuvem para transcrever suas mensagens de voz em insights de texto instantaneamente.

[!DNL Talk URL Inbox] é uma voz da extensão do cliente em [!DNL Adobe Experience Platform]. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html).
...
![Extensão da Caixa de Entrada do URL do Talk](../../assets/catalog/voice/talkurl/catalog.png)
...
Para instalar a extensão [!DNL Talk URL Inbox]:
...
Para obter informações sobre as opções de configuração de extensão e suporte à instalação, consulte a página [Caixa de Entrada de URL do Talk no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100583.html).
