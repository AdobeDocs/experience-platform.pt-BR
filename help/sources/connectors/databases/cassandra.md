...
[!DNL Experience Platform] fornece suporte para assimilar dados de um banco de dados de terceiros. [!DNL Platform] pode se conectar a diferentes tipos de bancos de dados, como relacional, NoSQL ou datas warehouses. O suporte para provedores de banco de dados inclui [!DNL Apache Cassandra].

A documentação abaixo fornece informações sobre como se conectar [!DNL Apache Cassandra] a [!DNL Platform] APIs:

## Conectar-se [!DNL Apache Cassandra] a [!DNL Platform] APIs

- [Crie um conector Apache Cassandra usando a API de Serviço de Fluxo](../../tutorials/api/create/databases/cassandra.md)
