...
![Instalar extensão Mailchimp](../../../images/extensions/server/mailchimp/install.png)
...
![Adicionar configuração de ação Evento](../../../images/extensions/server/mailchimp/action-configurations.png)
