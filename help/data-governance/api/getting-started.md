...
Todos os recursos em [!DNL Experience Platform], incluindo aqueles pertencentes à Governança de dados, estão isolados em sandboxes virtuais específicas. Todas as solicitações para [!DNL Platform] APIs exigem um cabeçalho que especifique o nome da sandbox em que a operação ocorrerá:
