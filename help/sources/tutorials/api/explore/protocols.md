...
# Explore um sistema de protocolo usando o [!DNL Flow Service] API
...
Este tutorial usa o [!DNL Flow Service] API para explorar aplicativos de protocolos.
...
Usando a ID de conexão para seu aplicativo de protocolos, você pode explorar suas tabelas de dados executando solicitações GET. Use a chamada a seguir para encontrar o caminho da tabela na qual você deseja inspecionar ou assimilar [!DNL Platform].
...
Uma resposta bem-sucedida retorna uma matriz de tabelas de seu aplicativo de protocolos. Encontre a tabela que deseja trazer [!DNL Platform] e toma nota da sua `path` , conforme você precisará fornecê-la na próxima etapa para inspecionar sua estrutura.
