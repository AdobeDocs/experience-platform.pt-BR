...
Para usar as Fontes de autoatendimento (SDK em lote), você deve garantir que tenha acesso a uma sandbox de organização provisionada com as Fontes Adobe Experience Platform.
