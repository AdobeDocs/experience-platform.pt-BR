...
Além disso, este tutorial requer que você já tenha criado uma conta de pagamentos. Uma lista de tutoriais para criar diferentes conectores de pagamento na interface do usuário pode ser encontrada no [visão geral dos conectores de origem](../../../home.md).

## Selecionar dados

Depois de criar sua conta de pagamentos, a **[!UICONTROL Selecionar dados]** será exibida, fornecendo uma interface interativa para explorar sua hierarquia de arquivos.
