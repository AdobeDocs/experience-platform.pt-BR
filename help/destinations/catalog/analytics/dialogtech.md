---
keywords: extensão dialogtech, dialogtech, dialog tech destination, DialogTech, DialogTech, DialogTech SourceTrak
...
Inclua o trecho [!DNL DialogTech SourceTrak] do javascript no Adobe Launch

[!DNL DialogTech] é uma extensão do analytics no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte o [site da Dialog tech](https://www.dialogtech.com/).
