...
Este tutorial o orienta pelas etapas para criar uma conexão básica para [!DNL Azure Data Explore] usando a [[!DNL Flow Service] API](https://www.adobe.io/experience-platform-apis/references/flow-service/).
