...
A documentação abaixo fornece informações sobre como conectar o [!DNL PayPal] ao Experience Platform usando APIs ou a interface do usuário:

## Conectar o [!DNL PayPal] ao Experience Platform usando APIs
...
## Conectar o [!DNL PayPal] ao Experience Platform usando a interface
