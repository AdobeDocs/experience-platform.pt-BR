...
| Exploração de dados | Acesso fácil aos dados XDM assimilados em [!DNL Platform] integrados ao SDK [!DNL Platform Data Access]. |
...
| Pontuação em lote | Enriquecer [!DNL Real-Time Customer Profile] com insights de aprendizado de máquina ou gravá-los como conjuntos de dados de volta em [!DNL Platform] |
| Agendando | Integrado ao Serviço de Orquestração do [!DNL Platform] para automatizar o treinamento do modelo, a pontuação e os pipelines de recursos com cronogramas definidos pelo usuário por meio de APIs. |
...
* Não é possível estender um grupo de campos fornecido por [!DNL Platform] adicionando um campo.
