...
>abstract="A visualização Processamento de identidade contém informações sobre registros assimilados no Serviço de identidade, incluindo o número de identidades adicionadas, os gráficos criados e os gráficos atualizados. Consulte o guia de definição de métrica para saber mais sobre métricas e gráficos."
>text="Learn more in documentation"

>[!CONTEXTUALHELP]
>id="platform_monitoring_dataflow_run_details_identity"
>title="Detalhes da execução do fluxo de dados"
>abstract="A página Detalhes da execução do fluxo de dados exibe mais informações sobre a execução do fluxo de dados de identidade, incluindo a ID da organização e a ID de execução do fluxo de dados."
