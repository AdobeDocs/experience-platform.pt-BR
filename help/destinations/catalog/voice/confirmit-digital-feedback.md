---
keywords: Confirmar comentários digitais; confirmar extensão; confirmar
title: Confirmar extensão de Feedback digital
description: A extensão Confirmar comentários digitais é uma voz do destino do cliente no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
![Confirmar extensão de Feedback digital](../../assets/catalog/voice/confirmit-digital-feedback/catalog.png)
