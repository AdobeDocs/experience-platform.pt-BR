...
>abstract="Este widget exibe o número total de perfis mesclados dentro do segmento selecionado. Esse número depende da política de mesclagem aplicada aos seus dados e está correto no momento do instantâneo mais recente."
...
>abstract="Este widget fornece informações sobre o número total de perfis que atendem aos critérios de **qualquer** definição de segmento, conforme capturada durante o instantâneo diário, para os últimos 30 dias, 90 dias ou 12 meses."
...
>abstract="Este widget mostra a sobreposição de perfis no seu segmento que contém as identidades escolhidas. Os círculos exibem o tamanho relativo de cada identidade. O número de perfis que contêm ambos os namespaces é representado pela sobreposição entre os círculos."
