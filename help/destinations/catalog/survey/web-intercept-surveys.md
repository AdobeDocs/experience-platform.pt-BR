...
[!DNL QuestionPro Intercept Surveys] O é uma plataforma para implantar pesquisas e coletar dados de atitude no ponto de transação ou quando os usuários entram/saem do site.
...
Para instalar o [!DNL QuestionPro Intercept Surveys] extensão:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte [Página de Pesquisas de Interceptação QuestionPro no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.90096.questionpro-surveys.html).
