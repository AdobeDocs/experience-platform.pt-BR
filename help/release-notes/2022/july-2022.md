...
| Grupo de campos | [[!UICONTROL Clima atual]](https://github.com/adobe/xdm/blob/master/components/classes/weather.schema.json) | Um grupo de campos para o [!UICONTROL XDM ExperienceEvent] e [!UICONTROL Clima] classes, usadas para capturar as condições meteorológicas atuais de um código postal. |
