...
![Conectar-se à adobe campanha](./assets/adobe-campaign/catalog.png)
...
![Configurar o assistente de Campanhas](./assets/adobe-campaign/connection-type.png)
...
![Preencher informações de Campanha](./assets/adobe-campaign/account-info.png)
...
- **[!UICONTROL Formato]** de arquivo: **CSV** ou Delimitado por **tabulação**. Selecione o formato de arquivo a ser exportado para o local do armazenamento.

![Informações básicas sobre campanhas](./assets/adobe-campaign/basic-information.png)

Clique em **[!UICONTROL Criar]** após preencher os campos acima. Seu destino agora está conectado e você pode [ativar segmentos](./activate-destinations.md) no destino.

## Ativar segmentos {#activate-segments}

Consulte [Ativar perfis e segmentos em um destino](./activate-destinations.md) para obter informações sobre o fluxo de trabalho da ativação de segmentos.

## Atributos de destino {#destination-attributes}

Ao [ativar segmentos](./activate-destinations.md) no destino Adobe Campaign, recomendamos que você selecione um identificador exclusivo do schema [da](../../profile/home.md#profile-fragments-and-union-schemas)união. Selecione o identificador exclusivo e quaisquer outros campos XDM que você deseja exportar para o destino. Para obter mais informações, consulte [Selecionar quais campos de schema usar como atributos de destino em seus arquivos](./email-marketing-destinations.md#destination-attributes) exportados na documentação de destinos de marketing de email.

## Dados exportados {#exported-data}

Para [!DNL Adobe Campaign] destinos, o CDP Adobe em tempo real cria um arquivo delimitado por tabulação `.txt` ou `.csv` no local do armazenamento fornecido. Para obter mais informações sobre os arquivos, consulte Destinos de marketing de [email e destinos](./activate-destinations.md#esp-and-cloud-storage) de armazenamentos da Cloud no tutorial de ativação de segmentos.
