...
| Atualização do [[!DNL Amazon S3] ](../../destinations/catalog/cloud-storage/amazon-s3.md#changelog) | Atualização dos pacotes | Com essa atualização, o destino oferece funcionalidade aprimorada de exportação de arquivos e suporte [!BADGE Beta]Exportações de conjunto de dados {type=Informative}. |
| Atualização do [[!DNL Azure Blob] ](../../destinations/catalog/cloud-storage/azure-blob.md#changelog) | Atualização dos pacotes | Com essa atualização, o destino oferece funcionalidade aprimorada de exportação de arquivos e suporte [!BADGE Beta]Exportações de conjunto de dados {type=Informative}. |
...
| Recurso | Descrição |
| --- | --- |
| [!BADGE Beta]{type=Informativo} [!DNL SAP Commerce] | Agora você pode usar a origem do [[!DNL SAP Commerce] ](../../sources/connectors/ecommerce/sap-commerce.md) para trazer os dados de faturamento de assinatura da sua conta do [!DNL SAP Commerce] para a Experience Platform. |
