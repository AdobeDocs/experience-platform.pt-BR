...
Com base nas transformações de schema descritas acima, veja como a estrutura de uma mensagem muda entre o schema XDM de origem e um schema de amostra no lado do parceiro:
