...
As classificações permitem que os dados de variáveis do Analytics sejam categorizados e exibidos de maneiras diferentes quando os relatórios são gerados. O Conector de dados de classificações do Analytics requer que os dados tenham sido migrados para o novo [!DNL Classifications] infraestrutura do Adobe Analytics antes do uso. Para confirmar o status da migração de seus dados, entre em contato com o Gerente de sucesso do cliente do Adobe.
