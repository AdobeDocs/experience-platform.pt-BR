---
keywords: extensão do Google ads;google ads;extensão do google ads;extensão do Google Ads
title: Extensão do Google Ads
description: A extensão Google Ads é um destino de publicidade na Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
Essa extensão rastreia conversões de usuários que clicam em seu [!DNL Google Ads]. Será necessário também instalar a extensão gtag.js e adicioná-la à biblioteca, como [!DNL Google Ads] depende disso.

[!DNL Google Ads] O é uma extensão publicitária no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão em [Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html).
...
Para instalar o [!DNL Google Ads] extensão:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte [Página de anúncios do Google no Adobe Exchange](https://www.adobeexchange.com/experiencecloud.details.101383.google-ads.html).
