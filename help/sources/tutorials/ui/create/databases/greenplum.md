...
Na categoria *[!UICONTROL Bancos]* de dados, selecione **[!UICONTROL GreenPlum]** seguido por **[!UICONTROL Adicionar dados]** para criar um novo [!DNL GreenPlum] conector.
...
Ao seguir este tutorial, você estabeleceu uma conexão com sua [!DNL GreenPlum] conta. Agora você pode continuar com o próximo tutorial e [configurar um fluxo de dados para trazer dados para a Plataforma](../../dataflow/databases.md).