...
Selecione **[!DNL Snowflake]** na categoria *[!UICONTROL Databases]* e selecione **[!UICONTROL Set up]**.
...
Para usar uma conta existente, selecione a conta [!DNL Snowflake] à qual deseja se conectar e selecione **[!UICONTROL Next]** para continuar.
...
Para criar uma nova conta, selecione **[!UICONTROL New account]** e forneça um nome e, opcionalmente, adicione uma descrição para sua conta.

### Conectar-se ao Experience Platform no Azure {#azure}

Você pode conectar sua conta do [!DNL Snowflake] ao Experience Platform no Azure com autenticação de par de chaves.

Para usar a autenticação de par de chaves, selecione **[!UICONTROL KeyPair authentication]**, forneça valores para sua conta, nome de usuário, chave privada, senha de chave privada, banco de dados e warehouse e selecione **[!UICONTROL Connect to source]**.

![A interface de autenticação de par de chaves da conta.](../../../../images/tutorials/create/snowflake/new.png)
...
Para se conectar usando pares de chaves, selecione **[!UICONTROL KeyPair Authentication]**, forneça suas credenciais de autenticação e selecione **[!UICONTROL Connect to source]**. Para obter mais informações sobre essas credenciais, leia a [[!DNL Snowflake] visão geral do lote](../../../../connectors/databases/snowflake.md#gather-required-credentials).
...
Para conectar usando uma combinação de nome de usuário e senha, selecione **[!UICONTROL Basic authentication]**, forneça suas credenciais de autenticação e selecione **[!UICONTROL Connect to source]**. Para obter mais informações sobre essas credenciais, leia a [[!DNL Snowflake] visão geral do lote](../../../../connectors/databases/snowflake.md#gather-required-credentials).
