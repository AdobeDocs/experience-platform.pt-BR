...
title: Marcação de palavra-chave na API da IA de marcação de conteúdo
...
A tabela a seguir lista as entidades nomeadas que [!DNL Content Tagging AI] identificou:
