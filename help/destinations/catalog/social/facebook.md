...
>title="ID da Conta"
>abstract="Sua ID da conta do Facebook Ad. Você pode encontrar essa ID em sua conta do Facebook Ads Manager. Ao inserir essa ID, sempre adicione como prefixo `act_`."

Para configurar detalhes para o destino, preencha os campos obrigatórios e opcionais abaixo. Um asterisco ao lado de um campo na interface do usuário indica que o campo é obrigatório.

* **[!UICONTROL Nome]**: um nome pelo qual você reconhecerá esse destino no futuro.
* **[!UICONTROL Descrição]**: uma descrição que ajudará você a identificar esse destino no futuro.
* **[!UICONTROL ID da conta]**: Seu [!DNL Facebook Ad Account ID]. Você pode encontrar essa ID em seu [!DNL Facebook Ads Manager] conta. Ao inserir essa ID, sempre adicione como prefixo `act_`.
...
>title="Origem do público"
>abstract="Os anunciantes coletaram dados diretamente dos parceiros deles."

>[!CONTEXTUALHELP]
>id="platform_destinations_activate_facebook_originofaudience_customersandpartners"
>title="Origem do público"
>abstract="Os anunciantes coletaram dados diretamente dos clientes e parceiros."
