...
title: Confirmar extensão de Comentários Digitais
seo-title: Confirmar extensão de Comentários Digitais
description: A extensão Confirmar feedback digital é uma voz do destino do Cliente na Plataforma de dados do cliente em tempo real. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão Confirmar feedback digital é uma voz do destino do Cliente na Plataforma de dados do cliente em tempo real. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
[!DNL Confirmit Digital Feedback] ajuda você a transformar o tráfego de seu site em insights em tempo real. Com pesquisas [!DNL Confirmit], discretas e altamente direcionadas podem ser exibidas de acordo com suas necessidades, incentivando os visitantes a fornecer feedback, como:
...
[!DNL Confirmit] Feedback digital é uma voz da extensão do cliente na Plataforma de dados do cliente em tempo real. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
...
![Confirmar extensão de Comentários Digitais](../../assets/catalog/voice/confirmit-digital-feedback/catalog.png)
...
Para instalar a extensão [!DNL Confirmit] Digital Feedback:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte a página [Confirmação de feedback digital no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.103247.confirmit-digital-feedback-for-adobe-launch.html).
