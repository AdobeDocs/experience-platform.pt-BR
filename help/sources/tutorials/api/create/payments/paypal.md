...
Para criar uma ID de conexão base, faça uma solicitação POST para o ponto de extremidade `/connections` ao fornecer suas credenciais de autenticação [!DNL PayPal] como parte dos parâmetros de solicitação.
...
* [Crie um fluxo de dados para trazer dados de pagamentos para a Experience Platform usando a API  [!DNL Flow Service] ](../../collect/payments.md)
