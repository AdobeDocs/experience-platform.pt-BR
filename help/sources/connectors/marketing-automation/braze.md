...
O Experience Platform oferece suporte para assimilação de dados de aplicativos de transmissão. O suporte para provedores de streaming inclui [!DNL Braze Currents].
...
Para enviar com êxito seus dados do [!DNL Braze Currents] para o Experience Platform, você precisa inserir as seguintes credenciais do Experience Platform no painel da interface do usuário do [!DNL Braze].
...
Para obter informações sobre como recuperar esses valores, leia o guia em [introdução às APIs do Experience Platform](../../../landing/api-authentication.md). Para obter informações sobre como usar o painel [!DNL Braze], leia o guia [!DNL Braze] sobre como [Navegar até as Atualizações](https://www.braze.com/docs/user_guide/data_and_analytics/braze_currents/setting_up_currents/#step-2-navigate-to-currents).

## Próximas etapas

Ao ler este documento, você concluiu a configuração de pré-requisito necessária para transmitir dados da sua conta do [!DNL Braze Currents] para a Experience Platform. Agora você pode prosseguir para o guia em [conectando [!DNL Braze Currents] ao Experience Platform usando a interface do usuário](../../tutorials/ui/create/marketing-automation/braze.md).
