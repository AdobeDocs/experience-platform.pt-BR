...
* **[!DNL Query Service]:**Use query SQL para recuperar dados do Adobe Experience Platform, como dados da solução Adobe, dados de clientes primários ou outros dados da Platform.
...
* **[!DNL Sources](Conexões):**{#sources}Coloque dados no Adobe Experience Platform de várias fontes, como aplicativos Adobe, armazenamentos baseados em nuvem, bancos de dados e muito mais.
