---
keywords: Flashtalk Extensions do OneTag; Flashtalk Extensão do OneTag; Destinos do Flashtalk OneTag; Flashtalk OneTag; flashtalk onetag; flashtalk
title: Extensão Flashtalk OneTag
...
A extensão [!DNL Flashtalking OneTag] do Experience Platform Launch facilita o atributo de ações do site para exibir, vídeo e atividades de anúncios móveis. Implante o [!DNL Flashtalking OneTag] nas propriedades da Web usando o Launch.

[!DNL Flashtalking OneTag] O é uma extensão de publicidade no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão em [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
...
Para obter informações sobre as opções de configuração de extensão e o suporte de instalação, consulte a página [Flashtalk OneTag no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
