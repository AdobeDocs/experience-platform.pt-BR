...
| `metrics.segmentProfileByStatusCounter` | A contagem de perfis para cada status. Os três status a seguir são suportados: <ul><li>&quot;realizado&quot; - o número de perfis qualificados para o segmento.</li><li>&quot;encerrado&quot; - O número de segmentos de perfil que não existem mais no segmento.</li></ul> |
