...
seo-title: Extensão PebblePost
description: A extensão PebblePost é um destino de email na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão PebblePost é um destino de email na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão PebblePost {#pebblepost-extension}

## Visão geral {#overview}

A solução Programmatic Direct Mail® da PebblePost ajuda os profissionais de marketing digital a conectarem o interesse online e a intenção de usar mídia tangível e offline que é convertida. Os profissionais de marketing podem aproveitar os segmentos de dados personalizados que criaram na Adobe para agora públicos alvos consumidores com uma impressão de mídia interna relevante e duradoura. Analise o desempenho em tempo real com base na atividade do caminho de resposta e nas conversões no site.

O PebblePost é uma extensão de email na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100315.programmatic-direct-mail.html).
...
![Extensão PebblePost](assets/pebblepost-extension.png)
...
Para instalar a extensão PebblePost:
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte a página [PebblePost no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100315.programmatic-direct-mail.html).
