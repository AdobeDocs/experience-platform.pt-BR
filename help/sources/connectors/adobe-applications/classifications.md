...
As classificações permitem que os dados de variáveis do Analytics sejam categorizados e exibidos de diferentes maneiras quando os relatórios são gerados. O Conector de dados de classificações do Analytics requer que seus dados tenham sido migrados para a nova [!DNL Classifications] infraestrutura da Adobe Analytics antes do uso. Para confirmar o status de migração de seus dados, entre em contato com o Gerente de sucesso do cliente do Adobe.
