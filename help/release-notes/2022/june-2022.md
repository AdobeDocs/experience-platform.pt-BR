...
| [Adobe Advertising DSP](../../destinations/catalog/advertising/adobe-advertising-dsp-connection.md) | O destino do Adobe Advertising [!DNL Demand-Side Platform] (DSP) permite compartilhar segmentos primários autenticados com anunciantes e usuários aprovados para ativação de campanha com o DSP. |
