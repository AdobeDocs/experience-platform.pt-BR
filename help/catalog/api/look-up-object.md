...
Se você souber o identificador exclusivo de um [!DNL Catalog] objeto específico, poderá executar uma solicitação de GET para visualização dos detalhes desse objeto.
