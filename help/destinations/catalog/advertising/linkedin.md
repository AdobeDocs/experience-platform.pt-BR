...
[!DNL LinkedIn Insight Tag] é uma extensão de publicidade no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte [Tag do LinkedIn Insight](https://business.linkedin.com/marketing-solutions/insight-tag).
...
Para obter informações sobre as opções de configuração de extensão e suporte de instalação, consulte [Tag do LinkedIn Insight](https://business.linkedin.com/marketing-solutions/insight-tag).
