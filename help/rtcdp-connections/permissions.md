...
description: Uma visão geral de alto nível de como gerenciar permissões e controlar o acesso a recursos nas conexões Real-time Customer Data Platform (RTCDP).
