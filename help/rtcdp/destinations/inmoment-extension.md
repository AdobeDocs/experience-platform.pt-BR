...
description: A extensão InMoment é um destino pesquisa na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão InMoment {#inmoment-extension}

## Visão geral {#overview}

A integração InMoment Launch permite que você ative de forma rápida e fácil o feedback on-line por meio do produto Digital Intercept. No aplicativo, as interceptações podem ser configuradas e gerenciadas pelo administrador da nuvem CXI, permitindo que os gerentes CX tenham mais controle sobre seus programas.

InMoment é uma extensão pesquisa na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.100847.html).
...
![Extensão de hora](/help/rtcdp/destinations/assets/inmoment-extension.png)
...
Para instalar a extensão InMoment:
...
Para obter informações sobre as opções de configuração de extensão, consulte a página [de extensão do](https://exchange.adobe.com/experiencecloud.details.100847.html) Google Universal Analytics no Adobe Exchange.
