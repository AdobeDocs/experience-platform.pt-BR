---
title: extensão DIL do Gerenciador de Audiências
seo-title: extensão DIL do Gerenciador de Audiências
description: A extensão DIL do Gerenciador de Audiências é um destino da Plataforma de Gestão de dados (DMP) na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
seo-description: A extensão DIL do Gerenciador de Audiências é um destino da Plataforma de Gestão de dados (DMP) na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# extensão DIL do Gerenciador de Audiências {#aam-dil-extension}

## Visão geral {#overview}

Esta é a extensão da Biblioteca de integração de dados do Adobe Audiência Manager (implementação no cliente). Observação: Essa extensão não deve ser usada para o encaminhamento pelo lado do servidor (SSF) dos dados do Adobe Analytics. Para SSF, use a extensão do Adobe Analytics. Importante: A partir da versão 8.0, o DIL tem uma forte dependência do Serviço da Experience Cloud ID, versão 3.3 ou superior. Implemente o Serviço da Experience Cloud ID e o DIL para obter todos os recursos de integração de dados do Audiência Manager.

A DIL do Audiência Manager é uma extensão da Plataforma de Gestão de dados (DMP) na Plataforma de dados do cliente em tempo real da Adobe. Para obter mais informações sobre a funcionalidade de extensão, consulte a página [de extensão do Gerenciador de](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/adobe-audience-manager-extension.html) Audiências na documentação do Launch da plataforma Experience.
...
![extensão DIL do Gerenciador de Audiências](/help/rtcdp/destinations/assets/aam-dil-extension.png)
...
Para instalar a extensão DIL do Gerenciador de Audiências:
...
Para obter informações sobre as opções de configuração de extensão, consulte a página [de extensão do Gerenciador de](https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/adobe-audience-manager-extension.html) Audiências na documentação do Experience Launch.
