...
| Recurso | Descrição |
| --- | --- |
| Melhorias no [!DNL Data Prep] Recommendations | O Recommendations [!DNL Data Prep] agora é mais inteligente e rápido. As novas verificações de validação reduzem significativamente os erros de mapeamento mais comuns, reduzindo ainda mais o tempo de implantação. |
...
| Recurso | Descrição |
| --- | --- |
| Disponibilidade geral da origem do [!DNL Azure Data Explorer]  | Use a fonte do Azure Data Explorer para trazer dados da sua instância [!DNL Azure] para o Experience Platform. Consulte a [[!DNL Azure Data Explorer] visão geral da origem](../../sources/connectors/databases/data-explorer.md) para obter mais informações. |
| Disponibilidade geral da origem [!DNL Generic OData] | Use a fonte [!DNL Generic OData] para trazer recursos de sistemas que oferecem suporte ao protocolo de dados abertos para o Experience Platform. Consulte a [[!DNL Generic OData] visão geral da origem](../../sources/connectors/protocols/odata.md) para obter mais informações. |
| Suporte para detecção automática de propriedades de arquivo de origem para [!DNL Data Landing Zone] na interface do usuário do Experience Platform | A origem [!DNL Data Landing Zone] agora oferece suporte à detecção automática de propriedades de arquivos ao usar a interface do usuário do Experience Platform. Consulte a documentação sobre [criação de uma [!DNL Data Landing Zone] conexão de origem](../../sources/tutorials/ui/create/cloud-storage/data-landing-zone.md) para obter mais informações. |
