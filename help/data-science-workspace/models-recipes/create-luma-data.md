...
O tutorial a seguir usa um modelo personalizado de propensão de compra da Luma. Antes de continuar, [baixe os ativos necessários](../assets/DSW-course-sample-assets.7z) e a pasta zip. Esta pasta contém:
