---
keywords: Experience Platform;home;popular tópicos;redshift;Redshift;Amazon Redshift;amazon redshift
solution: Experience Platform
title: Criar uma conexão de origem do Amazon Redshift usando a API de serviço de fluxo
topic: overview
type: Tutorial
description: Saiba como conectar o Adobe Experience Platform ao Amazon Redshift usando a API de Serviço de Fluxo.
...
# Criar uma conexão de origem [!DNL Amazon Redshift] usando a API [!DNL Flow Service]
