...
Este documento fornece instruções passo a passo para criar e gerenciar tarefas de exportação usando a [API de perfil](https://www.adobe.com/go/profile-apis-en).
