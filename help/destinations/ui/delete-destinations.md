...
Na interface de usuário do [!DNL Adobe Experience Platform], é possível excluir conexões existentes com destinos.
...
* [Excluir destinos da guia [!UICONTROL Browse]](#delete-browse-tab)
...
3. Selecione o botão ![Mais botão](/help/images/icons/more.png) na coluna Nome e selecione ![Excluir botão](/help/images/icons/delete.png) **[!UICONTROL Delete]** para remover uma conexão de destino existente.
