...
Na categoria do Armazenamento *[!UICONTROL da]* Cloud, selecione **[!UICONTROL Amazon Kinesis]** , seguido por **[!UICONTROL Adicionar dados]** para criar um novo [!DNL Kinesis] conector.
...
Ao seguir este tutorial, você se conectou à sua [!DNL Kinesis] conta [!DNL Platform]. Agora você pode continuar para o próximo tutorial e [configurar um fluxo de dados para trazer dados do seu armazenamento em nuvem para a Plataforma](../../dataflow/streaming/cloud-storage.md).