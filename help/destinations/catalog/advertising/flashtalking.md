---
keywords: Extensões de OneTag Falantes;Extensão de OneTag Falante;Destinos de OneTag Falantes;OneTag Falantes;onetag falante
title: Extensão OneTag de fala rápida
description: A extensão Flashtalk OneTag é um destino de publicidade no Adobe Experience Platform. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no Adobe Exchange.
...
# Extensão do [!DNL Flashtalking OneTag] {#flashtalking-extension}

## Visão geral {#overview}

A extensão de tag [!DNL Flashtalking OneTag] facilita a atribuição de ações do site para exibição, vídeo e atividade de anúncios móveis. Implante o [!DNL Flashtalking OneTag] nas suas propriedades da Web usando marcas.

[!DNL Flashtalking OneTag] é uma extensão de publicidade em [!DNL Adobe Experience Platform]. Para obter mais informações sobre a funcionalidade de extensão, consulte a página de extensão no [Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
...
![Extensão do Flashtalk](../../assets/catalog/advertising/flashtalking/catalog.png)
...
Para instalar a extensão [!DNL Flashtalking OneTag]:
...
Para obter informações sobre as opções de configuração de extensão e suporte à instalação, consulte a [página Flashtalk OneTag no Adobe Exchange](https://exchange.adobe.com/experiencecloud.details.101392.flashtalking-onetag.html).
