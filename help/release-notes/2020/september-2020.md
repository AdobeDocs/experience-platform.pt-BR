...
**Data de lançamento: quinta-feira, 9 de setembro de 2020**
...
| Recurso | Descrição |
| --- | --- |
| Notificações de eventos do Adobe I/O | [!DNL Observability Insights] usa o Adobe I/O Eventos para criar notificações de eventos para vários serviços Experience Platform. As cargas de notificação são enviadas para um webhook configurado, que você pode usar para automatizar mais processos downstream. |
...
| Recurso | Descrição |
| ------- | ----------- |
| Mapeamento automático | O [!DNL Platform] fornece recomendações inteligentes para mapeamento automático durante o fluxo de trabalho de assimilação de dados, com base em um esquema ou conjunto de dados de destino selecionado pelo usuário. Você pode ajustar manualmente regras de mapeamento automático flexíveis para atender aos seus casos de uso. |
