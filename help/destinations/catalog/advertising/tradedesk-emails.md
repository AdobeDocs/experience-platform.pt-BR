...
Dependendo do tipo de IDs que você assimila em [!DNL Adobe Experience Platform], você deve seguir seus requisitos correspondentes. Leia a [visão geral do Namespace de Identidade](/help/identity-service/features/namespaces.md) para obter mais informações.
...
O [!DNL Adobe Experience Platform] oferece suporte para endereços de email e números de telefone com hash e sem hash. Siga as instruções na seção Requisitos de correspondência de ID e use os namespaces apropriados para texto sem formatação e endereços de email com hash, respectivamente.
...
Você pode hash de endereços de email antes de assimilá-los em [!DNL Adobe Experience Platform] ou usar endereços de email brutos.
