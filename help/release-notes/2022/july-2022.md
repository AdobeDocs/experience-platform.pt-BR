...
- [Lead para a correspondência da conta na CDP B2B](#B2B)
...
## Lead para a correspondência da conta na CDP B2B (#lead-to-account-match)

As empresas B2B geralmente têm as informações de seus clientes armazenadas em vários sistemas, cada um incluindo apenas dados parciais ou até mesmo conflitantes para a mesma entidade de negócios real. Isto cria um enorme desafio de chegar a uma visão precisa dos seus clientes, reduzindo assim a eficiência e a eficácia dos seus esforços de marketing e vendas B2B. Com o lançamento do lead para a correspondência da conta, a CDP B2B corresponde perfis de pessoa conhecidos para perfis da conta, para que possam ser segmentados e direcionados com dados de contexto B2B, como conta, oportunidade etc.

Leia mais sobre o recurso nas seguintes páginas de documentação:

- [Lead para correspondência de contas na CDP B2B](../../rtcdp/b2b-ai-ml-services/lead-to-account-matching.md)
- [Leia o enriquecimento do perfil de correspondência da conta no guia de enriquecimento do perfil do monitor](../../dataflows/ui/b2b/monitor-profile-enrichment.md)
